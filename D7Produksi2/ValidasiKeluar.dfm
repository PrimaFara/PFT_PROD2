object ValidasiKeluarFrm: TValidasiKeluarFrm
      ...
      object TabSheet1: TTabSheet
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              'NO_MESIN'#9'9'#9'NO MESIN'#9'F'
              'KD_ITEM'#9'10'#9'KODE'#9'F'
              'KETERANGAN'#9'34'#9'ITEM'#9'F'
              'LSATUAN'#9'10'#9'SAT'#9'F'
              'QTY1'#9'9'#9'Bukti'#9'T'#9'QTY'
              'QTY2'#9'11'#9'Sdh. Diambil'#9'T'#9'QTY'
              'QTY3'#9'9'#9'Diambil'#9'F'#9'QTY'
              'KD_SUB_LOKASI'#9'11'#9'TUJUAN'#9'F')
        ...
        object PanelBrowse: TPanel
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'NAMA_DIVISI'#9'19'#9'NAMA DIVISI'#9'F'
              'KODE_BRG'#9'7'#9'Kode'#9'F'#9'BARANG'
              'NAMA_BRG'#9'46'#9'Nama'#9'F'#9'BARANG'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from vvalidasikeluarfrm')
    ReadBuffer = 25
    Optimize = True
    Debug = False
    ...
    QBEDefinition.QBEFieldDefs = {
      0300000010000000070000004E4F5F4E4F544101000000000700000054414E47
  ...
  object QDetail: TOracleDataSet
    ...
    QBEDefinition.QBEBackgroundColor = clNone
    QBEDefinition.QBEFieldDefs = {
      0300000021000000070000004B445F4954454D01000000000400000044495343
      ...
      000000090000004B445F52454B5F474C0100000000}
    Cursor = crDefault
    ReadOnly = False
    LockingMode = lmCheckImmediate
    QueryAllRecords = True
  ...
  object ppReportInput: TppReport
    ...
    object ppDetailBand2: TppDetailBand
      ...
      object ppDBTextMesin: TppDBText
        UserName = 'DBText3'
        DataField = 'NO_MESIN'
        DataPipeline = ppDBQDetail
        Font.Charset = DEFAULT_CHARSET
  ...
  object QItem: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vstokall_lokasi')
    ReadBuffer = 25
    Optimize = True
    Debug = False
    StringFieldsOnly = False
