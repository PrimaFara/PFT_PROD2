...
type
  ...
  private
    ...
    vorder, SelectedFont, vopr, vkode, vjns_brg, vjns_lokasi, vkd_benang : String;
  public
    { Public declarations }
...
//  if BPBFrm=Nil then
  begin
    ...
    pjudul:=mychar;
    HasilSoftConesFrm.Caption:=UpperCase(pkode+pjudul);
...
begin
  QDetailQTY1.AsFloat:=(QDetailQTY6.AsFloat-(QDetailQTY5.AsFloat*QMasterQTY_RESEP.AsFloat))-
    (QDetailRASIO.AsFloat*QDetailQTY2.AsFloat);
...
begin
  ...
  QDetailSTD_PSN.AsFloat:=(QDetailQTY1.AsFloat-QDetailQTY_STANDAR.AsFloat)*100/
    QDetailQTY_STANDAR.AsFloat;
end;

procedure THasilSoftConesFrm.ppNo2Print(Sender: TObject);
begin
