object PermintaanKoreksi_cikalanFrm: TPermintaanKoreksi_cikalanFrm
  Left = 215
  Top = 106
  Width = 1010
  Height = 580
  Caption = '866. Koreksi Cucuk'
  Color = clBtnFace
  ...
  object Qitem_ko: TOracleDataSet
    SQL.Strings = (
      'select a.* from ipisma_db4.VSTOK_KOR2_TEMP a'
      ''
  ...
  object OracleQuery1: TOracleQuery
    SQL.Strings = (
      'begin'
        ...
        '  ipisma_db4.proc_mutasi_kor2_2507/*proc_mutasi_kor2_25*/(:pawal' +
        ',:pakhir);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
      ...
      'sum(qty4) as akhir1,sum(qty5) as akhir2,sum(qty6) as akhir3,'
        ...
        'sum(qty7) as selisih1,sum(qty8) as selisih2,sum(qty9) as selisih' +
        '3 '
