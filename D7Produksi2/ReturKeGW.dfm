object ReturKeGWFrm: TReturKeGWFrm
  Left = 190
  Top = 124
  Width = 1125
  Height = 560
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object PanelMaster: TPanel
          ...
          object LookKonstr: TwwDBLookupComboDlg
            Left = 358
            Top = 18
            Width = 151
            Height = 19
            ...
            LookupField = 'NAMA_KONSTRUKSI'
            TabOrder = 7
            AutoDropDown = True
            ShowButton = True
            AllowClearKey = False
            OnCloseUp = LookKonstrCloseUp
            OnEnter = LookKonstrEnter
          end
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            ControlType.Strings = (
              ...
              'KETERANGAN;CustomEdit;CmbGroup;F')
            Selected.Strings = (
              'KETERANGAN'#9'25'#9'LOKASI'#9'F'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vreturkeGW'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      000000050000005348494654010000000000090000004E4F5F44455341494E01
      00000000000500000052455345500100000000000A0000004B4F4E535452554B
      5349010000000000040000004245414D010000000000}
    ReadOnly = True
  ...
  object QMaster: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      0400000014000000070000004E4F5F4E4F54410100000000000C0000004B445F
      ...
      535452554B5349010000000000040000004245414D010000000000}
  ...
  object QBarang: TOracleDataSet
    ...
    object QBarangJNS: TStringField
      FieldName = 'JNS'
      Size = 3
    end
    object QBarangJNS1: TStringField
      FieldName = 'JNS1'
      Size = 3
    end
    ...
    object QBarangKD_JNS_ITEM: TStringField
      FieldName = 'KD_JNS_ITEM'
      Required = True
      Size = 6
    end
    object QBarangKD_SATUAN: TStringField
      FieldName = 'KD_SATUAN'
      Required = True
      Size = 2
    end
    ...
    object QBarangLEAD_TIME: TFloatField
      FieldName = 'LEAD_TIME'
    end
    object QBarangISFIXED: TStringField
      FieldName = 'ISFIXED'
      Required = True
      Size = 1
    end
  ...
  object QBrowseRekap: TOracleDataSet
    SQL.Strings = (
        ...
        ' pcs from ipisma_db4.vkelos_masuk t'
      
        'where trunc(tanggal)>=:pawal and trunc(tanggal)<=:pakhir and t.i' +
        'spost = 1'
      'group by (t.kd_konstruksi, t.nama_item)'
    ...
    QBEDefinition.QBEFieldDefs = {
      04000000040000000D0000004B445F4B4F4E535452554B534901000000000002
      0000004B4701000000000003000000504353010000000000090000004E414D41
      5F4954454D010000000000}
    ReadOnly = True
    QueryAllRecords = False
    Session = DMFrm.OS
  ...
  object QBrowseRekap_Total: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(t.kg) as kg, sum(t.pcs) as pcs from ipisma_db4.vretur' +
        'keGW t'
    ...
    Left = 512
    Top = 216
    object QBrowseRekap_TotalKG: TFloatField
      FieldName = 'KG'
    end
    object QBrowseRekap_TotalPCS: TFloatField
      FieldName = 'PCS'
    end
  end
  ...
  object QKP: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      45544552414E47414E010000000000}
    Session = DMFrm.OS
    Left = 608
    Top = 192
