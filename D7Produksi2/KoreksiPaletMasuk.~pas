...
type
  TKoreksiPaletMasukFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
    PanelMain: TPanel;
    PanelHeader: TPanel;
...
var
  KoreksiPaletMasukFrm: TKoreksiPaletMasukFrm;
...
uses DM, Pembelian, ValidasiPenyerahanBB, KelosKeluar, KelosMasuk,
  KoreksiKelosMasuk, KoreksiCikalanMasuk;
...
//  if BPBFrm=Nil then
  begin
    ...
    KoreksiPaletMasukFrm:=KoreksiPaletMasukFrm.Create(Application);
    KoreksiPaletMasukFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       KoreksiPaletMasukFrm.QMaster.ReadOnly:=True;
       KoreksiPaletMasukFrm.QDetail.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    KoreksiPaletMasukFrm.Caption:=UpperCase(pkode+pjudul);
    KoreksiPaletMasukFrm.vkode:=pkode;
   // ValidasiPenyerahanBBFrm.vjns_lokasi:=pjns_lokasi;
   // ValidasiPenyerahanBBFrm.vjns_brg:=pjns_brg;
    KoreksiPaletMasukFrm.QTransaksi.Open;

    KoreksiPaletMasukFrm.PanelHeader.Caption:=KoreksiPaletMasukFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+KoreksiPaletMasukFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    KoreksiPaletMasukFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    KoreksiPaletMasukFrm.wwDBGrid1.IniAttributes.SectionName:=KoreksiPaletMasukFrm.Caption+'1';
    KoreksiPaletMasukFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    KoreksiPaletMasukFrm.wwDBGrid1.LoadFromIniFile;
    KoreksiPaletMasukFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    KoreksiPaletMasukFrm.wwDBGrid2.IniAttributes.SectionName:=KoreksiPaletMasukFrm.Caption+'2';
    KoreksiPaletMasukFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    KoreksiPaletMasukFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,KoreksiPaletMasukFrm.Caption+'1',KoreksiPaletMasukFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,KoreksiPaletMasukFrm.Caption+'2',KoreksiPaletMasukFrm.wwDBGrid2);
    KoreksiPaletMasukFrm.wwDBSpinLine1.Value:=KoreksiPaletMasukFrm.wwDBGrid1.RowHeightPercent;
    KoreksiPaletMasukFrm.wwDBSpinLine2.Value:=KoreksiPaletMasukFrm.wwDBGrid2.RowHeightPercent;
...
procedure TKoreksiPaletMasukFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'1',wwDBGrid1);
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   KoreksiPaletMasukFrm:=Nil;
end;

procedure TKoreksiPaletMasukFrm.FormCreate(Sender: TObject);
begin
//barcode
...
//Otoritas Button
  ...
  QTransaksi.Close;
QTransaksi.SetVariable('kd_transaksi','879');
QTransaksi.Open;
...
procedure TKoreksiPaletMasukFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TKoreksiPaletMasukFrm.BtnOkClick(Sender: TObject);
begin
...
procedure TKoreksiPaletMasukFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKoreksiPaletMasukFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TKoreksiPaletMasukFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TKoreksiPaletMasukFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TKoreksiPaletMasukFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TKoreksiPaletMasukFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TKoreksiPaletMasukFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TKoreksiPaletMasukFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TKoreksiPaletMasukFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
 // ppNo.AsInteger:=0;
end;

procedure TKoreksiPaletMasukFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TKoreksiPaletMasukFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TKoreksiPaletMasukFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TKoreksiPaletMasukFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TKoreksiPaletMasukFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiPaletMasukFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TKoreksiPaletMasukFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TKoreksiPaletMasukFrm.Label5Click(Sender: TObject);
begin
...
procedure TKoreksiPaletMasukFrm.LookKonstruksiEnter(Sender: TObject);
begin
  QBarang.Open;
...
procedure TKoreksiPaletMasukFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TKoreksiPaletMasukFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QTime.Open;
...
procedure TKoreksiPaletMasukFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
  QTransaksi.DeclareVariable('kd_transaksi', otString);
  QTransaksi.SQL.Text:='select a.* from '+cUserTabel+'vtransaksi a where a.kd_transaksi=:kd_transaksi';
  QTransaksi.SetVariable('kd_transaksi','879');//vkode);
end;

procedure TKoreksiPaletMasukFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TKoreksiPaletMasukFrm.FormCloseQuery(Sender: TObject;
...
procedure TKoreksiPaletMasukFrm.QMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TKoreksiPaletMasukFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TKoreksiPaletMasukFrm.QLokasiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TKoreksiPaletMasukFrm.LookLokasiEnter(Sender: TObject);
begin
  //QLokasi.Open;
end;

procedure TKoreksiPaletMasukFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
  {if vjns_brg<>'' then
  begin
...
procedure TKoreksiPaletMasukFrm.LookKonstruksiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TKoreksiPaletMasukFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  ...
  QDetailKD_WARNA.AsString:='000';
//  QDetailNO_NOTA.AsString:=QMasterNO_NOTA.AsString;
end;

procedure TKoreksiPaletMasukFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiPaletMasukFrm.FormShow(Sender: TObject);
begin
//  PanelHeader.Caption:=QTransaksiKD_TRANSAKSI.AsString+'. '+UpperCase(Caption);
end;

procedure TKoreksiPaletMasukFrm.LookWarnaEnter(Sender: TObject);
begin
  DMFrm.QWarna.Open;
end;

procedure TKoreksiPaletMasukFrm.QHasilCelupBeforeOpen(
  DataSet: TDataSet);
begin
  QHasilCelup.SetVariable('NO_NOTA',wwDBEdit1.Text);
end;

procedure TKoreksiPaletMasukFrm.Button1Click(Sender: TObject);
begin
...
procedure TKoreksiPaletMasukFrm.LookResepEnter(Sender: TObject);
begin
  DMFrm.QResep.Open;
end;

procedure TKoreksiPaletMasukFrm.LookResepUserButton1Click(
...
procedure TKoreksiPaletMasukFrm.QDetailAfterPost(DataSet: TDataSet);
begin
//ShowMessage('dfdsf');

end;

procedure TKoreksiPaletMasukFrm.cbPostClick(Sender: TObject);
begin
//DBText3.Caption:='';
end;

procedure TKoreksiPaletMasukFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.Open;
...
procedure TKoreksiPaletMasukFrm.QTotalBeforeQuery(Sender: TOracleDataSet);
begin
QTotal.SetVariable('no_reg',QMasterNO_REG.AsInteger);
end;

procedure TKoreksiPaletMasukFrm.TabSheet2Show(Sender: TObject);
begin
QBrowse.Close;
QBrowse.Open;
QBrowse.Refresh;
...
procedure TKoreksiPaletMasukFrm.BtnPrintInputClick(Sender: TObject);
begin
QuickRep1.Preview;
end;

procedure TKoreksiPaletMasukFrm.BtnOk1Click(Sender: TObject);
begin
...
procedure TKoreksiPaletMasukFrm.QBrowseRekapAfterScroll(DataSet: TDataSet);
begin
