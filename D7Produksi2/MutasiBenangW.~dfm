object MutasiBenangWFrm: TMutasiBenangWFrm
      ...
      object QuickRep1: TQuickRep
        ...
        object SummaryBand1: TQRBand
          ...
          object QRExpr1: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QBrowse.QTY_OUT10)'
            Mask = '0.0,0;(0.0,0);-'
            FontSize = 7
          end
        end
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vmutasi_warping_v2'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      000000}
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
      ...
      'sum(qty_out20)as z2,'
      'sum(qty_out21)as z3'
      'from ipisma_db4.vmutasi_warping_v2'
      ':MYPARAM'
      ''
      '/*SELECT '
      ...
      '    ROUND(SUM(qty_in7), 2) AS x,'
      '    ROUND(SUM(qty_in8), 2) AS w, '
      '    ROUND(SUM(qty_out1), 2) AS g, '
      '    ROUND(SUM(qty_out2), 2) AS h, '
      '    ROUND(SUM(qty_out3), 2) AS i, '
      '    ROUND(SUM(qty_out4), 2) AS j, '
      '    ROUND(SUM(qty_out5), 2) AS k, '
      '    ROUND(SUM(qty_out6), 2) AS l, '
      '    ROUND(SUM(qty_out7), 2) AS m, '
      '    ROUND(SUM(qty_out8), 2) AS n, '
      '    ROUND(SUM(qty_out9), 2) AS o, '
      '    ROUND(SUM(qty_out10), 2) AS p, '
      '    ROUND(SUM(qty_out11), 2) AS q,'
      '    ROUND(SUM(qty_out12), 2) AS x1,'
      '    ROUND(SUM(qty_out13), 2) AS x2,'
      '    ROUND(SUM(qty_out14), 2) AS x3,'
      '    ROUND(SUM(qty_out15), 2) AS v,'
      '    ROUND(SUM(qty_out16), 2) AS y1,'
      '    ROUND(SUM(qty_out17), 2) AS y2,'
      '    ROUND(SUM(qty_out18), 2) AS y3,'
      '    ROUND(SUM(qty_out19), 2) AS z1,'
      '    ROUND(SUM(qty_out20), 2) AS z2,'
      '    ROUND(SUM(qty_out21), 2) AS z3'
      'FROM ipisma_db4.vmutasi_warping_v2'
      ':MYPARAM */')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      040000001D000000010000004101000000000001000000420100000000000100
      ...
      
      00000000020000005A33010000000000}
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 120
    Top = 392
    ...
    object QBrowseTotalX1: TFloatField
      FieldName = 'X1'
      DisplayFormat = '#,###.##;(#,###.##) '
    end
    object QBrowseTotalX2: TFloatField
      FieldName = 'X2'
      DisplayFormat = '#,###.##;(#,###.##) '
    end
    object QBrowseTotalX3: TFloatField
      FieldName = 'X3'
      DisplayFormat = '#,###.##;(#,###.##) '
    end
    ...
    object QBrowseTotalY1: TFloatField
      FieldName = 'Y1'
    end
    object QBrowseTotalY2: TFloatField
      FieldName = 'Y2'
    end
    object QBrowseTotalY3: TFloatField
      FieldName = 'Y3'
    end
    object QBrowseTotalZ1: TFloatField
      FieldName = 'Z1'
    end
    object QBrowseTotalZ2: TFloatField
      FieldName = 'Z2'
    end
    object QBrowseTotalZ3: TFloatField
      FieldName = 'Z3'
    end
  end
  ...
  object QTutupTahun: TOracleQuery
    SQL.Strings = (
      ...
      '  if to_char(:ptgl,'#39'mm'#39')='#39'12'#39' then'
        ...
        '    ipisma_db4.tutup_stok_tahun_wrp(to_number(to_char(:ptgl,'#39'yyy' +
        'y'#39')));'
      '  end if;'
      '  commit;'
      'end;')
  ...
  object QUpdate2: TOracleQuery
    Session = DMFrm.OS
    Variables.Data = {
      
      0000050000003A50515459040000000000000000000000}
