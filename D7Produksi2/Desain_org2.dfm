object DesainFrm: TDesainFrm
      ...
      object Panel3: TPanel
        ...
        object wwDBGrid2: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'KD_KONV'#9'8'#9'Konversi'#9'F'#9'BAHAN'
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KODI'#9'9'#9'Kodi'#9'F'#9'HASIL PRODUKSI'
          'PCS'#9'10'#9'Pcs'#9'F'#9'HASIL PRODUKSI'
    ...
    object TabSheet5: TTabSheet
      ...
      object wwDBGrid4: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KETETANGAN'#9'30'#9'KETETANGAN'#9#9)
        IniAttributes.Delimiter = ';;'
        TitleColor = clBtnFace
        FixedCols = 0
        ShowHorzScrollBar = True
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from (select a.* from ipisma_db4.vdesain2 a)'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D01000000180000006F726465
      72206279206E6F5F64657361696E20444553430000000000}
    QBEDefinition.QBEFieldDefs = {
      ...
      414B010000000000020000004B50010000000000040000004B4F444901000000
