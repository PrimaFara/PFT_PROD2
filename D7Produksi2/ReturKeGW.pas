...
type
  TReturKeGWFrm = class(TForm)
    ...
    QBrowseRekap_TotalKG: TFloatField;
    QBrowseRekap_TotalPCS: TFloatField;
    ...
    QBarangJNS: TStringField;
    QBarangJNS1: TStringField;
    QBarangNO_PART: TStringField;
    QBarangKD_JNS_ITEM: TStringField;
    QBarangKD_SATUAN: TStringField;
    QBarangSATUAN: TStringField;
    QBarangLEAD_TIME: TFloatField;
    QBarangISFIXED: TStringField;
    ...
    Label30: TLabel;
    LookKonstr: TwwDBLookupComboDlg;
    Label31: TLabel;
...
//  if BPBFrm=Nil then
  begin
    ...
    ReturKeGWFrm:=ReturKeGWFrm.Create(Application);
    ReturKeGWFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       ReturKeGWFrm.QMaster.ReadOnly:=True;
       ReturKeGWFrm.QDetail.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    ReturKeGWFrm.Caption:=UpperCase(pkode+pjudul);
    ReturKeGWFrm.vkode:=pkode;
   // ValidasiPenyerahanBBFrm.vjns_lokasi:=pjns_lokasi;
   // ValidasiPenyerahanBBFrm.vjns_brg:=pjns_brg;
    ReturKeGWFrm.QTransaksi.Open;

    ReturKeGWFrm.PanelHeader.Caption:=ReturKeGWFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+ReturKeGWFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    ReturKeGWFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    ReturKeGWFrm.wwDBGrid1.IniAttributes.SectionName:=ReturKeGWFrm.Caption+'1';
    ReturKeGWFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    ReturKeGWFrm.wwDBGrid1.LoadFromIniFile;
    ReturKeGWFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    ReturKeGWFrm.wwDBGrid2.IniAttributes.SectionName:=ReturKeGWFrm.Caption+'2';
    ReturKeGWFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    ReturKeGWFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,ReturKeGWFrm.Caption+'1',ReturKeGWFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,ReturKeGWFrm.Caption+'2',ReturKeGWFrm.wwDBGrid2);
    ReturKeGWFrm.wwDBSpinLine1.Value:=ReturKeGWFrm.wwDBGrid1.RowHeightPercent;
    ReturKeGWFrm.wwDBSpinLine2.Value:=ReturKeGWFrm.wwDBGrid2.RowHeightPercent;
...
procedure TReturKeGWFrm.SpeedButton3Click(Sender: TObject);
begin
...
procedure TReturKeGWFrm.SpeedButton4Click(Sender: TObject);
begin
...
procedure TReturKeGWFrm.vTglAwal2Change(Sender: TObject);
begin
//  vTglAkhir2.DateTime:=EndOfTheMonth(vTglAwal2.Date);
  vTglAkhir2.DateTime:=vTglAwal2.Date;
end;

procedure TReturKeGWFrm.BitBtn3Click(Sender: TObject);
begin
...
procedure TReturKeGWFrm.FormClose(Sender: TObject;
...
procedure TReturKeGWFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TReturKeGWFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TReturKeGWFrm.BtnOkClick(Sender: TObject);
begin
...
procedure TReturKeGWFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TReturKeGWFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TReturKeGWFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TReturKeGWFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TReturKeGWFrm.vTglAwalChange(Sender: TObject);
begin
//  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
  vTglAkhir.DateTime:=vTglAwal.Date;
end;

procedure TReturKeGWFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TReturKeGWFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TReturKeGWFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TReturKeGWFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
 // ppNo.AsInteger:=0;
end;

procedure TReturKeGWFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TReturKeGWFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TReturKeGWFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TReturKeGWFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TReturKeGWFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TReturKeGWFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TReturKeGWFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TReturKeGWFrm.Label5Click(Sender: TObject);
begin
...
procedure TReturKeGWFrm.LookKonstruksiEnter(Sender: TObject);
begin
{if DTPTanggal.Date >= StrToDate('01/01/2017') then
begin   }
//ShowMessage('tekan kene');
  QBarang.Close;
  //QBarang.SQL.Text:='select a.* from ipisma_db4.vitemall_1';
...
procedure TReturKeGWFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TReturKeGWFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QTime.Open;
...
procedure TReturKeGWFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
  QTransaksi.DeclareVariable('kd_transaksi', otString);
  QTransaksi.SQL.Text:='select a.* from '+cUserTabel+'vtransaksi a where a.kd_transaksi=:kd_transaksi';
  QTransaksi.SetVariable('kd_transaksi','867');//vkode);
end;

procedure TReturKeGWFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TReturKeGWFrm.FormCloseQuery(Sender: TObject;
...
procedure TReturKeGWFrm.QMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TReturKeGWFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TReturKeGWFrm.QLokasiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TReturKeGWFrm.LookLokasiEnter(Sender: TObject);
begin
  //QLokasi.Open;
end;

procedure TReturKeGWFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
  {if vjns_brg<>'' then
  begin
...
procedure TReturKeGWFrm.LookKonstruksiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TReturKeGWFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TReturKeGWFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
if (QDetailKONSTRUKSI.AsString='') then
     begin
        ShowMessage('Benang harus diisi !');
        Abort;
     end
   else
...
procedure TReturKeGWFrm.FormShow(Sender: TObject);
begin
//  PanelHeader.Caption:=QTransaksiKD_TRANSAKSI.AsString+'. '+UpperCase(Caption);
end;

procedure TReturKeGWFrm.LookWarnaEnter(Sender: TObject);
begin
  DMFrm.QWarna.Open;
end;

procedure TReturKeGWFrm.QAmbilresepBeforeOpen(
  DataSet: TDataSet);
begin
//  QHasilCelup.SetVariable('NO_NOTA',wwDBEdit1.Text);
end;

procedure TReturKeGWFrm.Button1Click(Sender: TObject);
begin
...
procedure TReturKeGWFrm.LookdesaiEnter(Sender: TObject);
begin
{  DMFrm.QDesain.Close;
  DMFrm.QDesain.Open;}
  QKP.Close;
...
procedure TReturKeGWFrm.LookResepUserButton1Click(
...
procedure TReturKeGWFrm.QDetailAfterPost(DataSet: TDataSet);
begin
//ShowMessage('dfdsf');

end;

procedure TReturKeGWFrm.cbPostClick(Sender: TObject);
begin
//DBText3.Caption:='';
end;

procedure TReturKeGWFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.Open;
...
procedure TReturKeGWFrm.QTotalBeforeQuery(Sender: TOracleDataSet);
begin
QTotal.SetVariable('no_reg',QMasterNO_REG.AsInteger);
end;

procedure TReturKeGWFrm.TabSheet2Show(Sender: TObject);
begin
//QBrowse.Close;
//QBrowse.Open;
//QBrowse.Refresh;
...
procedure TReturKeGWFrm.BtnPrintInputClick(Sender: TObject);
begin
QuickRep1.Preview;
end;

procedure TReturKeGWFrm.vTglAwal1Change(Sender: TObject);
begin
//  vTglAkhir1.DateTime:=EndOfTheMonth(vTglAwal1.Date);
  vTglAkhir1.DateTime:=vTglAwal1.Date;
end;

procedure TReturKeGWFrm.BtnOk1Click(Sender: TObject);
begin
    ...
    begin
     ...
     //   QBrowseRekap.QBEMode:=False;
      ...
      QBrowseRekap.Close;
  		...
  		//QBrowseRekap.SetVariable('porder',' order by no_nota');
      //QBrowse.SetVariable('kd_lokasi',vkd_lokasi);
      QBrowseRekap.Open;
      ...
      wwDBGrid5.ColumnByName('kg').FooterValue:=FormatFloat('#.#,#;#.#,#; ',QBrowseRekap_TotalKG.AsFloat);
      wwDBGrid5.ColumnByName('pcs').FooterValue:=FormatFloat('#.#,#;#.#,#; ',QBrowseRekap_TotalPCS.AsFloat);
...
procedure TReturKeGWFrm.QBrowseRekapAfterScroll(DataSet: TDataSet);
begin
  LabelBanner1.Caption:='Record ke '+IntToStr(QBrowseRekap.RecNo)+' dari '+FormatFloat('#,#',QBrowseRekap.RecordCount)+' Records';
end;

procedure TReturKeGWFrm.BtnFind1Click(Sender: TObject);
begin
...
procedure TReturKeGWFrm.BtnOk21Click(Sender: TObject);
begin
  if QBrowseRekap.QBEMode then
  begin
    ...
    while not QBrowseRekap.Eof do
      begin
        t1:=t1+QBrowseRekapKG.AsFloat;
        t2:=t2+QBrowseRekapPCS.AsFloat;
        QBrowseRekap.Next;
      end;
      QBrowseRekap.EnableControls;
...
procedure TReturKeGWFrm.BtnExport1Click(Sender: TObject);
begin
 {   DMFrm.SaveDialog1.FileName:=PanelHeader.Caption+' '+
...
procedure TReturKeGWFrm.TabSheet4Show(Sender: TObject);
begin
...
procedure TReturKeGWFrm.BitBtn10Click(Sender: TObject);
begin
QuickRep3.Preview;
end;

procedure TReturKeGWFrm.BitBtn7Click(Sender: TObject);
begin
QuickRep2.Preview;
end;

procedure TReturKeGWFrm.BtnOK3Click(Sender: TObject);
begin
...
procedure TReturKeGWFrm.wwDBGrid5TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TReturKeGWFrm.QBrowseRekap2FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
...
procedure TReturKeGWFrm.cbStokClick(Sender: TObject);
begin
QBrowseRekap2.Filtered:=CBstok.Checked;
end;

procedure TReturKeGWFrm.LookWarna2CustomDlg(Sender: TObject);
begin
...
procedure TReturKeGWFrm.LookWarna2Enter(Sender: TObject);
begin
//if DTPTanggal.Date >= StrToDate('01/01/2017') then
  begin
...
procedure TReturKeGWFrm.LookWarna2UserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
DMFrm.QWarna.Close;
DMFrm.QWarna.Open;
...
procedure TReturKeGWFrm.LookWarnaBeamCustomDlg(Sender: TObject);
begin
  LookWarnaDlg.Execute;
  QDetailKD_WARNA.AsString:=DMFrm.QWarnaKD_WARNA.AsString;
  QDetailNAMA_WARNA.AsString:=DMFrm.QWarnaWARNA.AsString;
...
procedure TReturKeGWFrm.LookWarnaDlgUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
  DMFrm.QWarna.Close;
  DMFrm.QWarna.Open;
...
procedure TReturKeGWFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TReturKeGWFrm.SpeedButton1Click(Sender: TObject);
begin
...
procedure TReturKeGWFrm.QBrowseRekap3FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
...
procedure TReturKeGWFrm.SpeedButton2Click(Sender: TObject);
begin
...
procedure TReturKeGWFrm.CheckBox1Click(Sender: TObject);
begin
QBrowseRekap3.Filtered:=CheckBox1.Checked;
end;

procedure TReturKeGWFrm.vTglAwal3Change(Sender: TObject);
begin
//  vTglAkhir2.DateTime:=EndOfTheMonth(vTglAwal2.Date);
  vTglAkhir3.DateTime:=vTglAwal3.Date;
end;

procedure TReturKeGWFrm.BitBtn12Click(Sender: TObject);
begin
...
procedure TReturKeGWFrm.wwDBSpinEdit3Change(Sender: TObject);
begin
    wwDBGrid3.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TReturKeGWFrm.QBrowseRekap2AfterScroll(DataSet: TDataSet);
begin
 LabelBanner2.Caption:='Record ke '+IntToStr(QBrowseRekap2.RecNo)+' dari '+FormatFloat('#,#',QBrowseRekap2.RecordCount)+' Records';
end;

procedure TReturKeGWFrm.QBrowseRekap3AfterScroll(DataSet: TDataSet);
begin
 Label25.Caption:='Record ke '+IntToStr(QBrowseRekap3.RecNo)+' dari '+FormatFloat('#,#',QBrowseRekap3.RecordCount)+' Records';
end;

procedure TReturKeGWFrm.BitBtn15Click(Sender: TObject);
begin
QuickRep4.Preview;
end;

procedure TReturKeGWFrm.LookGrupEnter(Sender: TObject);
begin
QGrup.Close;
QGrup.Open;
end;

procedure TReturKeGWFrm.LookGrupCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
begin
...
procedure TReturKeGWFrm.LookdesaiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
{QMasterRESEP.AsString:=DMFrm.QDesainNO_ORDER.AsString;
QMasterNO_DESAIN.AsInteger:=DMFrm.QDesainNO_DESAIN.AsInteger;}
QMasterRESEP.AsString:=QKPkp.AsString;
end;

procedure TReturKeGWFrm.LookkelbChange(Sender: TObject);
begin
{if Lookkelb.Text='LUSI' then
begin
...
procedure TReturKeGWFrm.LookWarna2CloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
...
procedure TReturKeGWFrm.wwDBNavigatorInputButton1Click(Sender: TObject);
begin
Lookdesai.Enabled:=True;
end;

procedure TReturKeGWFrm.LookKonstrEnter(Sender: TObject);
begin
QLookKons.Close;
QLookKons.Open;
end;

procedure TReturKeGWFrm.LookMesinEnter(Sender: TObject);
begin
QJns_Beam.Close;
QJns_Beam.Open;
end;

procedure TReturKeGWFrm.LookKonstrCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  QMasterKONSTRUKSI.AsString:=QLookKonsNAMA_KONSTRUKSI.AsString;
end;

procedure TReturKeGWFrm.LookMesinCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
