...
type
  THTRasioFrm = class(TForm)
    ...
    QBrowseTEORITIS_EFF: TFloatField;
  ...
  begin
     if (Sender as TwwDBGrid).DataSource.DataSet.FieldByName(AFieldName).FieldKind=fkData then
        begin
          ...
          ((Sender as TwwDBGrid).DataSource.DataSet as TOracleDataSet).SetVariable('porder','order by '+(Sender as TwwDBGrid).ColumnByName(AFieldName).FieldName+vorder);
