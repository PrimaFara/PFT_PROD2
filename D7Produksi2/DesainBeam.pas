...
type
  TDesainBeamFrm = class(TForm)
    ...
    procedure CmbArahCloseUp(Sender: TObject);
...
procedure TDesainBeamFrm.CmbArahCloseUp(Sender: TObject);
begin
  QMasterKETERANGAN.AsString:=CmbArah.Text;
end;
