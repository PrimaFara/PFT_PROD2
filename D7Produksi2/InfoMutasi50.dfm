object InfoMutasi50Frm: TInfoMutasi50Frm
  Left = -16
  Top = 168
  Width = 1010
  Height = 518
  ...
  object QDump: TOracleQuery
    SQL.Strings = (
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok2'
        ...
        '  where kd_lokasi='#39'50'#39' and kd_item=a.kd_item and jns_lokasi='#39'LOK' +
        'ASI'#39' and tgl<trunc(:vsysdate))/:VRASIO AS AWAL1,'
      '0,'
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok2'
      
        '  where kd_lokasi='#39'50'#39' and kd_item=a.kd_item and jns_lokasi='#39'LOK' +
        'ASI'#39' and kd_transaksi='#39'876'#39' and tgl>=trunc(:vsysdate)and tgl<tru' +
        'nc(:vsysdate2)+1-1/86400)/:VRASIO AS masuk1,'
      '0 as masuk2,0 as masuk3,0 as masuk4,'
      '(select -sum(qty_in-qty_out) from ipisma_db4.vkartu_stok2'
      
        '  where kd_lokasi='#39'50'#39' and kd_item=a.kd_item and jns_lokasi='#39'LOK' +
        'ASI'#39' and kd_transaksi='#39'679'#39' and tgl>=trunc(:vsysdate)and tgl<tru' +
        'nc(:vsysdate2)+1-1/86400)/:VRASIO AS keluar1,'
      '(select -sum(qty_in-qty_out) from ipisma_db4.vkartu_stok2'
      
        '  where kd_lokasi='#39'50'#39' and kd_item=a.kd_item and jns_lokasi='#39'LOK' +
        'ASI'#39' and kd_transaksi='#39'680'#39' and tgl>=trunc(:vsysdate)and tgl<tru' +
  ...
  object QDump2: TOracleQuery
    SQL.Strings = (
      ...
      '(select sum(qty_in2-qty_out) from ipisma_db4.vkartu_stok2'
        ...
        '  where kd_warna=b.kd_warna and kd_lokasi='#39'50'#39' and kd_item=a.kd_' +
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok2'
        ...
        '  where kd_warna=b.kd_warna and kd_lokasi='#39'50'#39' and kd_item=a.kd_' +
        'item and jns_lokasi='#39'LOKASI'#39' and kd_transaksi='#39'876'#39' and tgl>=tru' +
      ...
      '(select -sum(qty_in-qty_out) from ipisma_db4.vkartu_stok2'
        ...
        '  where kd_warna=b.kd_warna and kd_lokasi='#39'50'#39' and kd_item=a.kd_' +
        'item and jns_lokasi='#39'LOKASI'#39' and kd_transaksi='#39'679'#39' and tgl>=tru' +
        'nc(:vsysdate)and tgl<trunc(:vsysdate2)+1-1/86400)/:VRASIO AS kel' +
        'uar1,'
      '(select -sum(qty_in-qty_out) from ipisma_db4.vkartu_stok2'
      
        '  where kd_warna=b.kd_warna and kd_lokasi='#39'50'#39' and kd_item=a.kd_' +
        'item and jns_lokasi='#39'LOKASI'#39' and kd_transaksi='#39'680'#39' and tgl>=tru' +
        'nc(:vsysdate)and tgl<trunc(:vsysdate2)+1-1/86400)/:VRASIO AS kel' +
        'uar2,'
      '0 as keluar3,0 as keluar4,0 as keluar5,0 as keluar6,'
      'a.kd_sub_kel,c.warna, '#39'ALL'#39
      
        'from ipisma_db4.vitemall a, ipisma_db4.vitem_warna3 b, ipisma_db' +
        '3.warna c'
