...
var
  LokProMes_TNFrm: TLokProMes_TNFrm;
...
procedure TLokProMes_TNFrm.FormClose(Sender: TObject;
...
procedure TLokProMes_TNFrm.BtnSimpanClick(Sender: TObject);
begin
...
procedure TLokProMes_TNFrm.QMasterAfterPost(DataSet: TDataSet);
begin
  BtnSimpan.Enabled:=True;
end;

procedure TLokProMes_TNFrm.BtnEditingClick(Sender: TObject);
begin
...
procedure TLokProMes_TNFrm.BtnBrowseClick(Sender: TObject);
begin
...
procedure TLokProMes_TNFrm.FormCreate(Sender: TObject);
begin
{  DMFrm.QSatuan.Close;}
...
procedure TLokProMes_TNFrm.wwDBGrid1TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TLokProMes_TNFrm.QMasterAfterScroll(DataSet: TDataSet);
begin
  LRecords.Caption:='Data ke '+IntToStr(DataSet.RecNo)+' dari '+IntToStr(DataSet.RecordCount)+' data';
end;

procedure TLokProMes_TNFrm.BitBtn5Click(Sender: TObject);
var
  vtitle : String;
begin
  {case PageControl1.ActivePageIndex of
...
procedure TLokProMes_TNFrm.TabSheet1Show(Sender: TObject);
begin
QMaster.Close;
  QMaster.Open;
...
procedure TLokProMes_TNFrm.QMasterNewRecord(DataSet: TDataSet);
begin
  QMasterKD_LOKASI.AsString:='50';
  //QMasterISAKTIF.AsString:='1';
end;

procedure TLokProMes_TNFrm.FormCloseQuery(Sender: TObject;
...
procedure TLokProMes_TNFrm.wwDBGrid1DblClick(Sender: TObject);
var
...
procedure TLokProMes_TNFrm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TLokProMes_TNFrm.LookMesinCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
   if modified then
  begin
...
procedure TLokProMes_TNFrm.BtnExportClick(Sender: TObject);
begin
  if QMaster.Active then
  begin
     DMFrm.SaveDialog1.DefaultExt:='XLK';
     DMFrm.SaveDialog1.Filter:='Excel files (*.XLK)|*.XLK';
     DMFrm.SaveDialog1.FileName:='DAFTAR LOKASI PROSES PERTENUNAN';
     wwDBGrid1.ExportOptions.TitleName:='DAFTAR LOKASI PROSES PERTENUNAN';
       if DMFrm.SaveDialog1.Execute then
       begin
         try
...
procedure TLokProMes_TNFrm.LookMesinEnter(Sender: TObject);
begin
QKD_Mesin.Close;
QKD_Mesin.Open;
end;

procedure TLokProMes_TNFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TLokProMes_TNFrm.BtnOk2Click(Sender: TObject);
begin
...
procedure TLokProMes_TNFrm.TabSheet2Show(Sender: TObject);
begin
  QJns_Msn.Open;
...
procedure TLokProMes_TNFrm.SpeedButton1Click(Sender: TObject);
begin
  if BtnSimpan.Enabled then
    ShowMessage('Simpan/ Posting Data Dulu !')
    else
