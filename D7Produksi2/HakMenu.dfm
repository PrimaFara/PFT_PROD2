object HakMenuFrm: THakMenuFrm
  ...
  object QBrowse: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      0400000005000000040000005449504501000000000005000000565553455201
      00000000000A0000004B45544552414E47414E010000000000060000004B445F
      444956010000000000070000004953414B544946010000000000}
    ReadOnly = True
  ...
  object QMaster2: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db4.menu_tipe a')
    QBEDefinition.QBEFieldDefs = {
      040000000200000004000000544950450100000000000A0000004B4554455241
      4E47414E010000000000}
    Session = DMFrm.OS
  ...
  object QMaster3: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db4.menu_tipe_detail a'
      'where tipe = :tip'
      'order by imenu')
    Variables.Data = {
      0300000001000000040000003A544950050000000400000041444D0000000000}
    QBEDefinition.QBEFieldDefs = {
