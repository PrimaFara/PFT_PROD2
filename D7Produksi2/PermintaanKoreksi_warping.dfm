object PermintaanKoreksi_warpingFrm: TPermintaanKoreksi_warpingFrm
  Left = 215
  Top = 106
  Width = 1010
  Height = 580
  Caption = '864. Koreksi Warping'
  Color = clBtnFace
  ...
  object Qitem_ko: TOracleDataSet
    SQL.Strings = (
      'select a.* from ipisma_db4.vstok_kor0_temp a'
      '--where qty3 <>0'
  ...
  object OracleQuery1: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_mutasi_kor0_v6(:pawal,:pakhir);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
      ...
      '')
    Variables.Data = {
      0300000001000000040000003A42554B0300000004000000F4540A0000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000003000000040000004157414C01000000000005000000414B48495201
