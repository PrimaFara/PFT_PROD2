...
begin
  ...
  begin
    ...
    t13:=t13+QMBTQTY_KOREKSI_OUT.AsFloat;
    t14:=t14+QMBTqty_akhir.AsFloat;
    QMBT.Next;
  end;
  ...
  wwDBGrid5.ColumnByName('QTY_KOREKSI_OUT').FooterValue:=FormatFloat('#,##0.##;(#,##0.##);-',t13);
  wwDBGrid5.ColumnByName('qty_akhir').FooterValue:=FormatFloat('#,##0.##;(#,##0.##);-',t14);
...
begin
  ...
  wwDBGrid5.ColumnByName('QTY_KOREKSI_OUT').FooterValue:=FormatFloat('#.#,#;(#.#,#)',t13);
  wwDBGrid5.ColumnByName('qty_akhir').FooterValue:=FormatFloat('#,##0.##;(#,##0.##);-',t14);
end;
