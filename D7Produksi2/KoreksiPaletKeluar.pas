...
type
  TKoreksiPaletKeluarFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
    PanelMain: TPanel;
    PanelHeader: TPanel;
...
var
  KoreksiPaletKeluarFrm: TKoreksiPaletKeluarFrm;
...
uses DM, Pembelian, ValidasiPenyerahanBB, KelosKeluar, KelosMasuk,
  KoreksiKelosMasuk, KoreksiKelosKeluar, KoreksiCikalanKeluar;
...
//  if BPBFrm=Nil then
  begin
    ...
    KoreksiPaletKeluarFrm:=KoreksiPaletKeluarFrm.Create(Application);
    KoreksiPaletKeluarFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       KoreksiPaletKeluarFrm.QMaster.ReadOnly:=True;
       KoreksiPaletKeluarFrm.QDetail.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    KoreksiPaletKeluarFrm.Caption:=UpperCase(pkode+pjudul);
    KoreksiPaletKeluarFrm.vkode:=pkode;
   // ValidasiPenyerahanBBFrm.vjns_lokasi:=pjns_lokasi;
   // ValidasiPenyerahanBBFrm.vjns_brg:=pjns_brg;
    KoreksiPaletKeluarFrm.QTransaksi.Open;

    KoreksiPaletKeluarFrm.PanelHeader.Caption:=KoreksiPaletKeluarFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+KoreksiPaletKeluarFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    KoreksiPaletKeluarFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    KoreksiPaletKeluarFrm.wwDBGrid1.IniAttributes.SectionName:=KoreksiPaletKeluarFrm.Caption+'1';
    KoreksiPaletKeluarFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    KoreksiPaletKeluarFrm.wwDBGrid1.LoadFromIniFile;
    KoreksiPaletKeluarFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    KoreksiPaletKeluarFrm.wwDBGrid2.IniAttributes.SectionName:=KoreksiPaletKeluarFrm.Caption+'2';
    KoreksiPaletKeluarFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    KoreksiPaletKeluarFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,KoreksiPaletKeluarFrm.Caption+'1',KoreksiPaletKeluarFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,KoreksiPaletKeluarFrm.Caption+'2',KoreksiPaletKeluarFrm.wwDBGrid2);
    KoreksiPaletKeluarFrm.wwDBSpinLine1.Value:=KoreksiPaletKeluarFrm.wwDBGrid1.RowHeightPercent;
    KoreksiPaletKeluarFrm.wwDBSpinLine2.Value:=KoreksiPaletKeluarFrm.wwDBGrid2.RowHeightPercent;
...
procedure TKoreksiPaletKeluarFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'1',wwDBGrid1);
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   KoreksiPaletKeluarFrm:=Nil;
end;

procedure TKoreksiPaletKeluarFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TKoreksiPaletKeluarFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TKoreksiPaletKeluarFrm.BtnOkClick(Sender: TObject);
begin
...
procedure TKoreksiPaletKeluarFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKoreksiPaletKeluarFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TKoreksiPaletKeluarFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TKoreksiPaletKeluarFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TKoreksiPaletKeluarFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TKoreksiPaletKeluarFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TKoreksiPaletKeluarFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TKoreksiPaletKeluarFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TKoreksiPaletKeluarFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
 // ppNo.AsInteger:=0;
end;

procedure TKoreksiPaletKeluarFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TKoreksiPaletKeluarFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TKoreksiPaletKeluarFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TKoreksiPaletKeluarFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TKoreksiPaletKeluarFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiPaletKeluarFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TKoreksiPaletKeluarFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TKoreksiPaletKeluarFrm.Label5Click(Sender: TObject);
begin
...
procedure TKoreksiPaletKeluarFrm.LookKonstruksiEnter(Sender: TObject);
begin
QBarang.Open;
...
procedure TKoreksiPaletKeluarFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TKoreksiPaletKeluarFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QTime.Open;
...
procedure TKoreksiPaletKeluarFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
  QTransaksi.DeclareVariable('kd_transaksi', otString);
  QTransaksi.SQL.Text:='select a.* from '+cUserTabel+'vtransaksi a where a.kd_transaksi=:kd_transaksi';
  QTransaksi.SetVariable('kd_transaksi','880');//vkode);
end;

procedure TKoreksiPaletKeluarFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TKoreksiPaletKeluarFrm.FormCloseQuery(Sender: TObject;
...
procedure TKoreksiPaletKeluarFrm.QMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TKoreksiPaletKeluarFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TKoreksiPaletKeluarFrm.QLokasiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TKoreksiPaletKeluarFrm.LookLokasiEnter(Sender: TObject);
begin
  //QLokasi.Open;
end;

procedure TKoreksiPaletKeluarFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
  {if vjns_brg<>'' then
  begin
...
procedure TKoreksiPaletKeluarFrm.LookKonstruksiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TKoreksiPaletKeluarFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TKoreksiPaletKeluarFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiPaletKeluarFrm.FormShow(Sender: TObject);
begin
//  PanelHeader.Caption:=QTransaksiKD_TRANSAKSI.AsString+'. '+UpperCase(Caption);
end;

procedure TKoreksiPaletKeluarFrm.LookWarnaEnter(Sender: TObject);
begin
  DMFrm.QWarna.Open;
end;

procedure TKoreksiPaletKeluarFrm.QHasilCelupBeforeOpen(
  DataSet: TDataSet);
begin
  QHasilCelup.SetVariable('NO_NOTA',wwDBEdit1.Text);
end;

procedure TKoreksiPaletKeluarFrm.Button1Click(Sender: TObject);
begin
...
procedure TKoreksiPaletKeluarFrm.LookResepEnter(Sender: TObject);
begin
  DMFrm.QResep.Open;
end;

procedure TKoreksiPaletKeluarFrm.LookResepUserButton1Click(
...
procedure TKoreksiPaletKeluarFrm.QDetailAfterPost(DataSet: TDataSet);
begin
//ShowMessage('dfdsf');

end;

procedure TKoreksiPaletKeluarFrm.cbPostClick(Sender: TObject);
begin
//DBText3.Caption:='';
end;

procedure TKoreksiPaletKeluarFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.Open;
...
procedure TKoreksiPaletKeluarFrm.QTotalBeforeQuery(Sender: TOracleDataSet);
begin
QTotal.SetVariable('no_reg',QMasterNO_REG.AsInteger);
end;

procedure TKoreksiPaletKeluarFrm.TabSheet2Show(Sender: TObject);
begin
QBrowse.Close;
QBrowse.Open;
QBrowse.Refresh;
...
procedure TKoreksiPaletKeluarFrm.BtnPrintInputClick(Sender: TObject);
begin
QuickRep1.Preview;
end;

procedure TKoreksiPaletKeluarFrm.BtnOk1Click(Sender: TObject);
begin
...
procedure TKoreksiPaletKeluarFrm.QBrowseRekapAfterScroll(DataSet: TDataSet);
begin
