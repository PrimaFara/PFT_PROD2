object HTRasioFrm: THTRasioFrm
  Left = 209
  Top = 126
  Width = 1032
  Height = 659
  Caption = 'Pengaturan Rasio'
  Color = clBtnFace
      ...
      object TabSheet1: TTabSheet
        ...
        object PanelMaster: TPanel
          ...
          object GroupBox1: TGroupBox
            ...
            Width = 553
            Height = 49
            Caption = ' Periode Produksi Tenun '
            TabOrder = 1
            DesignSize = (
              553
              49)
            ...
            object wwDBDateTimePicker1: TwwDBDateTimePicker
              ...
              OnEnter = wwDBDateTimePicker1Enter
            end
        ...
        object PanelDetail: TPanel
          ...
          DesignSize = (
            808
            282)
          object LabelBannerDetail: TLabel
            Left = 0
            Top = 269
            Width = 808
            Height = 13
        ...
        object PanelBrowse: TPanel
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'LOOM'#9'10'#9'LOOM'#9'F'
              'NO_RESEP'#9'15'#9'RESEP'#9'F'
              'ISPOST'#9'3'#9'ISPOST'#9'F'
              'KETERANGAN'#9'15'#9'KETERANGAN'#9'F'
              'NO_SERI_BEAM'#9'18'#9'NO_SERI_BEAM'#9'F'
              'RM_LUSI'#9'10'#9'RM_LUSI'#9'F'
              'RM_PAKAN'#9'10'#9'RM_PAKAN'#9'F'
              'RT_LUSI'#9'10'#9'RT_LUSI'#9'F'
              'RT_PAKAN'#9'10'#9'RT_PAKAN'#9'F'
              'TEORITIS_EFF'#9'10'#9'TEORITIS_EFF'#9'F'
      ...
      object TabSheet4: TTabSheet
        ...
        object wwDBGrid3: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'NAMA_KONSTRUKSI'#9'50'#9'NAMA BENANG'#9'F'
            'KG'#9'10'#9'KG'#9'F'
            'PCS'#9'10'#9'PCS'#9'F')
          IniAttributes.Enabled = True
          IniAttributes.Delimiter = ';;'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select'
        ...
        '  a.no_reg, b.no_reg_d, a.no_nota, a.keterangan, a.ispost, a.tgl' +
        '_insert,'
      
        '  b.kp, b.konstruksi, b.loom, b.no_seri_beam, b.rm_lusi, b.rm_pa' +
        'kan, b.rt_lusi, b.rt_pakan, b.status, d.no_order as no_resep, b.' +
        'teoritis_eff'
      'from ipisma_db4.hasil_tenun_rasio a'
      'left join ipisma_db4.hasil_tenun_rasio_d b on a.no_reg=b.no_reg'
      'left join ipisma_db4.beam_isi c on b.no_seri_beam=c.no_seri_beam'
      'left join ipisma_db4.desain d on d.no_desain=c.id_rab'
      ''
      'where trunc(a.periode1)>=:pawal and trunc(a.periode1)<=:pakhir'
      ':porder')
    Variables.Data = {
      0300000003000000060000003A504157414C0C00000007000000787C09010101
    ...
    QBEDefinition.QBEFieldDefs = {
      
      00000054454F52495449535F454646010000000000}
    ReadOnly = True
    ...
    object QBrowseRT_LUSI: TFloatField
      FieldName = 'RT_LUSI'
    end
    object QBrowseRT_PAKAN: TFloatField
      FieldName = 'RT_PAKAN'
    end
    ...
    object QBrowseNO_REG_D: TFloatField
      FieldName = 'NO_REG_D'
    end
    object QBrowseNO_RESEP: TStringField
      FieldName = 'NO_RESEP'
    end
    object QBrowseTEORITIS_EFF: TFloatField
      FieldName = 'TEORITIS_EFF'
    end
  end
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db4.HASIL_TENUN_RASIO a'
      'where a.no_reg=:pno_reg')
    Variables.Data = {
      0300000001000000080000003A504E4F5F524547030000000000000000000000}
    SequenceField.Field = 'NO_REG'
    SequenceField.Sequence = 'IPISMA_DB4.NO_REG_HTR'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      
      000000000008000000504552494F444532010000000000}
    Cursor = crAppStart
    ...
    object QMasterTGL_UPDATE: TDateTimeField
      FieldName = 'TGL_UPDATE'
    end
    object QMasterOPR_UPDATE: TStringField
    ...
    object QMasterPERIODE1: TDateTimeField
      FieldName = 'PERIODE1'
    end
    object QMasterPERIODE2: TDateTimeField
      FieldName = 'PERIODE2'
    end
  end
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db4.hasil_tenun_rasio_d a'
      'where a.no_reg=:no_reg'
      'order by a.kp, a.loom, a.no_seri_beam')
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
      5F45464601000000000006000000535441545553010000000000}
    Master = QMaster
    MasterFields = 'NO_REG'
    DetailFields = 'NO_REG'
    RefreshOptions = [roAfterInsert, roAfterUpdate]
    ...
    object QDetailRT_LUSI: TFloatField
      FieldName = 'RT_LUSI'
    end
    object QDetailRT_PAKAN: TFloatField
      FieldName = 'RT_PAKAN'
    end
    ...
    object QDetailLOOM: TStringField
      FieldName = 'LOOM'
      Size = 30
    end
    ...
    object QDetailTEORITIS_EFF: TFloatField
      FieldName = 'TEORITIS_EFF'
    end
  ...
  object QAmbil_Data: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_palet_keluar(:qno_reg,:qno_nota);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QCek_KM: TOracleDataSet
    SQL.Strings = (
        ...
        'select no_bukti from ipisma_db4.palet where no_bukti=:pbukti and' +
        ' no_bukti like '#39'876%'#39)
  ...
  object QBarang: TOracleDataSet
    SQL.Strings = (
      'select distinct b.*, c.no_benang as pakan, c.nama_konstruksi'
      'from ipisma_db4.konversi_beam b'
      'left join ('
      
        '     select distinct a.*, b.nama_konstruksi from ipisma_db4.KODE' +
        '_PROD_KONS_D a'
      
        '     left join (select distinct kp, (lusi||'#39' x '#39'||pakan) as nama' +
        '_konstruksi from ipisma_db4.kode_prod_kons'
      '     ) b on a.kp=b.kp'
      'order by a.kp'
      ') c on b.kp=c.kp'
      'where b.aktif = '#39'1'#39
      'order by b.kp, c.no_benang, b.mesin asc'
      ''
      ''
      ''
      ''
      ...
      ''
        ...
        '/*select distinct b.*, c.lusi||'#39' x '#39'||c.pakan as pakan from ipis' +
        'ma_db4.konversi_beam b'
      'left join ipisma_db4.kode_prod_kons c on b.kp=c.kp'
      'where b.aktif = '#39'1'#39
      'order by b.kp asc*/'
      ''
      ''
      '')
    QBEDefinition.QBEFieldDefs = {
      040000000F000000040000004B4F4445010000000000050000004D4553494E01
      ...
      000500000050414B414E0100000000000F0000004E414D415F4B4F4E53545255
      4B5349010000000000}
    Session = DMFrm.OS
    Left = 336
    Top = 344
    object QBarangKP: TStringField
      DisplayWidth = 20
      FieldName = 'KP'
      Required = True
    end
    object QBarangMESIN: TStringField
      DisplayWidth = 20
      FieldName = 'MESIN'
      Size = 100
    end
    object QBarangPAKAN: TStringField
    ...
    object QBarangAKTIF: TStringField
      FieldName = 'AKTIF'
      Visible = False
      Size = 1
    end
    object QBarangEDIT: TStringField
      FieldName = 'EDIT'
      Visible = False
      Size = 1
    end
    object QBarangTGL_INSERT: TDateTimeField
      FieldName = 'TGL_INSERT'
      Visible = False
    end
    object QBarangTGL_EDIT: TDateTimeField
      FieldName = 'TGL_EDIT'
      Visible = False
    end
    object QBarangOPR_INSERT: TStringField
      FieldName = 'OPR_INSERT'
      Visible = False
      Size = 30
    end
    object QBarangOPR_EDIT: TStringField
      FieldName = 'OPR_EDIT'
      Visible = False
      Size = 30
    end
    object QBarangRASIO_PAKAN: TFloatField
      FieldName = 'RASIO_PAKAN'
      Visible = False
    end
    object QBarangRM_LUSI: TFloatField
      FieldName = 'RM_LUSI'
      Visible = False
    end
    object QBarangRM_PAKAN: TFloatField
      FieldName = 'RM_PAKAN'
      Visible = False
    end
    object QBarangNAMA_KONSTRUKSI: TStringField
  ...
  object QBrowseRekap: TOracleDataSet
    SQL.Strings = (
        ...
        'select t.kd_konstruksi,t.nama_konstruksi,sum(t.kg) as kg,sum(t.p' +
        'cs) as pcs from ipisma_db4.vpalet t'
      'where trunc(tanggal)>=:pawal and trunc(tanggal)<=:pakhir'
      'group by (t.kd_konstruksi, t.nama_konstruksi)'
      'order by t.nama_konstruksi')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      0000004B47010000000000030000005043530100000000000F0000004E414D41
      5F4B4F4E535452554B5349010000000000}
    ReadOnly = True
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 880
    ...
    object QBrowseRekapNAMA_KONSTRUKSI: TStringField
      FieldName = 'NAMA_KONSTRUKSI'
      Required = True
      Size = 50
    end
  ...
  object QAmbilData: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_ambil_beam(:pno_reg, :ptgl, :ptgl2);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      0300000003000000050000003A5054474C0C0000000000000000000000080000
      003A504E4F5F524547030000000000000000000000060000003A5054474C320C
      0000000000000000000000}
    Cursor = crSQLWait
    Left = 624
    Top = 64
  end
  object QUpdateSts: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_update_beam_sts(:pno_reg_d);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      03000000010000000A0000003A504E4F5F5245475F4403000000000000000000
      0000}
    Cursor = crSQLWait
    Left = 672
    Top = 88
