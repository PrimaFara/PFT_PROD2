object LapHasilTenunFrm: TLapHasilTenunFrm
  Left = 215
  Top = 124
  Width = 1136
  Height = 614
    ...
    object TabSheet2: TTabSheet
      ...
      object QuickRep1: TQuickRep
        ...
        object SummaryBand1: TQRBand
          ...
          object QRExpr1: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QBrowse.JML_POT_TENUN)'
            FontSize = 8
          end
          ...
          object QRExpr2: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QBrowse.PROSENTASE)'
            FontSize = 8
          end
          ...
          object QRExpr4: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QBrowse.JML_POT_BS)'
            FontSize = 8
          end
        ...
        object TitleBand1: TQRBand
          ...
          object QRLabel1: TQRLabel
            ...
            AutoSize = True
            AutoStretch = False
            Caption = 'LAPORAN PRODUKSI TENUN'
            Color = clWhite
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -19
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'LOKASI_TENUN'#9'20'#9'PERTENUNAN'#9'F'
          'KP'#9'6'#9'GRUP'#9'F'
          'KONSTRUKSI'#9'5'#9'J-S'#9'F'
          'JML_MESIN'#9'10'#9'MESIN'#9'F'
          'JML_POT_TENUN'#9'10'#9'JUMLAH~PRODUKSI'#9'F'
          'JML_POT_BS'#9'10'#9'JUMLAH~BS'#9'F'
          'PROSENTASE'#9'10'#9'PROSENTASE'#9'F'
          'EFF'#9'10'#9'EFF'#9'F')
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'JML_MESIN'#9'10'#9'JUMLAH'#9'F'#9'MESIN'
          'MESIN'#9'20'#9'JENIS'#9'F'#9'MESIN'
          'KP'#9'15'#9'KP'#9'F'
          'KONSTRUKSI'#9'35'#9'KONSTRUKSI'#9'F'
          'JML_POT_TENUN'#9'10'#9'JUMLAH~PRODUKSI'#9'F'
          'JML_POT_BK'#9'10'#9'JUMLAH~BK'#9'F'
          'JML_POT_BS'#9'10'#9'JUMLAH~BS'#9'F'
          'PROSENTASE'#9'10'#9'PROSENTASE'#9'F'
          'EFF'#9'10'#9'EFF'#9'F')
        IniAttributes.Enabled = True
    ...
    object TabSheet3: TTabSheet
      ...
      object wwDBGrid3: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'JML_POT_TENUN'#9'10'#9'JUMLAH~TENUN'#9'F'
          'JML_POT_BS'#9'10'#9'JUMLAH~BS'#9'F'
          'PROSENTASE'#9'10'#9'PROSENTASE'#9'F'
          'EFF'#9'10'#9'EFF'#9'F')
        IniAttributes.Enabled = True
    ...
    object TabSheet4: TTabSheet
      ...
      object wwDBGrid4: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'QTY_A'#9'10'#9'PRODUKSI'#9'F'#9'REGU A'
          'BK_A'#9'10'#9'BK'#9'F'#9'REGU A'
          'BS_A'#9'10'#9'BS'#9'F'#9'REGU A'
          'QTY_B'#9'10'#9'PRODUKSI'#9'F'#9'REGU B'
          'BK_B'#9'10'#9'BK'#9'F'#9'REGU B'
          'BS_B'#9'10'#9'BS'#9'F'#9'REGU B'
          'QTY_C'#9'10'#9'PRODUKSI'#9'F'#9'REGU C'
          'BK_C'#9'10'#9'BK'#9'F'#9'REGU C'
          'BS_C'#9'10'#9'BS'#9'F'#9'REGU C'
          'QTY_D'#9'10'#9'PRODUKSI'#9'F'#9'REGU D'
          'BK_D'#9'10'#9'BK'#9'F'#9'REGU D'
          'BS_D'#9'10'#9'BS'#9'F'#9'REGU D'
          'QTY_E'#9'10'#9'PRODUKSI'#9'F'#9'REGU E'
          'BK_E'#9'10'#9'BK'#9'F'#9'REGU E'
          'BS_E'#9'10'#9'BS'#9'F'#9'REGU E'
          'QTY_F'#9'10'#9'PRODUKSI'#9'F'#9'REGU F'
          'BK_F'#9'10'#9'BK'#9'F'#9'REGU F'
          'BS_F'#9'10'#9'BS'#9'F'#9'REGU F'
          'QTY_G'#9'10'#9'PRODUKSI'#9'F'#9'REGU G'
          'BK_G'#9'10'#9'BK'#9'F'#9'REGU G'
          'BS_G'#9'10'#9'BS'#9'F'#9'REGU G'
          'JML_PROD'#9'15'#9'JUMLAH~PROD'#9'F'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      '/*select a.* from ipisma_db4.v_lap_tenun_per_grup a*/'
      ''
      'select * from('
      'select a.* from ipisma_db4.V_LAP_TENUN_KONSTR_LOK a'
    ...
    QBEDefinition.QBEFieldDefs = {
      
      0100000000000A0000004A4D4C5F504F545F424B010000000000}
    ...
    object QBrowseJML_MESIN: TFloatField
      FieldName = 'JML_MESIN'
    end
    ...
    object QBrowseJML_POT_TENUN: TFloatField
      FieldName = 'JML_POT_TENUN'
    end
    object QBrowseJML_POT_BS: TFloatField
      FieldName = 'JML_POT_BS'
    end
    object QBrowsePROSENTASE: TFloatField
    ...
    object QBrowseJML_POT_BK: TFloatField
      FieldName = 'JML_POT_BK'
    end
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(jml_pot_tenun) as potong_tenun, sum(jml_pot_bs) as po' +
        'tong_bs '
      
        'from ipisma_db4.V_LAP_TENUN_KONSTR_LOK /*v_lap_tenun_konstruksi*' +
        '/')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000020000000C000000504F544F4E475F54454E554E0100000000000900
      0000504F544F4E475F4253010000000000}
    ...
    Left = 968
    Top = 312
    object QBrowseTotalPOTONG_TENUN: TFloatField
      FieldName = 'POTONG_TENUN'
    end
    object QBrowseTotalPOTONG_BS: TFloatField
      FieldName = 'POTONG_BS'
    end
  end
  object QBrowse2: TOracleDataSet
    ...
    Variables.Data = {
      ...
      050000003A4C4F4F4D0500000002000000350000000000}
    QBEDefinition.QBEFieldDefs = {
      
      4B010000000000090000004A4D4C5F4D4553494E010000000000}
    MasterFields = 'konstruksi'
    RefreshOptions = [roAfterInsert]
    Session = DMFrm.OS
    ...
    object QBrowse2JML_MESIN: TFloatField
      FieldName = 'JML_MESIN'
    end
    ...
    object QBrowse2JML_POT_TENUN: TFloatField
      FieldName = 'JML_POT_TENUN'
    end
    object QBrowse2JML_POT_BS: TFloatField
      FieldName = 'JML_POT_BS'
    end
    object QBrowse2PROSENTASE: TFloatField
      FieldName = 'PROSENTASE'
    end
    object QBrowse2EFF: TFloatField
      FieldName = 'EFF'
    end
    object QBrowse2LOKASI_TENUN: TStringField
      FieldKind = fkCalculated
      FieldName = 'LOKASI_TENUN'
      Size = 15
      Calculated = True
    ...
    object QBrowse2JML_POT_BK: TFloatField
      FieldName = 'JML_POT_BK'
    end
    ...
    object QBrowse2TOT_PERSEN: TFloatField
      FieldKind = fkCalculated
      FieldName = 'TOT_PERSEN'
      Calculated = True
    end
  end
  ...
  object QBrowse3: TOracleDataSet
    SQL.Strings = (
      'select a.* from ipisma_db4.v_lap_tenun_konstruksi a')
    QBEDefinition.QBEFieldDefs = {
      
      46010000000000}
    ...
    object QBrowse3MESIN: TFloatField
      FieldName = 'MESIN'
    end
    ...
    object QBrowse3JML_POT_BS: TFloatField
      FieldName = 'JML_POT_BS'
    end
    object QBrowse3PROSENTASE: TFloatField
      FieldName = 'PROSENTASE'
    end
    object QBrowse3EFF: TFloatField
      FieldName = 'EFF'
    end
  end
  ...
  object QAmbil_Data: TOracleQuery
    SQL.Strings = (
      'begin'
        ...
        '  ipisma_db4.proc_V_LAP_TENUN_GRUP (:pawal,:pakhir); /*Proc_vlap' +
        '_tenun_per_grup(:pawal,:pakhir, :hari);*/'
      ' /*commit;*/'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QAmbil_Data2: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_V_LAP_TENUN_KONSTR_LOK(:pawal,:pakhir);'
      '  --commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      0300000002000000060000003A504157414C0C00000007000000787C0B0B0101
      0100000000070000003A50414B4849520C00000007000000787C0B0B01010100
      000000}
    Left = 880
    Top = 360
  end
  object QAmbil_Data3: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_vlap_tenun_tot_kons(:pawal,:pakhir);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      0300000002000000060000003A504157414C0C00000007000000787A0A010101
      0100000000070000003A50414B4849520C00000007000000787A0A1F01010100
      000000}
    Left = 880
    Top = 408
  end
  object QBrowseTotal01: TOracleDataSet
    SQL.Strings = (
      
        'select sum(jml_pot_tenun) as jml_prod, sum(jml_pot_bs) as jml_bs' +
        ', '
      '(sum(jml_pot_bs)/sum(jml_pot_tenun))*100 as prosentase  '
      'from ipisma_db4.V_LAP_TENUN_KONSTR_LOK /*v_lap_tenun_per_grup*/')
    QBEDefinition.QBEFieldDefs = {
      0400000003000000080000004A4D4C5F50524F44010000000000060000004A4D
      4C5F42530100000000000A00000050524F53454E54415345010000000000}
    MasterFields = 'konstruksi'
    RefreshOptions = [roAfterInsert]
    Session = DMFrm.OS
    OnFilterRecord = QBrowseFilterRecord
    Left = 1048
    Top = 320
    object QBrowseTotal01JML_PROD: TFloatField
      FieldName = 'JML_PROD'
    end
    object QBrowseTotal01JML_BS: TFloatField
      FieldName = 'JML_BS'
    end
    object QBrowseTotal01PROSENTASE: TFloatField
      FieldName = 'PROSENTASE'
    end
  end
  object QBrowseTotal02: TOracleDataSet
    SQL.Strings = (
      'select '
      'sum(jml_mesin) as jml_mesin,'
      'sum(jml_pot_tenun) as jml_prod,'
      'sum(jml_pot_bk) as jml_bk, '
      'sum(jml_pot_bs) as jml_bs, '
      '(sum(jml_pot_bs)/sum(jml_pot_tenun))*100 as prosentase  '
      'from ipisma_db4.V_LAP_TENUN_KONSTR_LOK'
      'where lokasi like:loom'
      ':myparam')
    Variables.Data = {
      0300000002000000080000003A4D59504152414D010000000000000000000000
      050000003A4C4F4F4D0500000002000000350000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000005000000080000004A4D4C5F50524F44010000000000060000004A4D
      4C5F42530100000000000A00000050524F53454E544153450100000000000600
      00004A4D4C5F424B010000000000050000004D4553494E010000000000}
    MasterFields = 'konstruksi'
    RefreshOptions = [roAfterInsert]
    Session = DMFrm.OS
    OnFilterRecord = QBrowseFilterRecord
    Left = 1048
    Top = 368
    object QBrowseTotal02JML_PROD: TFloatField
      FieldName = 'JML_PROD'
    end
    object QBrowseTotal02JML_BS: TFloatField
      FieldName = 'JML_BS'
    end
    object QBrowseTotal02PROSENTASE: TFloatField
      FieldName = 'PROSENTASE'
    end
    object QBrowseTotal02JML_BK: TFloatField
      FieldName = 'JML_BK'
    end
    object QBrowseTotal02MESIN: TFloatField
      FieldName = 'MESIN'
    end
  end
  object QBrowseTotal03: TOracleDataSet
    SQL.Strings = (
      
        'select sum(jml_pot_tenun) as jml_prod, sum(jml_pot_bs) as jml_bs' +
        ', (sum(jml_pot_bs)/sum(jml_pot_tenun))*100 as prosentase  from i' +
        'pisma_db4.v_lap_tenun_konstruksi'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
    ...
    Left = 1048
    Top = 416
    object QBrowseTotal03JML_PROD: TFloatField
      FieldName = 'JML_PROD'
    end
    object QBrowseTotal03JML_BS: TFloatField
      FieldName = 'JML_BS'
    end
    object QBrowseTotal03PROSENTASE: TFloatField
      FieldName = 'PROSENTASE'
    end
  end
  object QAmbil_Data4: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.PROC_V_LAP_DEF_TN_PROSES_GRUP2(:pawal,:pakhir);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      0300000002000000060000003A504157414C0C00000000000000000000000700
  ...
  object QBrowse4: TOracleDataSet
    ...
    object QBrowse4LOKASI: TStringField
      FieldName = 'LOKASI'
      Size = 30
    end
    ...
    object QBrowse4RESEP: TStringField
      FieldName = 'RESEP'
      Size = 25
    end
    object QBrowse4SISIR: TIntegerField
      FieldName = 'SISIR'
    end
    object QBrowse4PICK: TIntegerField
      FieldName = 'PICK'
    end
    object QBrowse4BK_A: TFloatField
      FieldName = 'BK_A'
    end
    object QBrowse4BS_A: TFloatField
      FieldName = 'BS_A'
    end
    object QBrowse4BK_B: TFloatField
      FieldName = 'BK_B'
    end
    object QBrowse4BS_B: TFloatField
      FieldName = 'BS_B'
    end
    object QBrowse4BK_C: TFloatField
      FieldName = 'BK_C'
    end
    object QBrowse4BS_C: TFloatField
      FieldName = 'BS_C'
    end
    object QBrowse4BK_D: TFloatField
      FieldName = 'BK_D'
    end
    object QBrowse4BS_D: TFloatField
      FieldName = 'BS_D'
    end
    object QBrowse4BK_E: TFloatField
      FieldName = 'BK_E'
    end
    object QBrowse4BS_E: TFloatField
      FieldName = 'BS_E'
    end
    object QBrowse4BK_F: TFloatField
      FieldName = 'BK_F'
    end
    object QBrowse4BS_F: TFloatField
      FieldName = 'BS_F'
    end
    object QBrowse4BK_G: TFloatField
      FieldName = 'BK_G'
    end
    object QBrowse4BS_G: TFloatField
      FieldName = 'BS_G'
    end
    object QBrowse4JML_PROD: TFloatField
      FieldKind = fkCalculated
      FieldName = 'JML_PROD'
      Calculated = True
    end
    object QBrowse4QTY_A: TFloatField
      FieldName = 'QTY_A'
    end
    object QBrowse4QTY_B: TFloatField
      FieldName = 'QTY_B'
    end
    object QBrowse4QTY_C: TFloatField
      FieldName = 'QTY_C'
    end
    object QBrowse4QTY_D: TFloatField
      FieldName = 'QTY_D'
    end
    object QBrowse4QTY_E: TFloatField
      FieldName = 'QTY_E'
    end
    object QBrowse4QTY_F: TFloatField
      FieldName = 'QTY_F'
    end
    object QBrowse4QTY_G: TFloatField
      FieldName = 'QTY_G'
    end
    ...
    object QBrowse4TGL_NAIK: TDateTimeField
      FieldName = 'TGL_NAIK'
    end
  end
  ...
  object QBrowseTotal04: TOracleDataSet
    SQL.Strings = (
      'SELECT * FROM (select '
      'sum(BK_A) as tot_BK_A, sum(BS_A) as tot_BS_A,'
      'sum(BK_B) as tot_BK_B, sum(BS_B) as tot_BS_B, '
      'sum(BK_C) as tot_BK_C, sum(BS_C) as tot_BS_C, '
      'sum(BK_D) as tot_BK_D, sum(BS_D) as tot_BS_D, '
      'sum(BK_E) as tot_BK_E, sum(BS_E) as tot_BS_E, '
      'sum(BK_F) as tot_BK_F, sum(BS_A) as tot_BS_F, '
      'sum(BK_G) as tot_BK_G, sum(BS_G) as tot_BS_G, '
    ...
    QBEDefinition.QBEFieldDefs = {
      
      000000}
    MasterFields = 'konstruksi'
    RefreshOptions = [roAfterInsert]
    Session = DMFrm.OS
    ...
    Left = 1040
    Top = 464
    object QBrowseTotal04TOT_BK_A: TFloatField
      FieldName = 'TOT_BK_A'
    end
    object QBrowseTotal04TOT_BS_A: TFloatField
      FieldName = 'TOT_BS_A'
    end
    object QBrowseTotal04TOT_BK_B: TFloatField
      FieldName = 'TOT_BK_B'
    end
    object QBrowseTotal04TOT_BS_B: TFloatField
      FieldName = 'TOT_BS_B'
    end
    object QBrowseTotal04TOT_BK_C: TFloatField
      FieldName = 'TOT_BK_C'
    end
    object QBrowseTotal04TOT_BS_C: TFloatField
      FieldName = 'TOT_BS_C'
    end
    object QBrowseTotal04TOT_BK_D: TFloatField
      FieldName = 'TOT_BK_D'
    end
    object QBrowseTotal04TOT_BS_D: TFloatField
      FieldName = 'TOT_BS_D'
    end
    object QBrowseTotal04TOT_BK_E: TFloatField
      FieldName = 'TOT_BK_E'
    end
    object QBrowseTotal04TOT_BS_E: TFloatField
      FieldName = 'TOT_BS_E'
    end
    object QBrowseTotal04TOT_BK_F: TFloatField
      FieldName = 'TOT_BK_F'
    end
    object QBrowseTotal04TOT_BS_F: TFloatField
      FieldName = 'TOT_BS_F'
    end
    object QBrowseTotal04TOT_BK_G: TFloatField
      FieldName = 'TOT_BK_G'
    end
    object QBrowseTotal04TOT_BS_G: TFloatField
      FieldName = 'TOT_BS_G'
    end
    object QBrowseTotal04TOTAL: TFloatField
      FieldName = 'TOTAL'
    end
    object QBrowseTotal04PROD_A: TFloatField
      FieldName = 'PROD_A'
    end
    object QBrowseTotal04PROD_B: TFloatField
      FieldName = 'PROD_B'
    end
    object QBrowseTotal04PROD_C: TFloatField
      FieldName = 'PROD_C'
    end
    object QBrowseTotal04PROD_D: TFloatField
      FieldName = 'PROD_D'
    end
    object QBrowseTotal04PROD_E: TFloatField
      FieldName = 'PROD_E'
    end
    object QBrowseTotal04PROD_F: TFloatField
      FieldName = 'PROD_F'
    end
    object QBrowseTotal04PROD_G: TFloatField
      FieldName = 'PROD_G'
    end
  end
