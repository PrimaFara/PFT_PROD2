...
type
  TBPHasilTenunKainFrm = class(TForm)
    Panel1: TPanel;
    Panel2: TPanel;
...
var
  BPHasilTenunKainFrm: TBPHasilTenunKainFrm;
...
procedure TBPHasilTenunKainFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TBPHasilTenunKainFrm.BtnOk2Click(Sender: TObject);
begin
...
procedure TBPHasilTenunKainFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TBPHasilTenunKainFrm.FormShow(Sender: TObject);
begin
  QBrowseNO_NOTA.AsString:= '1';
  QBrowse.Close;
  QBrowse.SetVariable('plokasi', HasilTenunKainFrm.QMasterSHIFT.AsString);
  QBrowse.Open;
end;

procedure TBPHasilTenunKainFrm.QBrowseNewRecord(DataSet: TDataSet);
begin
...
procedure TBPHasilTenunKainFrm.QBrowseBeforeInsert(DataSet: TDataSet);
begin
  vnota:=QBrowseNO_NOTA.AsString;
  vlokasi:=QBrowseLOKASI.AsString;
end;

procedure TBPHasilTenunKainFrm.QBrowseBeforeQuery(Sender: TOracleDataSet);
begin
  QBrowse.SetVariable('no_reg',HasilTenunKainFrm.QMasterNO_REG.AsInteger);
...
procedure TBPHasilTenunKainFrm.QTotalBeforeQuery(Sender: TOracleDataSet);
begin
  QTotal.SetVariable('no_reg',HasilTenunKainFrm.QMasterNO_REG.AsInteger);

end;

procedure TBPHasilTenunKainFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.Open;
...
procedure TBPHasilTenunKainFrm.QBrowseBeforePost(DataSet: TDataSet);
begin
...
procedure TBPHasilTenunKainFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  wwDBGrid2UpdateFooter(nil);
end;

procedure TBPHasilTenunKainFrm.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  QRLPeriode.Caption:=vTglAwal.Text+' dan '+vTglAkhir.Text;
end;

procedure TBPHasilTenunKainFrm.BitBtn2Click(Sender: TObject);
begin
  QuickRep1.Preview;
end;

procedure TBPHasilTenunKainFrm.wwCheckBox1Click(Sender: TObject);
begin
...
procedure TBPHasilTenunKainFrm.Edit1Change(Sender: TObject);
begin
...
procedure TBPHasilTenunKainFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String );
  var
  vorder: String;
begin
...
procedure TBPHasilTenunKainFrm.LookBeamEnter(Sender: TObject);
begin
  QLookBeam.Close;
...
procedure TBPHasilTenunKainFrm.LookBeamCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
  begin
