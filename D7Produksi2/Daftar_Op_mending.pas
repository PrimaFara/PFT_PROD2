...
procedure TDaftar_Op_MendingFrm.Look_OpCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
    QMasterNAMA.AsString:=QLook_OpNAMA_KARYAWAN.AsString;
    QMasterNIK_LAMA.AsString:=QLook_OpNIK_LAMA.AsString;
    QMasterNIK.AsString:=QLook_OpNIK.AsString;
  end;
end;
