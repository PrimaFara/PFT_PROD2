object HasilCelupFrm: THasilCelupFrm
      ...
      object TabSheet1: TTabSheet
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              'NO_MESIN'#9'13'#9'Nomer'#9'F'#9'MESIN'
              'QTY3'#9'6'#9'Jml'#9'F'#9'MESIN'
              'QTY4'#9'7'#9'Kps'#9'F'#9'MESIN'
              'KD_ITEM'#9'10'#9'KODE'#9'F'
              'KETERANGAN'#9'24'#9'ITEM'#9'T'
              'KD_WARNA'#9'6'#9'Kode'#9'F'#9'WARNA'
              'WARNA'#9'16'#9#9'T'#9'WARNA'
      ...
      object TabSheet2: TTabSheet
        ...
        object PanelBrowse: TPanel
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            Height = 394
            Selected.Strings = (
              'NO_NOTA'#9'15'#9'Nomer'#9'F'#9'NOTA'
              'TGL'#9'12'#9'Tanggal'#9'F'#9'NOTA'
              'SHIFTGRUP'#9'5'#9'Shift'#9'F'#9'NOTA'
              'KD_SUB_LOKASI'#9'10'#9'Mesin'#9'F'#9'MESIN TERPASANG'
              'JML'#9'5'#9'Jml'#9'F'#9'MESIN TERPASANG'
              'EFF'#9'9'#9'Eff'#9'F'#9'MESIN TERPASANG'
              'QTY3'#9'6'#9'Jml'#9'F'#9'MESIN TERPAKAI'
              'QTY4'#9'7'#9'Kps'#9'F'#9'MESIN TERPAKAI'
              'EFF_MESIN'#9'9'#9'Eff'#9'F'#9'MESIN TERPAKAI'
              'KD_ITEM'#9'10'#9'Kode'#9'F'#9'BENANG'
              'KETERANGAN'#9'20'#9'Nama'#9'F'#9'BENANG'
              'WARNA'#9'19'#9'WARNA'#9'F'
              'NO_BATCH'#9'13'#9'NO BATCH'#9'F'
              'QTY1'#9'12'#9'Kg'#9'F'#9'QTY'
              'QTY2'#9'7'#9'Pcs'#9'F'#9'QTY')
            IniAttributes.Enabled = True
            IniAttributes.Delimiter = ';;'
            IniAttributes.CheckNewFields = True
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from vhasilcelupfrm')
    QBEDefinition.QBEFieldDefs = {
      0400000017000000070000004E4F5F4E4F544101000000000005000000534849
      ...
      4553494E010000000000030000004B5053010000000000}
    ReadOnly = True
  ...
  object QMaster: TOracleDataSet
    ...
    Variables.Data = {
      0300000001000000090000003A504E4F5F4E4F5441050000000F000000373931
      2D303730362D30303030310000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QItem: TOracleDataSet
    ...
    Variables.Data = {
      0300000002000000090000003A564A4E535F4252470500000000000000000000
      000B0000003A564B445F42454E414E47050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QKg: TOracleDataSet
    SQL.Strings = (
        ...
        'rom ipisma_db4.gd_stok'
      
        'where kd_item=:kd_item and kd_sub_lokasi=:kd_lokasi and tgl<=:tg' +
        'l+1-1/86400')
    Variables.Data = {
      0300000003000000080000003A4B445F4954454D050000000000000000000000
      040000003A54474C0C00000000000000000000000A0000003A4B445F4C4F4B41
