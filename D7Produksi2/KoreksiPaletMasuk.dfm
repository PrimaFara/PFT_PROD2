object KoreksiPaletMasukFrm: TKoreksiPaletMasukFrm
  Left = 201
  Top = 65
  Width = 1074
  Height = 659
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object PanelDetail: TPanel
          ...
          object wwDBComboWarna: TwwDBComboBox
            Left = 248
            Top = 67
            Width = 137
            Height = 19
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vkoreksi_palet_masuk'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      0000000000080000004E4F5F42554B5449010000000000040000004752555001
      0000000000}
    ReadOnly = True
  ...
  object QBarang: TOracleDataSet
    SQL.Strings = (
      ...
      '    FROM ipisma_db3.item'
        ...
        '    WHERE kd_item <> '#39'30.14688'#39' and kd_kel = '#39'30'#39' /* Hindari kod' +
        'e 30.14688 dalam pemilihan ini */'
      ')'
      'WHERE rn = 1'
      ''
      
        '/*select kd_item, nama_item from ipisma_db4.vitemall_2*/ /*vstok' +
        '_kelos*/'
      ''
      '')
    QBEDefinition.QBEFieldDefs = {
