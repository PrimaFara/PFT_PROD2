...
var
  KelosKeluarFrm: TKelosKeluarFrm;
...
procedure TKelosKeluarFrm.QBrowseRekap2AfterScroll(DataSet: TDataSet);
begin
  LabelBanner2.Caption:='Record ke '+IntToStr(QBrowseRekap2.RecNo)+' dari '+FormatFloat('#,#',QBrowseRekap2.RecordCount)+' Records';
end;

procedure TKelosKeluarFrm.SpeedButton3Click(Sender: TObject);
begin
...
procedure TKelosKeluarFrm.SpeedButton4Click(Sender: TObject);
begin
...
procedure TKelosKeluarFrm.FormClose(Sender: TObject;
...
procedure TKelosKeluarFrm.FormCreate(Sender: TObject);
begin
//barcode
...
QTransaksi.Close;
QTransaksi.SetVariable('kd_transaksi','861');
QTransaksi.Open;
...
procedure TKelosKeluarFrm.BtnExportClick(Sender: TObject);
begin
{    DMFrm.SaveDialog1.FileName:=PanelHeader.Caption+' '+
  ...
  begin
     ...
     //DMFrm.SaveDialog1.FileName:='KELUAR KELOS';
...
procedure TKelosKeluarFrm.BtnOkClick(Sender: TObject);
begin
      ...
      QBrowse.SQL.Text:='select * from '+cUserTabel+'vkelos'+
        ' where tanggal>=:pawal and tanggal<=:pakhir and kd_transaksi=:kd_transaksi :porder';
  		...
  		QBrowse.SetVariable('pakhir',Trunc(vTglAkhir.Date)+1-1/86400);
			QBrowse.SetVariable('kd_transaksi',vkodeq);
...
procedure TKelosKeluarFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKelosKeluarFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TKelosKeluarFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TKelosKeluarFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TKelosKeluarFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TKelosKeluarFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TKelosKeluarFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TKelosKeluarFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TKelosKeluarFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
 // ppNo.AsInteger:=0;
end;

procedure TKelosKeluarFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TKelosKeluarFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TKelosKeluarFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TKelosKeluarFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TKelosKeluarFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TKelosKeluarFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TKelosKeluarFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TKelosKeluarFrm.Label5Click(Sender: TObject);
begin
...
procedure TKelosKeluarFrm.LookKonstruksiEnter(Sender: TObject);
begin
...
procedure TKelosKeluarFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TKelosKeluarFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
  QTransaksi.DeclareVariable('kd_transaksi', otString);
  QTransaksi.SQL.Text:='select a.* from '+cUserTabel+'vtransaksi a where a.kd_transaksi=:kd_transaksi';
  QTransaksi.SetVariable('kd_transaksi','861');//vkode);
end;

procedure TKelosKeluarFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TKelosKeluarFrm.FormCloseQuery(Sender: TObject;
...
procedure TKelosKeluarFrm.QMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TKelosKeluarFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TKelosKeluarFrm.QLokasiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TKelosKeluarFrm.LookLokasiEnter(Sender: TObject);
begin
  //QLokasi.Open;
end;

procedure TKelosKeluarFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
  {if vjns_brg<>'' then
  begin
...
procedure TKelosKeluarFrm.LookKonstruksiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TKelosKeluarFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TKelosKeluarFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TKelosKeluarFrm.FormShow(Sender: TObject);
begin
//  PanelHeader.Caption:=QTransaksiKD_TRANSAKSI.AsString+'. '+UpperCase(Caption);

end;

procedure TKelosKeluarFrm.LookWarnaEnter(Sender: TObject);
begin
  DMFrm.QWarnaBaru.Open;//DMFrm.QWarna.Open;
end;

procedure TKelosKeluarFrm.QHasilCelupBeforeOpen(
  DataSet: TDataSet);
begin
  QHasilCelup.SetVariable('NO_NOTA',wwDBEdit1.Text);
end;

procedure TKelosKeluarFrm.Button1Click(Sender: TObject);
begin
//QMaster.Post;
...
procedure TKelosKeluarFrm.LookResepEnter(Sender: TObject);
begin
  //DMFrm.QResep.Open;
end;

procedure TKelosKeluarFrm.LookResepUserButton1Click(
...
procedure TKelosKeluarFrm.QDetailAfterPost(DataSet: TDataSet);
begin
//ShowMessage('dfdsf');
{if (Dataset.State=dsEdit) and (QMasterNO_NOTA.AsString='') and (QMasterISPOST.AsString='1') then
   begin
...
procedure TKelosKeluarFrm.BitBtn1Click(Sender: TObject);
begin
...
procedure TKelosKeluarFrm.cbPostClick(Sender: TObject);
begin
DBText3.Caption:='';
end;

procedure TKelosKeluarFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.Open;
...
procedure TKelosKeluarFrm.wwDBNavigatorInputButton2Click(Sender: TObject);
begin
//QDetailNO_NOTA.AsString:=QMasterNO_NOTA.AsString;
end;

procedure TKelosKeluarFrm.QTotalBeforeQuery(Sender: TOracleDataSet);
begin
QTotal.SetVariable('no_reg',QMasterNO_REG.AsInteger);
end;

procedure TKelosKeluarFrm.TabSheet2Show(Sender: TObject);
begin
//QBrowse.Close;
//QBrowse.Open;
//QBrowse.Refresh;
...
procedure TKelosKeluarFrm.vTglAwal1Change(Sender: TObject);
begin
  vTglAkhir1.DateTime:=EndOfTheMonth(vTglAwal1.Date);
end;

procedure TKelosKeluarFrm.BtnOK1Click(Sender: TObject);
begin
   if vTglAwal1.Date>vTglAkhir1.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
    begin
    IF wwDBComboBox4.Text='LUSI' then
      begin
      //ShowMessage('Lusi');
        ...
        QAmbil_Data1.SetVariable('kel', 'LUSI');
        QAmbil_Data1.Execute;
        QBrowseRekap.Open;
        QBrowseRekap.EnableControls;
      end;
    IF wwDBComboBox4.Text='PAKAN' then
      begin
      //ShowMessage('Pakan');
        QBrowseRekap.DisableControls;
        QBrowseRekap.Close;
        ...
        QAmbil_Data1.SetVariable('pawal', vTglAwal1.Date);
        QAmbil_Data1.SetVariable('pakhir', vTglAkhir1.Date);
        QAmbil_Data1.SetVariable('kel', 'PAKAN');
        QAmbil_Data1.Execute;
        QBrowseRekap.Open;
        QBrowseRekap.EnableControls;
      end;

        IF wwDBComboBox4.Text='LUSI LAINNYA' then
      begin
      //ShowMessage('Lusi');
        QBrowseRekap.DisableControls;
        QBrowseRekap.Close;
        ...
        QAmbil_Data1.SetVariable('pawal', vTglAwal1.Date);
        QAmbil_Data1.SetVariable('pakhir', vTglAkhir1.Date);
        QAmbil_Data1.SetVariable('kel', 'LUSI LAINNYA');
        QAmbil_Data1.Execute;
        QBrowseRekap.Open;
        QBrowseRekap.EnableControls;
      end;
    IF wwDBComboBox4.Text='PAKAN LAINNYA' then
      begin
      //ShowMessage('Pakan');
        QBrowseRekap.DisableControls;
        QBrowseRekap.Close;
        ...
        QAmbil_Data1.SetVariable('pawal', vTglAwal1.Date);
        QAmbil_Data1.SetVariable('pakhir', vTglAkhir1.Date);
        QAmbil_Data1.SetVariable('kel', 'PAKAN LAINNYA');
        QAmbil_Data1.Execute;
        QBrowseRekap.Open;
        QBrowseRekap.EnableControls;
      end;
    IF wwDBComboBox4.Text='SEMUA' then
      begin
      //ShowMessage('Semua');
        QBrowseRekap.DisableControls;
        QBrowseRekap.Close;
...
procedure TKelosKeluarFrm.QBrowseRekapAfterScroll(DataSet: TDataSet);
begin
  LabelBanner1.Caption:='Record ke '+IntToStr(QBrowseRekap.RecNo)+' dari '+FormatFloat('#,#',QBrowseRekap.RecordCount)+' Records';
end;

procedure TKelosKeluarFrm.BtnExport1Click(Sender: TObject);
begin
{    DMFrm.SaveDialog1.FileName:=PanelHeader.Caption+' '+
      vTglAwal.Text+' sd '+vTglAkhir.Text+'.html';
    if DMFrm.SaveDialog1.Execute then
    begin
      try
        ...
        wwDBGrid3.ExportOptions.TitleName:='<font size=4>'+PanelHeader.Caption+'</font><br><font size=1>'+vTglAwal.Text+' sd '+vTglAkhir.Text+'</font>';
  ...
  QBrowseRekap.Open;
     DMFrm.SaveDialog1.DefaultExt:='XLK';
     DMFrm.SaveDialog1.Filter:='Excel files (*.XLK)|*.XLK';
     DMFrm.SaveDialog1.FileName:='Rekap Benang Kelos Keluar';//+vTglAwal1.Text+' s/d '+vTglAkhir1.Text;
     wwDBGrid3.ExportOptions.TitleName:='REKAP BENANG KELOS KELUAR';
       if DMFrm.SaveDialog1.Execute then
       begin
         try
         wwDBGrid3.ExportOptions.FileName:=DMFrm.SaveDialog1.FileName;
...
procedure TKelosKeluarFrm.TabSheet4Show(Sender: TObject);
begin
...
procedure TKelosKeluarFrm.BtnOK3Click(Sender: TObject);
begin
...
procedure TKelosKeluarFrm.vTglAkhir2Change(Sender: TObject);
begin
//  vTglAkhir2.DateTime:=EndOfTheMonth(vTglAwal2.Date);
end;

procedure TKelosKeluarFrm.TabSheet5Show(Sender: TObject);
begin
...
procedure TKelosKeluarFrm.vTglAwal2Change(Sender: TObject);
begin
  vTglAkhir2.DateTime:=EndOfTheMonth(vTglAwal2.Date);
end;

procedure TKelosKeluarFrm.BitBtn6Click(Sender: TObject);
begin
 if vTglAwal1.Date>vTglAkhir1.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
    begin
      ...
      QBrowseRekap.DeclareVariable('pawal',otDate);
      QBrowseRekap.DeclareVariable('pakhir',otDate);
      ...
      QBrowseDetail.DeclareVariable('mu',otString);}
  		...
  		QBrowseRekap.SetVariable('pakhir',Trunc(vTglAkhir1.Date)+1-1/86400);
...
procedure TKelosKeluarFrm.BitBtn10Click(Sender: TObject);
begin
QuickRep2.Preview;
end;

procedure TKelosKeluarFrm.BitBtn3Click(Sender: TObject);
begin
...
//  QBrowseRekap2.Open;
     DMFrm.SaveDialog1.DefaultExt:='XLK';
     DMFrm.SaveDialog1.Filter:='Excel files (*.XLK)|*.XLK';
     DMFrm.SaveDialog1.FileName:='Rekap Grup Kelos Keluar';
     wwDBGrid4.ExportOptions.TitleName:='REKAP GRUP KELOS KELUAR';
       if DMFrm.SaveDialog1.Execute then
       begin
         try
...
procedure TKelosKeluarFrm.SpeedButton1Click(Sender: TObject);
begin
...
procedure TKelosKeluarFrm.SpeedButton2Click(Sender: TObject);
begin
  if QBrowseRekap.QBEMode then
  begin
...
procedure TKelosKeluarFrm.cbStokClick(Sender: TObject);
begin
QBrowseRekap2.Filtered:=CBstok.Checked;
end;

procedure TKelosKeluarFrm.QBrowseRekap2FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
...
procedure TKelosKeluarFrm.LookWarnaDlgUserButton1Click(Sender: TObject;
  LookupTable: TDataSet);
begin
...
procedure TKelosKeluarFrm.LookWarna2CustomDlg(Sender: TObject);
begin
...
procedure TKelosKeluarFrm.BtnPrintInputClick(Sender: TObject);
begin
QuickRep3.Preview;
end;

procedure TKelosKeluarFrm.vTglAwal3Change(Sender: TObject);
begin
  vTglAkhir3.DateTime:=EndOfTheMonth(vTglAwal3.Date);
end;

procedure TKelosKeluarFrm.BitBtn2Click(Sender: TObject);
begin
...
procedure TKelosKeluarFrm.SpeedButton5Click(Sender: TObject);
begin
...
procedure TKelosKeluarFrm.SpeedButton6Click(Sender: TObject);
begin
...
procedure TKelosKeluarFrm.CheckBox1Click(Sender: TObject);
begin
QBrowseRekap3.Filtered:=CheckBox1.Checked;
end;

procedure TKelosKeluarFrm.QBrowseRekap3FilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
...
procedure TKelosKeluarFrm.BitBtn12Click(Sender: TObject);
begin
...
//  QBrowseRekap2.Open;
     DMFrm.SaveDialog1.DefaultExt:='XLK';
     DMFrm.SaveDialog1.Filter:='Excel files (*.XLK)|*.XLK';
     DMFrm.SaveDialog1.FileName:='Rekap Shift Kelos Keluar';
     wwDBGrid5.ExportOptions.TitleName:='REKAP SHIFT KELOS KELUAR';
       if DMFrm.SaveDialog1.Execute then
       begin
         try
...
procedure TKelosKeluarFrm.QBrowseRekap3AfterScroll(DataSet: TDataSet);
begin
  Label21.Caption:='Record ke '+IntToStr(QBrowseRekap3.RecNo)+' dari '+FormatFloat('#,#',QBrowseRekap3.RecordCount)+' Records';
end;

procedure TKelosKeluarFrm.BitBtn15Click(Sender: TObject);
begin
QuickRep4.Preview;
end;

procedure TKelosKeluarFrm.LookWarna2Enter(Sender: TObject);
begin
{if DTPTanggal.Date >= StrToDate('01/01/2017') then
  begin  }
//  ShowMessage('tekan kene 44444');
    ...
    QWarna.SQL.Text:='select a.*, a.rowid from ipisma_db3.warna_baru a where a.isfixed=1 :porder';
...
procedure TKelosKeluarFrm.LookGrupEnter(Sender: TObject);
begin
QGrup.Close;
QGrup.Open;
end;

procedure TKelosKeluarFrm.LookGrupCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
begin
...
procedure TKelosKeluarFrm.wwDBLookupComboDlg1Enter(Sender: TObject);
begin
QNo_bukti.Close;
QNo_bukti.Open;
...
procedure TKelosKeluarFrm.wwDBLookupComboDlg1CloseUp(Sender: TObject;
...
begin
  ...
  begin
      ...
      QNo_Bukti1.Open;
    QMasterNO_BUKTI.AsString:=QNo_buktiNO_NOTA.AsString;
    QMasterRESEP.AsString:=QNo_bukti1RESEP.AsString;
    QMasterNO_DESAIN.AsInteger:=QNo_bukti1NO_DESAIN.AsInteger;
    QMasterKETERANGAN.AsString:=QNo_bukti1KETERANGAN.AsString;
    QMasterKEL.AsString:=QNo_bukti1KEL.AsString;
    QMasterSHIFT.AsString:=QNo_bukti1SHIFT.AsString;      //210923 permintaan user
    Label27.Caption:=QMasterKEL.AsString;
    Label29.Caption:=QMasterRESEP.AsString;
  end;
end;

procedure TKelosKeluarFrm.LookWarna2CloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
...
procedure TKelosKeluarFrm.LookdesaiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
begin
...
procedure TKelosKeluarFrm.LookdesaiEnter(Sender: TObject);
begin
QStokWIP.Close;
...
procedure TKelosKeluarFrm.LookKonstrEnter(Sender: TObject);
begin
  QLookKons.close;
  QLookKons.Open;
end;

procedure TKelosKeluarFrm.LookMesinEnter(Sender: TObject);
begin
  QJns_Beam.Close;
  QJns_Beam.Open;
end;

procedure TKelosKeluarFrm.LookMesinCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  QMasterBEAM.AsString:=QJns_BeamNAMA_MESIN.AsString;
end;

procedure TKelosKeluarFrm.LookKonstrCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
if modified then
