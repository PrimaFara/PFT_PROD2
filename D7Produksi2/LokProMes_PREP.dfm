object LokProMes_PREPFrm: TLokProMes_PREPFrm
  Left = 200
  Top = 127
  Width = 1123
  Height = 602
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object Panel2: TPanel
        ...
        object BtnEditingPR: TSpeedButton
          Left = 8
          Top = 16
          Width = 75
          Height = 25
  ...
  object Panel4: TPanel
    ...
    object LTitle: TLabel
      ...
      Width = 313
      Height = 23
      Caption = 'Lokasi/Proses/Mesin Persiapan'
      Color = clTeal
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -19
  ...
  object QKD_Mesin: TOracleDataSet
    SQL.Strings = (
      ...
      'where kelompok in('#39'WARPING'#39','#39'KANJI'#39')'
      ''
      ''
      '')
    ReadBuffer = 10
