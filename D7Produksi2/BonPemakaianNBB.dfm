object BonPemakaianNBBFrm: TBonPemakaianNBBFrm
  Left = 183
  Top = 223
  Width = 783
  Height = 611
  Caption = 'Bon Pemakaian'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'KETERANGAN'#9'57'#9'Nama/ Spesifikasi [ALT]+[K]'#9'T'#9'BARANG/ BAHAN'
          'SATUAN'#9'10'#9'Satuan'#9'T'#9'BARANG/ BAHAN'
          'QTY_STOK'#9'8'#9'STOK~SAAT INI'#9'T'
          'QTY_BON'#9'10'#9'BON~BLN INI'#9'T'
  ...
  object QTransaksi: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      4C41480100000000000C00000049445F464F524D554C415349010000000000}
  ...
  object QDetail: TOracleDataSet
    ...
    Variables.Data = {
      ...
      000000}
    QBEDefinition.QBEFieldDefs = {
      0400000010000000070000004B445F4954454D0100000000000A0000004B4554
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from (select * from pmtx02.vbon_barang_nbb'
      'where kd_transaksi=:kd_transaksi)'
      ':myparam')
    Variables.Data = {
    ...
    object QBrowseNO_REG_BON: TIntegerField
      FieldName = 'NO_REG_BON'
      Required = True
    end
  end
