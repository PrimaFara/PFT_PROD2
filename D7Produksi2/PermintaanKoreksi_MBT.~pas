...
type
  TPermintaanKoreksi_MBTFrm = class(TForm)
    ...
    QBrowseAWPOT: TFloatField;
    QBrowseAWLUSI: TFloatField;
    QBrowseAWPAKAN: TFloatField;
    QBrowseSELISIH_POT: TFloatField;
    QBrowseSELISIH_PAKAN: TFloatField;
    QBrowseSELISIH_LUSI: TFloatField;
...
var
  PermintaanKoreksi_MBTFrm: TPermintaanKoreksi_MBTFrm;
...
//  if BPBFrm=Nil then
  begin
    PermintaanKoreksi_MBTFrm:=TPermintaanKoreksi_MBTFrm.Create(Application);
    PermintaanKoreksi_MBTFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       PermintaanKoreksi_MBTFrm.QMaster.ReadOnly:=True;
       PermintaanKoreksi_MBTFrm.QDetail.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    PermintaanKoreksi_MBTFrm.Caption:=UpperCase(pkode+pjudul);
    PermintaanKoreksi_MBTFrm.vkode:=pkode;//copy(pjudul,1,3);
  ...
  //  PermintaanKoreksi_kelosFrm.vjns_brg:='';
    PermintaanKoreksi_MBTFrm.QTransaksi.Open;

    PermintaanKoreksi_MBTFrm.Caption:=UpperCase(pkode+pjudul);
    PermintaanKoreksi_MBTFrm.PanelHeader.Caption:=PermintaanKoreksi_MBTFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+PermintaanKoreksi_MBTFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    PermintaanKoreksi_MBTFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    PermintaanKoreksi_MBTFrm.wwDBGrid1.IniAttributes.SectionName:=PermintaanKoreksi_MBTFrm.Caption+'1';
    PermintaanKoreksi_MBTFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    PermintaanKoreksi_MBTFrm.wwDBGrid1.LoadFromIniFile;
    PermintaanKoreksi_MBTFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    PermintaanKoreksi_MBTFrm.wwDBGrid2.IniAttributes.SectionName:=PermintaanKoreksi_MBTFrm.Caption+'2';
    PermintaanKoreksi_MBTFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    PermintaanKoreksi_MBTFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,PermintaanKoreksi_MBTFrm.Caption+'1',PermintaanKoreksi_MBTFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,PermintaanKoreksi_MBTFrm.Caption+'2',PermintaanKoreksi_MBTFrm.wwDBGrid2);
    PermintaanKoreksi_MBTFrm.wwDBSpinLine1.Value:=PermintaanKoreksi_MBTFrm.wwDBGrid1.RowHeightPercent;
    PermintaanKoreksi_MBTFrm.wwDBSpinLine2.Value:=PermintaanKoreksi_MBTFrm.wwDBGrid2.RowHeightPercent;
...
procedure TPermintaanKoreksi_MBTFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'1',wwDBGrid1);
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2); 
   Action:=caFree;
   PermintaanKoreksi_MBTFrm:=Nil;
end;

procedure TPermintaanKoreksi_MBTFrm.FormCreate(Sender: TObject);
begin
//barcode
...
QTransaksi.Close;
QTransaksi.SetVariable('kd_transaksi','880');
QTransaksi.Open;
...
procedure TPermintaanKoreksi_MBTFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_MBTFrm.BtnOkClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ...
    begin
      ...
      QBrowse.SQL.Text:='select * from ipisma_db4.VPERMINTAANKOREKSI_TENUN'+ // vpermintaankoreksi_kelosfrm'+
        ' where trunc(tanggal)>=:pawal and trunc(tanggal)<=:pakhir and kd_transaksi=:kd_transaksi :porder';
  		QBrowse.SetVariable('pawal',Trunc(vTglAwal.Date));
  		QBrowse.SetVariable('pakhir',Trunc(vTglAkhir.Date)+1-1/86400);
			QBrowse.SetVariable('kd_transaksi','880');
...
procedure TPermintaanKoreksi_MBTFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TPermintaanKoreksi_MBTFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TPermintaanKoreksi_MBTFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TPermintaanKoreksi_MBTFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TPermintaanKoreksi_MBTFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TPermintaanKoreksi_MBTFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TPermintaanKoreksi_MBTFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_MBTFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TPermintaanKoreksi_MBTFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  //ppNo.AsInteger:=0;
end;

procedure TPermintaanKoreksi_MBTFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TPermintaanKoreksi_MBTFrm.Button1Click(Sender: TObject);
begin
//  ppDesigner1.ShowModal;
end;

procedure TPermintaanKoreksi_MBTFrm.BtnDesign2Click(Sender: TObject);
begin
//  ppDesigner1.ShowModal;
end;

procedure TPermintaanKoreksi_MBTFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_MBTFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TPermintaanKoreksi_MBTFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TPermintaanKoreksi_MBTFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_MBTFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TPermintaanKoreksi_MBTFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
//  ppNo2.AsInteger:=ppNo2.AsInteger+1;
end;

procedure TPermintaanKoreksi_MBTFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_MBTFrm.BtnPrintInputClick(Sender: TObject);
begin
//  ppReportInput.Print;
end;

procedure TPermintaanKoreksi_MBTFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_MBTFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_MBTFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TPermintaanKoreksi_MBTFrm.Label5Click(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_MBTFrm.LookItemEnter(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_MBTFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_MBTFrm.QMasterNewRecord(DataSet: TDataSet);
begin
QTransaksi.Close;
QTransaksi.Open;
...
procedure TPermintaanKoreksi_MBTFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_MBTFrm.ppPageStyle1BeforePrint(Sender: TObject);
begin
//  ppNo2.AsInteger:=0;
end;

procedure TPermintaanKoreksi_MBTFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TPermintaanKoreksi_MBTFrm.FormCloseQuery(Sender: TObject;
...
procedure TPermintaanKoreksi_MBTFrm.QMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_MBTFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_MBTFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
//  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TPermintaanKoreksi_MBTFrm.QProc_Update_POBeforeQuery(Sender: TOracleQuery);
begin
//  QProc_Update_PO.SetVariable('NO_PO',QMasterNO_BUKTI.AsString);
end;

procedure TPermintaanKoreksi_MBTFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
  if LookArah.ItemIndex=0 then
    begin
...
procedure TPermintaanKoreksi_MBTFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  QDetailIBUKTI.AsInteger:=QMasterIBUKTI.AsInteger;
end;

procedure TPermintaanKoreksi_MBTFrm.QDetailBeforePost(DataSet: TDataSet);
begin
  if QDetailNO_MESIN{KD_ITEM}.AsString='' then
     begin
        ShowMessage('KP harus diisi !');
        Abort;
 //    end
{     else
...
procedure TPermintaanKoreksi_MBTFrm.QDetailCalcFields(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_MBTFrm.TabSheet3Show(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_MBTFrm.QItemBeforeOpen(DataSet: TDataSet);
begin
// QLokasi.Open;
end;

procedure TPermintaanKoreksi_MBTFrm.BitBtn1Click(Sender: TObject);
var
vuser, vpwd : string;
nota: string;
cetak : string ;
...
procedure TPermintaanKoreksi_MBTFrm.CheckBox1Click(Sender: TObject);
BEGIN
{VAR
nota: string;
cetak : string ;
...
procedure TPermintaanKoreksi_MBTFrm.wwCheckBox1Click(Sender: TObject);
{VAR
nota: string;
cetak : string ;
opr_insert : string;
