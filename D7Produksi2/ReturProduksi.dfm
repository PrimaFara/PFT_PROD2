object ReturProduksiFrm: TReturProduksiFrm
  Left = 60
  Top = 47
  Width = 1010
  Height = 659
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'KETERANGAN'#9'37'#9'ITEM'#9'F'
              'LSATUAN'#9'9'#9'SATUAN'#9'T'
              'QTY1'#9'9'#9'Bukti'#9'T'#9'QTY'
              'QTY2'#9'10'#9'Sdh. Diambil'#9'T'#9'QTY'
              'QTY3'#9'10'#9'Diambil'#9'F'#9'QTY'
              'KD_SUB_LOKASI'#9'12'#9'LOKASI ASAL'#9'F')
  ...
  object QMaster: TOracleDataSet
    ...
    QBEDefinition.QBEBackgroundColor = clNone
    QBEDefinition.QBEFieldDefs = {
      0300000021000000070000004E4F5F4E4F544101000000000C0000004B445F54
  ...
  object QDetail: TOracleDataSet
    ...
    QBEDefinition.QBEBackgroundColor = clNone
    QBEDefinition.QBEFieldDefs = {
      030000001C000000070000004B445F4954454D01000000000400000044495343
