...
procedure TBPHasilWOFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TBPHasilWOFrm.BtnOk2Click(Sender: TObject);
begin
...
procedure TBPHasilWOFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TBPHasilWOFrm.FormShow(Sender: TObject);
begin
  QBrowse.Open;
end;

procedure TBPHasilWOFrm.QBrowseNewRecord(DataSet: TDataSet);
begin
...
procedure TBPHasilWOFrm.QBrowseBeforeInsert(DataSet: TDataSet);
begin
  vnota:=QBrowseNO_NOTA.AsString;
  vlokasi:=QBrowseLOKASI.AsString;
end;

procedure TBPHasilWOFrm.QBrowseBeforeQuery(Sender: TOracleDataSet);
begin
...
procedure TBPHasilWOFrm.QTotalBeforeQuery(Sender: TOracleDataSet);
begin
  QTotal.SetVariable('no_reg',HasilwoFrm.QMasterNO_REG.AsInteger);

end;

procedure TBPHasilWOFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.Open;
...
procedure TBPHasilWOFrm.QBrowseBeforePost(DataSet: TDataSet);
begin
...
procedure TBPHasilWOFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  wwDBGrid2UpdateFooter(nil);
end;

procedure TBPHasilWOFrm.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  QRLPeriode.Caption:=vTglAwal.Text+' dan '+vTglAkhir.Text;
end;

procedure TBPHasilWOFrm.BitBtn2Click(Sender: TObject);
begin
  QuickRep1.Preview;
end;

procedure TBPHasilWOFrm.wwCheckBox1Click(Sender: TObject);
begin
...
procedure TBPHasilWOFrm.Edit1Change(Sender: TObject);
begin
...
procedure TBPHasilWOFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String );
  var
  vorder: String;
begin
...
procedure TBPHasilWOFrm.LookBeamEnter(Sender: TObject);
begin
  QLookBeam.Close;
