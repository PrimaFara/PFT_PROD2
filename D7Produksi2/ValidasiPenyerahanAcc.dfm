object ValidasiPenyerahanAccFrm: TValidasiPenyerahanAccFrm
  Left = -12
  Top = 56
  Width = 1032
  Height = 776
      ...
      object TabSheet1: TTabSheet
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Height = 403
            ControlType.Strings = (
              'KD_REK_GL;CustomEdit;LookRekening1;F')
            Selected.Strings = (
              'KD_ITEM'#9'9'#9'KODE'#9'T'
              'KETERANGAN'#9'40'#9'ITEM'#9'T'
              'LSATUAN'#9'9'#9'SATUAN'#9'T'
              'QTY1'#9'9'#9'QTY'#9'T'
              'HRG'#9'14'#9'HARGA'#9'F'
              'SUBTOTAL'#9'14'#9'SUB TOTAL'#9'T'
              'KD_SUB_LOKASI'#9'12'#9'LOKASI'#9'T'
              'KD_REK_GL'#9'14'#9'PERKIRAAN DEBET'#9'F')
      ...
      object TabSheet2: TTabSheet
        ...
        object PanelBrowse: TPanel
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            Height = 511
            Selected.Strings = (
              'NO_NOTA'#9'14'#9'NO NOTA'#9'T'
              'TANGGAL'#9'11'#9'TANGGAL'#9'T'
              'NAMA_DIVISI'#9'16'#9'NAMA DIVISI'#9'T'
              'KD_JNS_ITEM'#9'3'#9'Jns'#9'T'#9'BARANG'
              'KODE_BRG'#9'7'#9'Kode'#9'T'#9'BARANG'
              'NAMA_BRG'#9'32'#9'Nama'#9'T'#9'BARANG'
              'SATUAN'#9'6'#9'Sat'#9'T'#9'BARANG'
              'NO_PART'#9'8'#9'No Part'#9'T'#9'BARANG'
              'QTY1'#9'10'#9'QTY'#9'T'
              'HRG'#9'12'#9'HARGA'#9'F'
              'SUBTOTAL'#9'14'#9'SUB TOTAL'#9'T'
              'KD_REK_GL'#9'12'#9'Debet'#9'F'#9'REKENING PERIKIRAAN'
              'KD_REK_GL1'#9'13'#9'Kredit'#9'T'#9'REKENING PERIKIRAAN'
              'LOKASI'#9'8'#9'LOKASI'#9'T')
            IniAttributes.Enabled = True
            IniAttributes.Delimiter = ';;'
            IniAttributes.CheckNewFields = True
            ExportOptions.ExportType = wwgetHTML
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
        ...
        'select a.no_nota as no_nota, a.tgl as tanggal, a.kd_transaksi, a' +
        '.status, a.shift, a.grup, a.kd_div, a.kd_rek_gl as kd_rek_gl1, b' +
        '.nama_divisi,'
      
        '    d.kd_jns_item, c.kd_item as kode_brg, d.nama_item as nama_br' +
        'g, d.no_part, f.satuan, c.qty1 , c.hrg, c.qty1*c.hrg as subtotal' +
        ', c.kd_rek_gl,'
      
        '    c.kd_sub_lokasi as lokasi, e.kd_lokasi as jns_lokasi, c.rowi' +
        'd'
      
        'from ipisma_db4.bukti_detail c, ipisma_db4.bukti a, ipisma_db4.d' +
        'ivisi b, '
      
        '  ipisma_db4.item d, ipisma_db4.sub_lokasi e, ipisma_db4.satuan ' +
        'f'
      'where a.ibukti=c.ibukti and'
      '  a.kd_div=b.kd_div and'
      '  c.kd_sub_lokasi=e.kd_sub_lokasi and'
      '  c.kd_item=d.kd_item and d.kd_satuan=f.kd_satuan and'
      '  a.tgl>=:pawal and a.tgl<:pakhir and kd_transaksi like '#39'7%1'#39
      ':porder'
      '')
    ReadBuffer = 25
    Optimize = True
    Debug = False
    Variables.Data = {
      0300000003000000060000003A504157414C0C00000007000000786B03010101
      0100000000070000003A50414B4849520C00000007000000786B031F01010100
    ...
    QBEDefinition.QBEFieldDefs = {
      0300000014000000070000004E4F5F4E4F544101000000000700000054414E47
      ...
      4F4B4153490100000000030000004852470100000000090000004B445F52454B
      5F474C01000000000A0000004B445F52454B5F474C3101000000000B0000004B
      445F4A4E535F4954454D0100000000070000004E4F5F50415254010000000008
      000000535542544F54414C0100000000}
    Cursor = crDefault
    ReadOnly = True
    ...
    object QBrowseKD_REK_GL1: TStringField
      FieldName = 'KD_REK_GL1'
      Size = 22
    end
    ...
    object QBrowseKD_REK_GL: TStringField
      FieldName = 'KD_REK_GL'
      Size = 22
    end
    ...
    object QBrowseSUBTOTAL: TFloatField
      FieldName = 'SUBTOTAL'
      DisplayFormat = '0.0,0;(0.0,0)'
    end
  end
  ...
  object QMaster: TOracleDataSet
    ...
    QBEDefinition.QBEBackgroundColor = clNone
    QBEDefinition.QBEFieldDefs = {
      0300000026000000070000004E4F5F4E4F544101000000000C0000004B445F54
      ...
      0B0000004F55545354414E44494E470100000000090000004B445F52454B5F47
      4C0100000000}
    Cursor = crDefault
    ReadOnly = False
    LockingMode = lmCheckImmediate
    ...
    object QMasterKD_REK_GL: TStringField
      FieldName = 'KD_REK_GL'
      Size = 22
    end
  end
  ...
  object QDetail: TOracleDataSet
    ...
    object QDetailKD_REK_GL: TStringField
      FieldName = 'KD_REK_GL'
      Size = 22
    end
  ...
  object QProc_Update_PO: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_update_po(:no_po);'
      'end;')
    Session = DMFrm.OS
    ReadBuffer = 25
    Optimize = True
  ...
  object QItem: TOracleDataSet
    ...
    object QItemNO_PART: TStringField
