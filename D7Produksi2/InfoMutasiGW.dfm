    ...
    object PanelBrowse: TPanel
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'NAMA_ITEM'#9'28'#9'NAMA ITEM'#9'F'
          'WARNA'#9'9'#9'WARNA'#9'F'
          'NO_BATCH'#9'10'#9'NO BATCH'#9'F'
          'AWAL1'#9'10'#9'AWAL'#9'F'
          'MASUK1'#9'10'#9'Hasil Celup'#9'F'#9'MASUK'
          'MASUK2'#9'10'#9'Hasil Kelos'#9'F'#9'MASUK'
          'MASUK3'#9'10'#9'Retur'#9'F'#9'MASUK'
          'MASUK4'#9'10'#9'Koreksi'#9'F'#9'MASUK'
          'KELUAR1'#9'10'#9'Ke Persiapan'#9'F'#9'KELUAR'
          'KELUAR2'#9'10'#9'Ke Tenun'#9'F'#9'KELUAR'
          'KELUAR3'#9'10'#9'Ke Finishing'#9'F'#9'KELUAR'
          'KELUAR4'#9'10'#9'Kelos'#9'F'#9'KELUAR'
          'KELUAR5'#9'10'#9'Retur'#9'F'#9'KELUAR'
  ...
  object QDump2: TOracleQuery
    SQL.Strings = (
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        '  where kd_warna=b.kd_warna and kd_lokasi=:kd_jns_item and kd_it' +
        'em=a.kd_item and jns_lokasi='#39'LOKASI'#39' and kd_transaksi='#39'881'#39' and ' +
        'tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1-1/86400)/:VRASI' +
        'O AS masuk1,'
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where kd_warna=b.kd_warna and kd_lokasi=:kd_jns_item and kd_it' +
        'em=a.kd_item and jns_lokasi='#39'LOKASI'#39' and kd_transaksi='#39'882'#39' and ' +
        'tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1-1/86400)/:VRASI' +
        'O AS masuk2,'
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where kd_warna=b.kd_warna and kd_lokasi=:kd_jns_item and kd_it' +
        'em=a.kd_item and jns_lokasi='#39'LOKASI'#39' and kd_transaksi='#39'883'#39' and ' +
        'tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1-1/86400)/:VRASI' +
        'O AS masuk3,'
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where kd_warna=b.kd_warna and kd_lokasi=:kd_jns_item and kd_it' +
        'em=a.kd_item and jns_lokasi='#39'LOKASI'#39' and kd_transaksi='#39'884'#39' and ' +
        'tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1-1/86400)/:VRASI' +
        'O AS masuk4,'
      '(select -sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where kd_warna=b.kd_warna and kd_lokasi=:kd_jns_item and kd_it' +
        'em=a.kd_item and jns_lokasi='#39'LOKASI'#39' and kd_transaksi='#39'681'#39' and ' +
        'tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1-1/86400)/:VRASI' +
        'O AS keluar1,'
      '(select -sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where kd_warna=b.kd_warna and kd_lokasi=:kd_jns_item and kd_it' +
        'em=a.kd_item and jns_lokasi='#39'LOKASI'#39' and kd_transaksi='#39'682'#39' and ' +
        'tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1-1/86400)/:VRASI' +
        'O AS keluar2,'
      '(select -sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where kd_warna=b.kd_warna and kd_lokasi=:kd_jns_item and kd_it' +
        'em=a.kd_item and jns_lokasi='#39'LOKASI'#39' and kd_transaksi='#39'683'#39' and ' +
        'tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1-1/86400)/:VRASI' +
        'O AS keluar3,'
      '(select -sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where kd_warna=b.kd_warna and kd_lokasi=:kd_jns_item and kd_it' +
        'em=a.kd_item and jns_lokasi='#39'LOKASI'#39' and kd_transaksi='#39'684'#39' and ' +
        'tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1-1/86400)/:VRASI' +
        'O AS keluar4,'
      '(select -sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where kd_warna=b.kd_warna and kd_lokasi=:kd_jns_item and kd_it' +
        'em=a.kd_item and jns_lokasi='#39'LOKASI'#39' and kd_transaksi='#39'685'#39' and ' +
        'tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1-1/86400)/:VRASI' +
        'O AS keluar5,'
      '(select -sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where kd_warna=b.kd_warna and kd_lokasi=:kd_jns_item and kd_it' +
        'em=a.kd_item and jns_lokasi='#39'LOKASI'#39' and kd_transaksi='#39'686'#39' and ' +
        'tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1-1/86400)/:VRASI' +
        'O AS keluar6,'
  ...
  object QDump3: TOracleQuery
    SQL.Strings = (
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        '  where no_batch=b.no_batch and kd_warna=b.kd_warna and kd_lokas' +
        'i=:kd_jns_item and kd_item=a.kd_item and jns_lokasi='#39'LOKASI'#39' and' +
        ' kd_transaksi='#39'881'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsys' +
        'date2)+1-1/86400)/:VRASIO AS masuk1,'
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where no_batch=b.no_batch and kd_warna=b.kd_warna and kd_lokas' +
        'i=:kd_jns_item and kd_item=a.kd_item and jns_lokasi='#39'LOKASI'#39' and' +
        ' kd_transaksi='#39'882'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsys' +
        'date2)+1-1/86400)/:VRASIO AS masuk2,'
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where no_batch=b.no_batch and kd_warna=b.kd_warna and kd_lokas' +
        'i=:kd_jns_item and kd_item=a.kd_item and jns_lokasi='#39'LOKASI'#39' and' +
        ' kd_transaksi='#39'883'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsys' +
        'date2)+1-1/86400)/:VRASIO AS masuk3,'
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where no_batch=b.no_batch and kd_warna=b.kd_warna and kd_lokas' +
        'i=:kd_jns_item and kd_item=a.kd_item and jns_lokasi='#39'LOKASI'#39' and' +
        ' kd_transaksi='#39'884'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsys' +
        'date2)+1-1/86400)/:VRASIO AS masuk4,'
      '(select -sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where no_batch=b.no_batch and kd_warna=b.kd_warna and kd_lokas' +
        'i=:kd_jns_item and kd_item=a.kd_item and jns_lokasi='#39'LOKASI'#39' and' +
        ' kd_transaksi='#39'681'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsys' +
        'date2)+1-1/86400)/:VRASIO AS keluar1,'
      '(select -sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where no_batch=b.no_batch and kd_warna=b.kd_warna and kd_lokas' +
        'i=:kd_jns_item and kd_item=a.kd_item and jns_lokasi='#39'LOKASI'#39' and' +
        ' kd_transaksi='#39'682'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsys' +
        'date2)+1-1/86400)/:VRASIO AS keluar2,'
      '(select -sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where no_batch=b.no_batch and kd_warna=b.kd_warna and kd_lokas' +
        'i=:kd_jns_item and kd_item=a.kd_item and jns_lokasi='#39'LOKASI'#39' and' +
        ' kd_transaksi='#39'683'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsys' +
        'date2)+1-1/86400)/:VRASIO AS keluar3,'
      '(select -sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where no_batch=b.no_batch and kd_warna=b.kd_warna and kd_lokas' +
        'i=:kd_jns_item and kd_item=a.kd_item and jns_lokasi='#39'LOKASI'#39' and' +
        ' kd_transaksi='#39'684'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsys' +
        'date2)+1-1/86400)/:VRASIO AS keluar4,'
      '(select -sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where no_batch=b.no_batch and kd_warna=b.kd_warna and kd_lokas' +
        'i=:kd_jns_item and kd_item=a.kd_item and jns_lokasi='#39'LOKASI'#39' and' +
        ' kd_transaksi='#39'685'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsys' +
        'date2)+1-1/86400)/:VRASIO AS keluar5,'
      '(select -sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where no_batch=b.no_batch and kd_warna=b.kd_warna and kd_lokas' +
        'i=:kd_jns_item and kd_item=a.kd_item and jns_lokasi='#39'LOKASI'#39' and' +
        ' kd_transaksi='#39'686'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsys' +
        'date2)+1-1/86400)/:VRASIO AS keluar6,'
      'a.kd_sub_kel,c.warna, b.no_batch'
      
        'from ipisma_db4.vitemall a, ipisma_db4.vitem_warna_batch b, ipis' +
        'ma_db3.warna c'
