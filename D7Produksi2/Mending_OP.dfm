object Mending_OPFrm: TMending_OPFrm
  Left = 200
  Top = 127
  Width = 1123
  Height = 602
  Caption = 'Operator Mending'
  Color = clBtnFace
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        ControlType.Strings = (
          ...
          'NAMA;CustomEdit;LookOP;F')
        Selected.Strings = (
          'NAMA'#9'35'#9'NAMA'#9'F'
          'NIK'#9'6'#9'NIK'#9'F'
          'GRUP'#9'5'#9'GRUP'#9'F')
      ...
      object LookOP: TwwDBLookupComboDlg
        Left = 168
        Top = 164
        Width = 121
        Height = 21
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from MENDING_OP a'
      ''
      ':myparam')
    ReadBuffer = 10
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000E0000006F726465
      72206279204E414D410000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000003000000030000004E494B010000000000040000004E414D41010000
      0000000400000047525550010000000000}
  ...
  object QLookOP: TOracleDataSet
    SQL.Strings = (
      'select NAMA_KARYAWAN,NIK, from ipisma_db4.KARYAWAN_HRD a'
      'where sts_aktif='#39'1'#39
      'order by NAMA_KARYAWAN'
      ''
      '')
    ReadBuffer = 10
    QBEDefinition.QBEFieldDefs = {
      04000000020000000D0000004E414D415F4B4152594157414E01000000000003
      0000004E494B010000000000}
    QueryAllRecords = False
    CountAllRecords = True
    ...
    Left = 308
    Top = 185
    object QLookOPNAMA_KARYAWAN: TStringField
      DisplayWidth = 45
      FieldName = 'NAMA_KARYAWAN'
      Required = True
      Size = 45
    end
    object QLookOPNIK: TStringField
      DisplayWidth = 5
      FieldName = 'NIK'
      Required = True
      Size = 5
  ...
  object dsQLookOP: TwwDataSource
    DataSet = QLookOP
    Left = 308
    Top = 233
  end
