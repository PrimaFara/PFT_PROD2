object LapProdPersiapanFrm: TLapProdPersiapanFrm
  Left = 193
  Top = 127
  Width = 1173
  Height = 611
  Caption = 'Laporan Produksi Persiapan'
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet2: TTabSheet
      ...
      object WebBrowser1: TWebBrowser
        ...
        ControlData = {
          4C000000C1760000B72E00000000000000000000000000000000000000000000
      ...
      object QuickRep1: TQuickRep
        ...
        object SummaryBand1: TQRBand
          ...
          object QRExpr16: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QProd_DB.DB_POT)'
            Mask = '0.0,0;(0.0,0);-'
            FontSize = 8
          end
          object QRExpr17: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QProd_DB.DB_KODI_calc)'
            Mask = '0.0,0;(0.0,0);-'
            FontSize = 8
          end
          object QRExpr18: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QProd_DB.K_KODI_calc)'
            Mask = '0.0,0;(0.0,0);-'
            FontSize = 8
          end
          ...
          object QRExpr20: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QProd_DB.C_KODI_calc)'
            Mask = '0.0,0;(0.0,0);-'
            FontSize = 8
          end
      ...
      object QuickRep2: TQuickRep
        ...
        object QRBand4: TQRBand
          ...
          object QRLabel61: TQRLabel
            ...
            AutoSize = True
            AutoStretch = False
            Caption = 'LAPORAN PRODUKSI KELOS'
            Color = clWhite
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -19
        ...
        object QRBand5: TQRBand
          ...
          object QRExpr7: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QProd_DB1.QTY1W)'
            Mask = '0.0,0;(0.0,0);-'
            FontSize = 8
          end
          object QRExpr8: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QProd_DB1.QTY2W)'
            Mask = '0.0,0;(0.0,0);-'
            FontSize = 8
          end
          object QRExpr9: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QProd_DB1.QTY1K)'
            Mask = '0.0,0;(0.0,0);-'
            FontSize = 8
          end
          object QRExpr10: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QProd_DB1.QTY2K)'
            Mask = '0.0,0;(0.0,0);-'
            FontSize = 8
          end
          object QRExpr11: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QProd_DB1.QTY1C)'
            Mask = '0.0,0;(0.0,0);-'
            FontSize = 8
          end
          object QRExpr12: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QProd_DB1.QTY2C)'
            Mask = '0.0,0;(0.0,0);-'
            FontSize = 8
          end
          ...
          object QRExpr13: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QProd_DB1.QTY3W)'
            Mask = '0.0,0;(0.0,0);-'
            FontSize = 8
          end
          object QRExpr14: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QProd_DB1.QTY3K)'
            Mask = '0.0,0;(0.0,0);-'
            FontSize = 8
          end
          object QRExpr15: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QProd_DB1.QTY3C)'
            Mask = '0.0,0;(0.0,0);-'
            FontSize = 8
          end
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'DB_JML_PROD'#9'10'#9'JUMLAH BEAM'#9'F'#9'WARPING'
          'DB_KODI'#9'10'#9'KODI'#9'F'#9'WARPING'
          'DB_POT'#9'10'#9'POTONG'#9'F'#9'WARPING'
          'DB_KG'#9'10'#9'KG'#9'F'#9'WARPING'
          'K_JML_PROD'#9'10'#9'JUMLAH BEAM'#9'F'#9'SIZING'
          'K_KODI'#9'10'#9'KODI'#9'F'#9'SIZING'
          'K_POT'#9'10'#9'POTONG'#9'F'#9'SIZING'
          'K_KG'#9'10'#9'KG'#9'F'#9'SIZING'
          'C_JML_PROD'#9'10'#9'JUMLAH BEAM'#9'F'#9'CUCUK'
          'C_KODI'#9'10'#9'KODI'#9'F'#9'CUCUK'
          'C_POT'#9'10'#9'POTONG'#9'F'#9'CUCUK'
          'C_KG'#9'10'#9'KG'#9'F'#9'CUCUK'
          'F_JML_PROD'#9'10'#9'JUMLAH BEAM'#9'F'#9'REPROSES KANJI'
          'F_KODI'#9'10'#9'KODI'#9'F'#9'REPROSES KANJI'
          'F_POT'#9'10'#9'POTONG'#9'F'#9'REPROSES KANJI'
          'F_KG'#9'10'#9'KG'#9'F'#9'REPROSES KANJI'
          'G_JML_PROD'#9'10'#9'JUMLAH BEAM'#9'F'#9'REPROSES CUCUK'
          'G_POT'#9'10'#9'KODI'#9'F'#9'REPROSES CUCUK'
          'G_KODI'#9'10'#9'POTONG'#9'F'#9'REPROSES CUCUK'
          'G_KG'#9'10'#9'KG'#9'F'#9'REPROSES CUCUK')
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          'KONSTRUKSI'#9'30'#9'KONSTRUKSI'#9'F'
          'QTY1W'#9'10'#9'POTONG'#9'F'#9'DESAIN BEAM'
          'QTY2W'#9'10'#9'KODI'#9'F'#9'DESAIN BEAM'
          'QTY3W'#9'10'#9'KG'#9'F'#9'DESAIN BEAM'
          'QTY1K'#9'10'#9'POTONG'#9'F'#9'KANJI'
          'QTY2K'#9'10'#9'KODI'#9'F'#9'KANJI'
          'QTY3K'#9'10'#9'KG'#9'F'#9'KANJI'
          'QTY1C'#9'10'#9'POTONG'#9'F'#9'CUCUK'
          'QTY2C'#9'10'#9'KODI'#9'F'#9'CUCUK'
          'QTY3C'#9'10'#9'KG'#9'F'#9'CUCUK')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'PRODUKSI2'
        IniAttributes.Delimiter = ';;'
    ...
    object TabSheet3: TTabSheet
      ...
      object wwDBGrid3: TwwDBGrid
        ...
        ControlType.Strings = (
          'ISPOST;CheckBox;1;0')
        Selected.Strings = (
          'NAMA_ITEM'#9'10'#9'NAMA ITEM'#9'F'
          'LUSI_KG'#9'10'#9'KG'#9'F'#9'LUSI'
          'LUSI_PCS'#9'10'#9'PCS'#9'F'#9'LUSI'
          'PAKAN_KG'#9'10'#9'KG'#9'F'#9'PAKAN'
          'PAKAN_PCS'#9'10'#9'PCS'#9'F'#9'PAKAN'
          'PAKAN_KG2'#9'10'#9'KG'#9'F'#9'PAKAN~LAINNYA'
          'PAKAN_PCS2'#9'10'#9'PCS'#9'F'#9'PAKAN~LAINNYA'
          'GWJ_KG'#9'10'#9'KG'#9'F'#9'GW dan JAHIT'
          'GWJ_PCS'#9'10'#9'PCS'#9'F'#9'GW dan JAHIT'
          'GWJ_KG2'#9'10'#9'KG'#9'F'#9'GW LAINNYA'
          'GWJ_PCS2'#9'10'#9'PCS'#9'F'#9'GW LAINNYA'
          'CKL_KG'#9'10'#9'KG'#9'F'#9'CIKALAN'
          'CKL_PCS'#9'10'#9'PCS'#9'F'#9'CIKALAN'
          'CKL_KG2'#9'10'#9'KG'#9'F'#9'CIKALAN~LAINNYA'
          'CKL_PCS2'#9'10'#9'PCS'#9'F'#9'CIKALAN~LAINNYA'
          'TOTAL_KG'#9'10'#9'KG'#9'F'#9'TOTAL'
          'TOTAL_PCS'#9'10'#9'PCS'#9'F'#9'TOTAL')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'PRODUKSI2'
        IniAttributes.Delimiter = ';;'
  ...
  object QProd_DB: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vprod_persiapan'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000001C0000006F726465
      72206279206265616D2C6B702C6B6F6E737472756B73690000000000}
    QBEDefinition.QBEFieldDefs = {
      }
    MasterFields = 'konstruksi'
    RefreshOptions = [roAfterInsert]
    Session = DMFrm.OS
    OnFilterRecord = QProd_DBFilterRecord
    Left = 64
    Top = 208
    ...
    object QProd_DBDB_JML_PROD: TFloatField
      FieldName = 'DB_JML_PROD'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBDB_KODI: TFloatField
      FieldName = 'DB_KODI'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBDB_POT: TFloatField
      FieldName = 'DB_POT'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBDB_KG: TFloatField
      FieldName = 'DB_KG'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBK_JML_PROD: TFloatField
      FieldName = 'K_JML_PROD'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBK_KODI: TFloatField
      FieldName = 'K_KODI'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBK_POT: TFloatField
      FieldName = 'K_POT'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBK_KG: TFloatField
      FieldName = 'K_KG'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBC_JML_PROD: TFloatField
      FieldName = 'C_JML_PROD'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBC_KODI: TFloatField
      FieldName = 'C_KODI'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBC_POT: TFloatField
      FieldName = 'C_POT'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBC_KG: TFloatField
      FieldName = 'C_KG'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBF_JML_PROD: TFloatField
      FieldName = 'F_JML_PROD'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBF_KODI: TFloatField
      FieldName = 'F_KODI'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBF_POT: TFloatField
      FieldName = 'F_POT'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBF_KG: TFloatField
      FieldName = 'F_KG'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBG_JML_PROD: TFloatField
      FieldName = 'G_JML_PROD'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBG_KODI: TFloatField
      FieldName = 'G_KODI'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBG_POT: TFloatField
      FieldName = 'G_POT'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBG_KG: TFloatField
      FieldName = 'G_KG'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_DBKP: TStringField
      FieldName = 'KP'
    end
    object QProd_DBBEAM: TStringField
      FieldName = 'BEAM'
      Size = 50
    end
  end
  ...
  object QAmbil_Data: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.Proc_prod_pesiapan_v2(:pawal,:pakhir);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        ' sum(db_pot) as db_pot, sum(db_kg) as db_kg,'
      
        'sum(k_jml_prod) as k_jml_prod, sum(k_kodi) as k_kodi, sum(k_pot)' +
        ' as k_pot, sum(k_kg) as k_kg,'
      
        'sum(c_jml_prod) as c_jml_prod, sum(c_kodi) as c_kodi, sum(c_pot)' +
        ' as c_pot, sum(c_kg) as c_kg,'
      
        'sum(f_jml_prod) as f_jml_prod, sum(f_kodi) as f_kodi, sum(f_pot)' +
        ' as f_pot, sum(f_kg) as f_kg,'
      
        'sum(g_jml_prod) as g_jml_prod, sum(g_kodi) as g_kodi, sum(g_pot)' +
        ' as g_pot, sum(g_kg) as g_kg'
      'from ipisma_db4.vprod_persiapan'
      ':MYPARAM')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000140000000B00000044425F4A4D4C5F50524F44010000000000070000
      ...
      
      00000004000000475F4B47010000000000}
    Session = DMFrm.OS
    Left = 64
    Top = 256
    ...
    object QTotalDB_KG: TFloatField
      FieldName = 'DB_KG'
    end
    object QTotalK_KG: TFloatField
      FieldName = 'K_KG'
    end
    object QTotalC_KG: TFloatField
      FieldName = 'C_KG'
    end
    object QTotalF_JML_PROD: TFloatField
      FieldName = 'F_JML_PROD'
    end
    object QTotalF_KODI: TFloatField
      FieldName = 'F_KODI'
    end
    object QTotalF_POT: TFloatField
      FieldName = 'F_POT'
    end
    object QTotalF_KG: TFloatField
      FieldName = 'F_KG'
    end
    object QTotalG_JML_PROD: TFloatField
      FieldName = 'G_JML_PROD'
    end
    object QTotalG_KODI: TFloatField
      FieldName = 'G_KODI'
    end
    object QTotalG_POT: TFloatField
      FieldName = 'G_POT'
    end
    object QTotalG_KG: TFloatField
      FieldName = 'G_KG'
    end
  end
  object QProd_DB1: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vprod_persiapan2'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      000000}
    MasterFields = 'konstruksi'
    RefreshOptions = [roAfterInsert]
    Session = DMFrm.OS
    OnFilterRecord = QProd_DB1FilterRecord
    Left = 64
    Top = 328
    object QProd_DB1KONSTRUKSI: TStringField
      FieldName = 'KONSTRUKSI'
      Size = 130
    end
    object QProd_DB1QTY1W: TFloatField
      FieldName = 'QTY1W'
      DisplayFormat = '#,##0.##;(#,##0.##) '
    end
    object QProd_DB1QTY2W: TFloatField
      FieldName = 'QTY2W'
      DisplayFormat = '#,##0.##;(#,##0.##) '
    end
    object QProd_DB1QTY3W: TFloatField
      FieldName = 'QTY3W'
      DisplayFormat = '#,##0.##;(#,##0.##) '
    end
    object QProd_DB1QTY1K: TFloatField
      FieldName = 'QTY1K'
      DisplayFormat = '#,##0.##;(#,##0.##) '
      EditFormat = '0.000'
    end
    object QProd_DB1QTY2K: TFloatField
      FieldName = 'QTY2K'
      DisplayFormat = '#,##0.##;(#,##0.##) '
      EditFormat = '0.000'
    end
    object QProd_DB1QTY3K: TFloatField
      FieldName = 'QTY3K'
      DisplayFormat = '#,##0.##;(#,##0.##) '
      EditFormat = '0.000'
    end
    object QProd_DB1QTY1C: TFloatField
      FieldName = 'QTY1C'
      DisplayFormat = '#,##0.##;(#,##0.##) '
      EditFormat = '0.000'
    end
    object QProd_DB1QTY2C: TFloatField
      FieldName = 'QTY2C'
      DisplayFormat = '#,##0.##;(#,##0.##) '
      EditFormat = '0.000'
    end
    object QProd_DB1QTY3C: TFloatField
      FieldName = 'QTY3C'
      DisplayFormat = '#,##0.##;(#,##0.##) '
      EditFormat = '0.000'
    end
  ...
  object Qambil_data1: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.Proc_prod_pesiapan2(:pawal,:pakhir);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object dsQprod_DB1: TwwDataSource
    DataSet = QProd_DB1
    Left = 208
    Top = 416
  end
  object QTotal1: TOracleDataSet
    ...
    Left = 128
    Top = 336
    object QTotal1DB_JML_PROD: TFloatField
      FieldName = 'DB_JML_PROD'
    end
    object QTotal1DB_KODI: TFloatField
      FieldName = 'DB_KODI'
    end
    object QTotal1DB_POT: TFloatField
      FieldName = 'DB_POT'
    end
    object QTotal1K_JML_PROD: TFloatField
      FieldName = 'K_JML_PROD'
    end
    object QTotal1K_KODI: TFloatField
      FieldName = 'K_KODI'
    end
    object QTotal1K_POT: TFloatField
      FieldName = 'K_POT'
    end
    object QTotal1C_JML_PROD: TFloatField
      FieldName = 'C_JML_PROD'
    end
    object QTotal1C_KODI: TFloatField
      FieldName = 'C_KODI'
    end
    object QTotal1C_POT: TFloatField
      FieldName = 'C_POT'
    end
  end
  ...
  object QProd_Kelos: TOracleDataSet
    SQL.Strings = (
      'select * from ('
      'select distinct a.nama_item, '
      'nvl(b.kg,0) as lusi_kg, nvl(b.pcs,0) as lusi_pcs, '
      'nvl(c.kg,0) as pakan_kg, nvl(c.pcs,0) as pakan_pcs,'
      'nvl(c2.kg,0) as pakan_kg2, nvl(c2.pcs,0) as pakan_pcs2,'
      'nvl(d.kg,0) as gwj_kg, nvl(d.pcs,0) as gwj_pcs, '
      'nvl(d2.kg,0) as gwj_kg2, nvl(d2.pcs,0) as gwj_pcs2,'
      'nvl(e.kg,0) as ckl_kg, nvl(e.pcs,0) as ckl_pcs,'
      'nvl(e2.kg,0) as ckl_kg2, nvl(e2.pcs,0) as ckl_pcs2,'
      
        'nvl(b.kg,0)+nvl(c.kg,0)+nvl(d.kg,0)+nvl(e.kg,0)+nvl(c2.kg,0)+nvl' +
        '(d2.kg,0)+nvl(e2.kg,0) as total_kg,'
      
        'nvl(b.pcs,0)+nvl(c.pcs,0)+nvl(d.pcs,0)+nvl(e.pcs,0)+nvl(c2.pcs,0' +
        ')+nvl(d2.pcs,0)+nvl(e2.pcs,0) as total_pcs'
      'from ipisma_db4.vkelos_masuk a'
      ''
      'left outer join--LUSI'
      
        '(select t.nama_item,sum(t.kg) as kg,sum(t.pcs) as pcs from ipism' +
        'a_db4.vkelos_masuk t'
      'where trunc(tanggal)>=:pawal and trunc(tanggal)<=:pakhir '
      
        'and t.ispost = 1 and (kel='#39'LUSI'#39' or kel='#39'TAMBAHAN'#39' or kel='#39'WIRON' +
        #39')'
      
        'and keterangan not in('#39'TANPA KELOS'#39','#39'LAINNYA'#39','#39'TANPA KELOS LAINN' +
        'YA'#39')      '
      'group by t.nama_item) b on a.nama_item=b.nama_item'
      ''
      'left outer join--PAKAN'
      
        '(select t.nama_item,sum(t.kg) as kg,sum(t.pcs) as pcs from ipism' +
        'a_db4.vkelos_masuk t'
      
        'where trunc(tanggal)>=:pawal and trunc(tanggal)<=:pakhir and t.i' +
        'spost = 1 and kel='#39'PAKAN'#39
      
        'and keterangan not in ('#39'LAINNYA'#39','#39'TANPA KELOS'#39','#39'TANPA KELOS LAIN' +
        'NYA'#39','#39'GUDANG WARNA'#39','#39'JAHIT'#39','#39'TENUN LAINNYA'#39','#39'GW LAINNYA'#39')  --add' +
        ' '#39'TENUN LAINNYA'#39'                         '
      'group by  t.nama_item) c on a.nama_item=c.nama_item'
      ''
      ''
      'left outer join --PAKAN LAINNYA 240924'
        ...
        'where trunc(tanggal)>=:pawal and trunc(tanggal)<=:pakhir and t.i' +
        'spost = 1 and kel='#39'PAKAN'#39
      'and keterangan in ('#39'TENUN LAINNYA'#39')                        '
      'group by  t.nama_item) c2 on a.nama_item=c2.nama_item'
      ''
      'left outer join --GW & JAHIT'
        ...
        'and keterangan in ('#39'GUDANG WARNA'#39','#39'JAHIT'#39')                      ' +
        '    '
      'group by  t.nama_item) d on a.nama_item=d.nama_item'
      ''
      'left outer join --GW LAINNYA 240924'
        ...
        'where trunc(tanggal)>=:pawal and trunc(tanggal)<=:pakhir and t.i' +
        'spost = 1 and kel='#39'PAKAN'#39
      'and keterangan in ('#39'GW LAINNYA'#39')                          '
      'group by  t.nama_item) d2 on a.nama_item=d2.nama_item'
      ''
      'left outer join --CIKALAN'
      
        '(select t.nama_item,sum(t.kg) as kg,sum(t.pcs) as pcs from ipism' +
        'a_db4.vkelos_masuk_cikalan t'
      
        'where trunc(tanggal)>=:pawal and trunc(tanggal)<=:pakhir and t.i' +
        'spost = 1 and KETERANGAN='#39'WARPING'#39
      'group by t.nama_item) e on a.nama_item=e.nama_item'
      ' '
      ''
      'left outer join --CIKALAN LAINNYA 240924'
      
        '(select t.nama_item,sum(t.kg) as kg,sum(t.pcs) as pcs from ipism' +
        'a_db4.vkelos_masuk_cikalan t'
      
        'where trunc(tanggal)>=:pawal and trunc(tanggal)<=:pakhir and t.i' +
        'spost = 1 and KETERANGAN='#39'WARPING LAINNYA'#39
      'group by t.nama_item) e2 on a.nama_item=e2.nama_item'
      ') '
      'where total_kg <> 0'
      'order by nama_item')
    Variables.Data = {
      ...
      00003A50414B4849520C0000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      000000000008000000434B4C5F50435332010000000000}
    MasterFields = 'konstruksi'
    RefreshOptions = [roAfterInsert]
    Session = DMFrm.OS
    Left = 136
    Top = 208
    object QProd_KelosNAMA_ITEM: TStringField
      FieldName = 'NAMA_ITEM'
      Size = 100
    end
    object QProd_KelosLUSI_KG: TFloatField
      FieldName = 'LUSI_KG'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_KelosLUSI_PCS: TFloatField
      FieldName = 'LUSI_PCS'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_KelosPAKAN_KG: TFloatField
      FieldName = 'PAKAN_KG'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_KelosPAKAN_PCS: TFloatField
      FieldName = 'PAKAN_PCS'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_KelosGWJ_KG: TFloatField
      FieldName = 'GWJ_KG'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_KelosGWJ_PCS: TFloatField
      FieldName = 'GWJ_PCS'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_KelosCKL_KG: TFloatField
      FieldName = 'CKL_KG'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_KelosCKL_PCS: TFloatField
      FieldName = 'CKL_PCS'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_KelosTOTAL_KG: TFloatField
      FieldName = 'TOTAL_KG'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_KelosTOTAL_PCS: TFloatField
      FieldName = 'TOTAL_PCS'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_KelosPAKAN_KG2: TFloatField
      FieldName = 'PAKAN_KG2'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_KelosPAKAN_PCS2: TFloatField
      FieldName = 'PAKAN_PCS2'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_KelosGWJ_KG2: TFloatField
      FieldName = 'GWJ_KG2'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_KelosGWJ_PCS2: TFloatField
      FieldName = 'GWJ_PCS2'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_KelosCKL_KG2: TFloatField
      FieldName = 'CKL_KG2'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
    object QProd_KelosCKL_PCS2: TFloatField
      FieldName = 'CKL_PCS2'
      DisplayFormat = '#.#,#;(#.#,#);'
    end
  end
  object dsQProd_Kelos: TwwDataSource
    DataSet = QProd_Kelos
    Left = 72
    Top = 408
  end
  object QTotal_Kelos: TOracleDataSet
    SQL.Strings = (
      'select '
      'sum(lusi_kg) as lusi_kg, sum(lusi_pcs) as lusi_pcs, '
      'sum(pakan_kg) as pakan_kg, sum(pakan_pcs) as pakan_pcs, '
      'sum(pakan_kg2) as pakan_kg2, sum(pakan_pcs2) as pakan_pcs2,'
      'sum(gwj_kg) as gwj_kg, sum(gwj_pcs) as gwj_pcs,'
      'sum(gwj_kg2) as gwj_kg2, sum(gwj_pcs2) as gwj_pcs2, '
      'sum(ckl_kg) as ckl_kg, sum(ckl_pcs) as ckl_pcs, '
      'sum(ckl_kg2) as ckl_kg2, sum(ckl_pcs2) as ckl_pcs2, '
      'sum(total_kg) as total_kg, sum(total_pcs) as total_pcs '
      'from ('
      'select distinct a.nama_item, '
      'nvl(b.kg,0) as lusi_kg, nvl(b.pcs,0) as lusi_pcs, '
      'nvl(c.kg,0) as pakan_kg, nvl(c.pcs,0) as pakan_pcs,'
      ...
      'left outer join'
        ...
        'and keterangan not in ('#39'LAINNYA'#39','#39'TANPA KELOS'#39','#39'TANPA KELOS LAIN' +
        'NYA'#39','#39'GUDANG WARNA'#39','#39'JAHIT'#39','#39'TENUN LAINNYA'#39','#39'GW LAINNYA'#39')       ' +
        '                    '
      'group by  t.nama_item) c on a.nama_item=c.nama_item'
      ''
      'left outer join --240924'
    ...
    Variables.Data = {
      ...
      00003A50414B4849520C0000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      00000000}
    Session = DMFrm.OS
    Left = 136
    Top = 256
    object QTotal_KelosLUSI_KG: TFloatField
      FieldName = 'LUSI_KG'
    end
    object QTotal_KelosLUSI_PCS: TFloatField
      FieldName = 'LUSI_PCS'
    end
    object QTotal_KelosPAKAN_KG: TFloatField
      FieldName = 'PAKAN_KG'
    end
    object QTotal_KelosPAKAN_PCS: TFloatField
      FieldName = 'PAKAN_PCS'
    end
    object QTotal_KelosGWJ_KG: TFloatField
      FieldName = 'GWJ_KG'
    end
    object QTotal_KelosGWJ_PCS: TFloatField
      FieldName = 'GWJ_PCS'
    end
    object QTotal_KelosCKL_KG: TFloatField
      FieldName = 'CKL_KG'
    end
    object QTotal_KelosCKL_PCS: TFloatField
      FieldName = 'CKL_PCS'
    end
    object QTotal_KelosTOTAL_KG: TFloatField
      FieldName = 'TOTAL_KG'
    end
    object QTotal_KelosTOTAL_PCS: TFloatField
      FieldName = 'TOTAL_PCS'
    end
    object QTotal_KelosPAKAN_KG2: TFloatField
      FieldName = 'PAKAN_KG2'
    end
    object QTotal_KelosPAKAN_PCS2: TFloatField
      FieldName = 'PAKAN_PCS2'
    end
    object QTotal_KelosGWJ_KG2: TFloatField
      FieldName = 'GWJ_KG2'
    end
    object QTotal_KelosGWJ_PCS2: TFloatField
      FieldName = 'GWJ_PCS2'
    end
    object QTotal_KelosCKL_KG2: TFloatField
      FieldName = 'CKL_KG2'
    end
    object QTotal_KelosCKL_PCS2: TFloatField
      FieldName = 'CKL_PCS2'
    end
  end
end
