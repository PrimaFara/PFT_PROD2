...
type
  TKoreksiKelosKeluarFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
    PanelMain: TPanel;
    PanelHeader: TPanel;
...
var
  KoreksiKelosKeluarFrm: TKoreksiKelosKeluarFrm;
...
//  if BPBFrm=Nil then
  begin
    ...
    KoreksikelosKeluarFrm.vkode:=pkode;
...
procedure TKoreksiKelosKeluarFrm.FormClose(Sender: TObject;
...
procedure TKoreksiKelosKeluarFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TKoreksiKelosKeluarFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TKoreksiKelosKeluarFrm.BtnOkClick(Sender: TObject);
begin
...
procedure TKoreksiKelosKeluarFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKoreksiKelosKeluarFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TKoreksiKelosKeluarFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TKoreksiKelosKeluarFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TKoreksiKelosKeluarFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TKoreksiKelosKeluarFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TKoreksiKelosKeluarFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TKoreksiKelosKeluarFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TKoreksiKelosKeluarFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
 // ppNo.AsInteger:=0;
end;

procedure TKoreksiKelosKeluarFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TKoreksiKelosKeluarFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TKoreksiKelosKeluarFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TKoreksiKelosKeluarFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TKoreksiKelosKeluarFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiKelosKeluarFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TKoreksiKelosKeluarFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TKoreksiKelosKeluarFrm.Label5Click(Sender: TObject);
begin
...
procedure TKoreksiKelosKeluarFrm.LookKonstruksiEnter(Sender: TObject);
begin
QBarang.Open;
...
procedure TKoreksiKelosKeluarFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TKoreksiKelosKeluarFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QTime.Open;
...
procedure TKoreksiKelosKeluarFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
  QTransaksi.DeclareVariable('kd_transaksi', otString);
  QTransaksi.SQL.Text:='select a.* from '+cUserTabel+'vtransaksi a where a.kd_transaksi=:kd_transaksi';
  QTransaksi.SetVariable('kd_transaksi','864');//vkode);
end;

procedure TKoreksiKelosKeluarFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TKoreksiKelosKeluarFrm.FormCloseQuery(Sender: TObject;
...
procedure TKoreksiKelosKeluarFrm.QMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TKoreksiKelosKeluarFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TKoreksiKelosKeluarFrm.QLokasiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TKoreksiKelosKeluarFrm.LookLokasiEnter(Sender: TObject);
begin
  //QLokasi.Open;
end;

procedure TKoreksiKelosKeluarFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
  {if vjns_brg<>'' then
  begin
...
procedure TKoreksiKelosKeluarFrm.LookKonstruksiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TKoreksiKelosKeluarFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TKoreksiKelosKeluarFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiKelosKeluarFrm.FormShow(Sender: TObject);
begin
//  PanelHeader.Caption:=QTransaksiKD_TRANSAKSI.AsString+'. '+UpperCase(Caption);
end;

procedure TKoreksiKelosKeluarFrm.LookWarnaEnter(Sender: TObject);
begin
  DMFrm.QWarna.Open;
end;

procedure TKoreksiKelosKeluarFrm.QHasilCelupBeforeOpen(
  DataSet: TDataSet);
begin
  QHasilCelup.SetVariable('NO_NOTA',wwDBEdit1.Text);
end;

procedure TKoreksiKelosKeluarFrm.Button1Click(Sender: TObject);
begin
...
procedure TKoreksiKelosKeluarFrm.LookResepEnter(Sender: TObject);
begin
  DMFrm.QResep.Open;
end;

procedure TKoreksiKelosKeluarFrm.LookResepUserButton1Click(
...
procedure TKoreksiKelosKeluarFrm.QDetailAfterPost(DataSet: TDataSet);
begin
//ShowMessage('dfdsf');

end;

procedure TKoreksiKelosKeluarFrm.cbPostClick(Sender: TObject);
begin
//DBText3.Caption:='';
end;

procedure TKoreksiKelosKeluarFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.Open;
...
procedure TKoreksiKelosKeluarFrm.QTotalBeforeQuery(Sender: TOracleDataSet);
begin
QTotal.SetVariable('no_reg',QMasterNO_REG.AsInteger);
end;

procedure TKoreksiKelosKeluarFrm.TabSheet2Show(Sender: TObject);
begin
QBrowse.Close;
QBrowse.Open;
QBrowse.Refresh;
...
procedure TKoreksiKelosKeluarFrm.BtnPrintInputClick(Sender: TObject);
begin
QuickRep1.Preview;
end;

procedure TKoreksiKelosKeluarFrm.BtnOk1Click(Sender: TObject);
begin
...
procedure TKoreksiKelosKeluarFrm.QBrowseRekapAfterScroll(DataSet: TDataSet);
begin
