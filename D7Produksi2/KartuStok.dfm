object KartuStokFrm: TKartuStokFrm
      ...
      object TabSheet2: TTabSheet
        ...
        object PanelBrowse: TPanel
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            Height = 337
            Selected.Strings = (
              'NAMA_KELOMPOK'#9'15'#9'KELOMPOK'
              'NAMA_ITEM'#9'37'#9'NAMA ITEM'
              'KD_ITEM'#9'5'#9'KODE'
              'NO_PART'#9'7'#9'NO PART'
              'SATUAN'#9'8'#9'SATUAN'
              'AWAL'#9'9'#9'AWAL'
              'MASUK'#9'9'#9'Masuk'
              'KELUAR'#9'9'#9'Keluar'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
        ...
        'select a.kd_item, a.no_part, a.rasio, a.kd_jns_item, n.nama_kelo' +
        'mpok, a.nama_item, a.kd_satuan, d.satuan, a.min_stok, a.lead_tim' +
        'e, isfixed,'
      
        '  nvl((select sum(p.qty_in-p.qty_out) from ipisma_db4.gd_stok p,' +
        ' ipisma_db4.sub_lokasi q where p.kd_item=a.kd_item and p.kd_sub_' +
        'lokasi=q.kd_sub_lokasi and q.jns_lokasi=:jns_lokasi and tgl<:paw' +
        'al),0) as awal,'
      
        '  nvl((select sum(p.qty_in) from ipisma_db4.gd_stok p, ipisma_db' +
        ...
        '  nvl((select sum(p.qty_out) from ipisma_db4.gd_stok p, ipisma_d' +
        ...
        '  from ipisma_db4.item a, ipisma_db4.satuan d, ipisma_db4.sub_ke' +
        'lompok m, ipisma_db4.kelompok n'
      
        '  where a.kd_satuan=d.kd_satuan and a.kd_sub_kel=m.kd_sub_kel an' +
        'd a.kd_kel=n.kd_kel and n.kd_kel=m.kd_kel and'
    ...
    QBEDefinition.QBEFieldDefs = {
      030000000E000000070000004B445F4954454D0100000000090000004E414D41
      ...
      4E4F5F50415254010000000005000000524153494F01000000000D0000004E41
      4D415F4B454C4F4D504F4B0100000000}
    Cursor = crDefault
    ReadOnly = True
