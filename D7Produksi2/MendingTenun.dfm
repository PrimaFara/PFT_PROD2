object MendingTenunFrm: TMendingTenunFrm
    ...
    object TabSheet1: TTabSheet
      ...
      object PanelDetail: TPanel
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            'NAMA_OPR'#9'30'#9'NAMA'#9'F'
            'NIK_LAMA'#9'15'#9'NIK'#9'F'
            'GRUP'#9'4'#9'GRUP'#9'F'
            'PCS'#9'10'#9'PCS'#9'F'
        ...
        object LookOpr: TwwDBLookupComboDlg
          Left = 32
          Top = 48
          Width = 121
          Height = 19
          ...
          ShowButton = True
          AllowClearKey = False
          OnCloseUp = LookOprCloseUp
          OnEnter = LookOprEnter
        end
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db4.mending_tn a'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      4F5F42554B544901000000000004000000545444310100000000000400000054
      5444320100000000000400000054544433010000000000040000005454443401
      00000000000500000053484946540100000000000700000054414E4747414C01
      0000000000060000004E4F5F524547010000000000}
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db4.mending_tn_detail a')
    SequenceField.Field = 'IBUKTI_DETAIL'
    SequenceField.Sequence = 'ipisma_db4.ibukti_detail'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      
      4449010000000000080000004E494B5F4C414D41010000000000}
  ...
  object QLookOPR: TOracleDataSet
    SQL.Strings = (
      'select a.* from ipisma_db4.mending_op a'
      'where isaktif='#39'1'#39
      'order by a.nama'
      '')
    QBEDefinition.QBEFieldDefs = {
      0400000004000000030000004E494B010000000000040000004E414D41010000
      000000080000004E494B5F4C414D41010000000000070000004953414B544946
      010000000000}
    ReadOnly = True
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 856
    Top = 240
    object QLookOPRNAMA: TStringField
      DisplayWidth = 30
      FieldName = 'NAMA'
      Size = 50
    end
    object QLookOPRNIK_LAMA: TStringField
      DisplayLabel = 'NIK'
      DisplayWidth = 15
      FieldName = 'NIK_LAMA'
      Size = 15
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select a.* from ipisma_db4.vmending_tn a'
    ...
    QBEDefinition.QBEFieldDefs = {
      
      5F4C414D41010000000000}
    ReadOnly = True
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 952
    ...
    object QBrowseNAMA_OPR: TStringField
      DisplayWidth = 30
      FieldName = 'NAMA_OPR'
      Size = 30
    end
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
      'select sum(pcs) as pcs, sum(kodi) as kodi'
      'from ipisma_db4.mending_tn_detail'
      'where no_reg=:no_reg')
  ...
  object QRekap_OP_Grup: TOracleDataSet
    SQL.Strings = (
      'select '
      't.nik_lama,t.nama_opr,t.grup, '
      'sum(t.pcs) as pcs, '
      'sum(t.kodi) as kodi'
      'from ipisma_db4.vmending_tn t'
      
        'where t.ispost='#39'1'#39' and t.tanggal>=trunc(:pawal) and t.tanggal<=t' +
        'runc(:pakhir)+1-1/86400'
      'group by t.nik_lama,t.nama_opr,t.grup'
      'order by t.nama_opr,t.grup')
    Variables.Data = {
      ...
      000000}
    QBEDefinition.QBEFieldDefs = {
      0400000005000000040000004B4F4449010000000000080000004E494B5F4C41
      4D41010000000000080000004E414D415F4F5052010000000000040000004752
      555001000000000003000000504353010000000000}
    MasterFields = 'id_rab'
    RefreshOptions = [roAfterInsert]
    Session = DMFrm.OS
    Left = 880
    Top = 192
    object QRekap_OP_GrupNIK_LAMA: TStringField
      FieldName = 'NIK_LAMA'
      Size = 15
    end
    object QRekap_OP_GrupNAMA_OPR: TStringField
      FieldName = 'NAMA_OPR'
      Size = 50
    end
    object QRekap_OP_GrupGRUP: TStringField
      FieldName = 'GRUP'
      Size = 2
    end
    object QRekap_OP_GrupPCS: TFloatField
      FieldName = 'PCS'
    end
    object QRekap_OP_GrupKODI: TFloatField
      FieldName = 'KODI'
    end
  end
