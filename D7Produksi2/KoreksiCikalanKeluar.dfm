object KoreksiCikalanKeluarFrm: TKoreksiCikalanKeluarFrm
  Left = 201
  Top = 57
  Width = 1074
  Height = 659
  ...
  AutoScroll = False
  Caption = 'KOREKSI CIKALAN KELUAR'
  Color = clBtnFace
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'QTY1'#9'10'#9'QTY1'#9'F'
              'QTY2'#9'10'#9'QTY2'#9'F'
              'QTY3'#9'10'#9'QTY3'#9'F'
              'QTY4'#9'10'#9'QTY4'#9'F'
              'QTY5'#9'10'#9'QTY5'#9'F'
              'QTY6'#9'10'#9'QTY6'#9'F')
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vkoreksi_cikalan_keluar'
    ...
    QBEDefinition.QBEFieldDefs = {
      040000000B000000070000004E4F5F4E4F54410100000000000700000054414E
  ...
  object QMaster: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      00000000000400000054544434010000000000080000004E4F5F42554B544901
      0000000000060000004942554B54490100000000000300000054474C01000000
      0000080000004E4F5F5245534550010000000000060000005354415455530100
  ...
  object QDetail: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      
      00004E4F5F4241544348010000000000}
    RefreshOptions = [roAfterInsert, roAfterUpdate]
    Session = DMFrm.OS
  ...
  object QBarang: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vstok_kelos'
      ''
      '')
    QBEDefinition.QBEFieldDefs = {
      0400000003000000070000004B445F4954454D010000000000090000004E414D
      415F4954454D0100000000000900000053544F4B5F4157414C010000000000}
    Session = DMFrm.OS
    Left = 448
    Top = 240
  ...
  object QBrowseRekap: TOracleDataSet
    SQL.Strings = (
      ...
      '')
    Variables.Data = {
      0300000002000000060000003A504157414C0C00000007000000787203010101
      0100000000070000003A50414B4849520C000000070000007872031E01010100
      000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object Qitem_ko: TOracleDataSet
    SQL.Strings = (
        ...
        'select '#39'-'#39' as kd_item, a.* from ipisma_db4.vstok_kor_temp a--, i' +
        'pisma_db4.vitemall_1 b b.kd_item,'
      'where qty1 <>0 --and a.nama_item=b.kd_sub_kel'
      '--ORDER BY a.nama_item')
    QBEDefinition.QBEFieldDefs = {
      }
    ReadOnly = True
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 600
    ...
    object Qitem_koKD_KONSTRUKSI: TStringField
      FieldName = 'KD_KONSTRUKSI'
    end
    ...
    object Qitem_koKD_WARNA: TStringField
      FieldName = 'KD_WARNA'
      Size = 10
    end
    object Qitem_koWARNA: TStringField
      FieldName = 'WARNA'
      Size = 100
    end
  ...
  object OracleQuery1: TOracleQuery
    SQL.Strings = (
      'begin'
      ' delete ipisma_db4.vstok_kor_temp;'
      'insert into ipisma_db4.vstok_kor_temp'
      '(kd_konstruksi, nama_item,  qty1, qty2)'
      '(--select k.kd_item,j.nama_item, j.awal from '
      '(select '#39'-'#39',nama_benang,awal1,awal2'
      
        '--nvl(p.awal1,0) + nvl(q.qty_in1,0) + nvl(r.qty_in1,0)+ nvl(s.qt' +
        'y_in1,0)+nvl(w.koreksi,0) as Awal'
      'from('
      
        'select '#39'-'#39', trim(ltrim(a.nama_item,'#39'benang'#39')) as nama_benang, '#39'-' +
        #39', '#39'-'#39','
      
        '(/*nvl(b.qty,0)+*/nvl(c.awalgw,0)/*+nvl(d.awalkel,0)+nvl(e.awalk' +
        'elm,0)+nvl(f.awalcik,0)+nvl(w.koreksi,0)*/)as awal1,'
      
        '(/*nvl(b.qty,0)+*/nvl(c.awalgw2,0)/*+nvl(d.awalkel2,0)+nvl(e.awa' +
        'lkelm2,0)+nvl(f.awalcik2,0)+nvl(w.koreksi2,0)*/)as awal2'
      ''
      
        'from (select distinct nama_item from (select kd_sub_kel as nama_' +
        'item from ipisma_db3.item b where '
      'b.kd_jns_item ='#39'30'#39' and nama_item not like '#39'%ISN%'#39')) a'
      ''
      '-- sisa awal in'
      
        'left outer join (select kd_item, tahun, qty from ipisma_db4.item' +
        '_saldo ) b'
      '  on (a.nama_item=b.kd_item)'
      '  '
      'left outer join (select nama_item, '
      
        'nvl(sum(qty_in),0) as awalgw, nvl(sum(qty_in2),0)as awalgw2 from' +
        ' '
      '(select a.kd_item, a.no_nota, b.kd_sub_kel as nama_item,'
      'qty_in, qty_in2, tgl, kd_transaksi'
      
        'from ipisma_db4.gd_stok2 a, ipisma_db3.item b where a.kd_item=b.' +
        'kd_item)'
      
        '  where trunc(tgl) >=to_date('#39'01/4/2019'#39','#39'dd/mm/yyyy'#39') and trunc' +
        '(tgl) <:pawal '
      '  and kd_transaksi ='#39'872'#39
      '  group by nama_item) c'
      '  on (a.nama_item=c.nama_item)))   );'
      '  '
      '  commit;'
      'end;')
    Session = DMFrm.OS
  ...
  object OracleQuery2: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_mutasi_kor(:pawal);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {0300000001000000060000003A504157414C0C0000000000000000000000}
    Left = 704
