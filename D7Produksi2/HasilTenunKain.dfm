object HasilTenunKainFrm: THasilTenunKainFrm
  Left = 314
  Top = 119
  Width = 972
  Height = 613
  Caption = 'HasilTenunKainFrm'
  Color = clBtnFace
    ...
    object TabSheet5: TTabSheet
      ...
      object wwDBGrid5: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'JML_POT_TENUN'#9'10'#9'PROD TENUN~METER'#9'F'
    ...
    object TabSheet6: TTabSheet
      ...
      object wwDBGrid6: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'JML_POT_TENUN'#9'15'#9'METER'#9'F'#9'QTY')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'PRODUKSI2'
        IniAttributes.Delimiter = ';;'
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db4.hasil_tenun_kain a'
      'where no_reg=:no_reg')
    Variables.Data = {
      0300000001000000070000003A4E4F5F52454703000000040000000000000000
      000000}
    SequenceField.Field = 'NO_REG'
    SequenceField.Sequence = 'ipisma_db4.NO_PROD_KAIN'
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db4.hasil_tenun_detail_kain a'
      'where a.no_reg=:no_reg')
    Variables.Data = {0300000001000000070000003A4E4F5F524547030000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000160000000600000053415455414E0100000000000C0000004E4F5F53
      ...
      535F4D4553494E010000000000020000004B50010000000000}
    Master = QMaster
    MasterFields = 'no_reg'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vrekap_htenun_kain'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000120000000700000054414E4747414C010000000000060000004E4F5F
      ...
      0000000000020000004B50010000000000}
  ...
  object QAmbilData: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_hasil_tenun2(:no_reg,:no_produksi);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
      'select sum(qty) as meter'
      'from ipisma_db4.vrekap_htenun_kain'
      ':myparam'
      ''
      '')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {0400000001000000050000004D45544552010000000000}
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 776
    Top = 200
  ...
  object QAmbilData2: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_hasil_tenun_kain_formasi(:pawal,:pakhir);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QBrowse2: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.lap_tenun_kain_formasi'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      040000000C00000004000000475255500100000000000600000050524F534553
  ...
  object QTotalBrowse2: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(hasil) as hasil from ipisma_db4.lap_tenun_kain_formas' +
        'i'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
  ...
  object QBrowseTotal3: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(jml_pot_tenun) as hasil, sum(jml_pot_bs) as BS from i' +
        'pisma_db4.v_lap_tenun_jns_mesin'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {040000000100000005000000484153494C010000000000}
  ...
  object QAmbilData4: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_ht_kain_per_jenis_mesin3(:date1,:date2);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QTotalBrowse4: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(jml_pot_tenun) as hasil_potong, sum(jml_pot_kodi) as ' +
        'hasil_kodi from ipisma_db4.v_lap_tenun_kain_jns_mesin'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QBrowse4: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.v_lap_tenun_kain_jns_mesin'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object QAmbilData5: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_rekap_ht_kain_konstruksi(:pawal,:pakhir);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
