object WipPertenunanFrm: TWipPertenunanFrm
    ...
    object TabSheet5: TTabSheet
      ...
      object wwDBGrid5: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'QTY_KOREKSI_OUT'#9'10'#9'KOREKSI'#9'F'#9'PENGELUARAN'
          'QTY_AKHIR'#9'10'#9'SISA AKHIR~(Kg)'#9'F')
        IniAttributes.Enabled = True
        IniAttributes.SaveToRegistry = True
        IniAttributes.FileName = 'PRODUKSI2'
        IniAttributes.Delimiter = ';;'
  ...
  object QMBT: TOracleDataSet
    ...
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000130000000A0000004B4F4E535452554B534901000000000005000000
      ...
      000000120000005154595F414646414C5F5249494C5F4F5554010000000000}
    Cursor = crHourGlass
    MasterFields = 'no_desain'
    RefreshOptions = [roAfterInsert]
    Session = DMFrm.OS
