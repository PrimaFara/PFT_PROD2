...
type
  TKoreksiCikalanKeluarFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
    PanelMain: TPanel;
    PanelHeader: TPanel;
...
var
  KoreksiCikalanKeluarFrm: TKoreksiCikalanKeluarFrm;
...
uses DM, Pembelian, ValidasiPenyerahanBB, KelosKeluar, KelosMasuk,
  KoreksiKelosMasuk, KoreksiKelosKeluar;
...
//  if BPBFrm=Nil then
  begin
    ...
    KoreksiCikalanKeluarFrm.vkode:=pkode;
...
procedure TKoreksiCikalanKeluarFrm.FormClose(Sender: TObject;
...
procedure TKoreksiCikalanKeluarFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TKoreksiCikalanKeluarFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TKoreksiCikalanKeluarFrm.BtnOkClick(Sender: TObject);
begin
...
procedure TKoreksiCikalanKeluarFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKoreksiCikalanKeluarFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TKoreksiCikalanKeluarFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TKoreksiCikalanKeluarFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TKoreksiCikalanKeluarFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TKoreksiCikalanKeluarFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TKoreksiCikalanKeluarFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TKoreksiCikalanKeluarFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TKoreksiCikalanKeluarFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
 // ppNo.AsInteger:=0;
end;

procedure TKoreksiCikalanKeluarFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TKoreksiCikalanKeluarFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TKoreksiCikalanKeluarFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TKoreksiCikalanKeluarFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TKoreksiCikalanKeluarFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiCikalanKeluarFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TKoreksiCikalanKeluarFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TKoreksiCikalanKeluarFrm.Label5Click(Sender: TObject);
begin
...
procedure TKoreksiCikalanKeluarFrm.LookKonstruksiEnter(Sender: TObject);
begin
//QBarang.Open;
OracleQuery1.Close;
OracleQuery1.SetVariable('pawal', QMasterTGL.AsDateTime);
...
procedure TKoreksiCikalanKeluarFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TKoreksiCikalanKeluarFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QTime.Open;
...
procedure TKoreksiCikalanKeluarFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
  QTransaksi.DeclareVariable('kd_transaksi', otString);
  QTransaksi.SQL.Text:='select a.* from '+cUserTabel+'vtransaksi a where a.kd_transaksi=:kd_transaksi';
  QTransaksi.SetVariable('kd_transaksi','865');//vkode);
end;

procedure TKoreksiCikalanKeluarFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TKoreksiCikalanKeluarFrm.FormCloseQuery(Sender: TObject;
...
procedure TKoreksiCikalanKeluarFrm.QMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TKoreksiCikalanKeluarFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TKoreksiCikalanKeluarFrm.QLokasiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TKoreksiCikalanKeluarFrm.LookLokasiEnter(Sender: TObject);
begin
  //QLokasi.Open;
end;

procedure TKoreksiCikalanKeluarFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
  {if vjns_brg<>'' then
  begin
...
procedure TKoreksiCikalanKeluarFrm.LookKonstruksiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TKoreksiCikalanKeluarFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TKoreksiCikalanKeluarFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiCikalanKeluarFrm.FormShow(Sender: TObject);
begin
//  PanelHeader.Caption:=QTransaksiKD_TRANSAKSI.AsString+'. '+UpperCase(Caption);
end;

procedure TKoreksiCikalanKeluarFrm.LookWarnaEnter(Sender: TObject);
begin
  DMFrm.QWarna.Open;
end;

procedure TKoreksiCikalanKeluarFrm.QHasilCelupBeforeOpen(
  DataSet: TDataSet);
begin
  QHasilCelup.SetVariable('NO_NOTA',wwDBEdit1.Text);
end;

procedure TKoreksiCikalanKeluarFrm.Button1Click(Sender: TObject);
begin
...
procedure TKoreksiCikalanKeluarFrm.LookResepEnter(Sender: TObject);
begin
  DMFrm.QResep.Open;
end;

procedure TKoreksiCikalanKeluarFrm.LookResepUserButton1Click(
...
procedure TKoreksiCikalanKeluarFrm.QDetailAfterPost(DataSet: TDataSet);
begin
//ShowMessage('dfdsf');

end;

procedure TKoreksiCikalanKeluarFrm.cbPostClick(Sender: TObject);
begin
//DBText3.Caption:='';
end;

procedure TKoreksiCikalanKeluarFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.Open;
...
procedure TKoreksiCikalanKeluarFrm.QTotalBeforeQuery(Sender: TOracleDataSet);
begin
QTotal.SetVariable('no_reg',QMasterIBUKTI.AsInteger);
end;

procedure TKoreksiCikalanKeluarFrm.TabSheet2Show(Sender: TObject);
begin
QBrowse.Close;
QBrowse.Open;
QBrowse.Refresh;
...
procedure TKoreksiCikalanKeluarFrm.BtnPrintInputClick(Sender: TObject);
begin
QuickRep1.Preview;
end;

procedure TKoreksiCikalanKeluarFrm.BtnOk1Click(Sender: TObject);
begin
...
procedure TKoreksiCikalanKeluarFrm.QBrowseRekapAfterScroll(DataSet: TDataSet);
begin
//  LabelBanner.Caption:='Record ke '+IntToStr(QBrowseRekap.RecNo)+' dari '+FormatFloat('#,#',QBrowseRekap.RecordCount)+' Records';
end;

procedure TKoreksiCikalanKeluarFrm.LookItemEnter(Sender: TObject);
begin
{OracleQuery1.Close;
OracleQuery1.SetVariable('pawal', QMasterTGL.AsDateTime);
OracleQuery1.Execute;}
...
OracleQuery2.Close;
OracleQuery2.SetVariable('pawal', trunc(QMasterTGL.AsDateTime));
