object CikalanMasukFrm: TCikalanMasukFrm
  Left = 337
  Top = 122
  Width = 964
  Height = 574
  ActiveControl = vTglAwal
  Caption = 'CIKALAN MASUK'
  Color = clBtnFace
        ...
        object PanelMaster: TPanel
          ...
          object wwDBLookupComboDlg1: TwwDBLookupComboDlg
            ...
            Selected.Strings = (
              ...
              'SISA_CKL'#9'10'#9'SISA CIKALAN'#9'F')
            DataField = 'KP_REV'
            DataSource = dsQMaster
            LookupTable = QKP_REV
            LookupField = 'KP'
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'KONSTRUKSI'#9'25'#9'NAMA'#9'T'#9'BENANG'
          ...
          object LookKonstruksi: TwwDBLookupComboDlg
            ...
            Selected.Strings = (
              ...
              'NAMA_ITEM'#9'50'#9'NAMA_ITEM'#9'F'#9)
            DataField = 'KD_KONSTRUKSI'
            DataSource = dsQDetail
            LookupTable = QBarang
            LookupField = 'KD_ITEM'
        ...
        object PanelBrowse: TPanel
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'NAMA_ITEM'#9'12'#9'NAMA'#9'F'#9'BENANG'
              'KD_WARNA'#9'7'#9'KODE'#9'F'#9'WARNA'
              'WARNA'#9'15'#9'NAMA'#9'F'#9'WARNA'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vkelos_masuk_cikalan'
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
      'select sum(kg) as kg, sum(pcs) as pcs'
      'from ipisma_db4.vkelos_masuk_cikalan'
  ...
  object QAmbil_Data3: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_cikalan_masuk_rekap_shift(:pawal,:pakhir);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QKP: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.kode_produksi_new'
      'where status='#39'1'#39' --and jenis='#39'SARUNG'#39
      'order by kp')
    QBEDefinition.QBEFieldDefs = {
  ...
  object QAmbil_Data1: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_cikalan_masuk_rekap_B(:pawal,:pakhir, :kel);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QStokWIP: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.Proc_stok_warping_temp_v2(:pawal);'
      'end;')
    Session = DMFrm.OS
  ...
  object QKP_REV: TOracleDataSet
    SQL.Strings = (
      ...
      'order by kp */')
    QBEDefinition.QBEFieldDefs = {
      0400000005000000020000004B500100000000000A0000004B4F4E535452554B
      5349010000000000040000004245414D0100000000000400000053544F4B0100
      0000000008000000534953415F434B4C010000000000}
    Session = DMFrm.OS
    Left = 416
    Top = 192
    object QKP_REVKP: TStringField
      DisplayWidth = 10
      FieldName = 'KP'
    end
    object QKP_REVBEAM: TStringField
      DisplayWidth = 30
      FieldName = 'BEAM'
      Size = 50
    end
    object QKP_REVKONSTRUKSI: TStringField
      DisplayWidth = 30
      FieldName = 'KONSTRUKSI'
      Size = 100
    end
    object QKP_REVSTOK: TFloatField
      DisplayWidth = 10
      FieldName = 'STOK'
    end
    object QKP_REVSISA_CKL: TFloatField
      DisplayLabel = 'SISA CIKALAN'
      DisplayWidth = 10
      FieldName = 'SISA_CKL'
    end
  end
