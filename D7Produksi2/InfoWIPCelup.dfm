  ...
  object QDump: TOracleQuery
    SQL.Strings = (
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        'saksi='#39'792'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1' +
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        '  where kd_lokasi=:kd_jns_item and kd_item=a.kd_item and kd_tran' +
        'saksi='#39'802'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1' +
      ...
      '(select sum(qty_out-qty_in) from ipisma_db4.vkartu_stok'
        ...
        '  where kd_lokasi=:kd_jns_item and kd_item=a.kd_item and kd_tran' +
        'saksi='#39'795'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1' +
  ...
  object QDump2: TOracleQuery
    SQL.Strings = (
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        '  where kd_lokasi=:kd_jns_item and kd_item=a.kd_item and kd_tran' +
        'saksi='#39'794'#39' and jns_lokasi='#39'PROSES'#39' and tgl>=trunc(:vsysdate)and' +
      ...
      '(select sum(qty_out-qty_in) from ipisma_db4.vkartu_stok'
        ...
        '  where kd_lokasi=:kd_jns_item and kd_item=a.kd_item and kd_tran' +
        'saksi='#39'792'#39' and jns_lokasi='#39'PROSES'#39' and tgl>=trunc(:vsysdate)and' +
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        '  where  jns_koreksi in ('#39'PROSES ULANG'#39', '#39'KELUAR PROSES'#39', '#39'LAINN' +
        'YA'#39') and kd_lokasi=:kd_jns_item and kd_item=a.kd_item and kd_tra' +
        'nsaksi='#39'804'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+' +
        '1-1/86400)/:VRASIO AS keluar5,'
      '(select sum(qty_in2-qty_out2) from ipisma_db4.vkartu_stok'
  ...
  object QDump3: TOracleQuery
    SQL.Strings = (
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        'asi=:kd_jns_item and kd_item=a.kd_item and kd_transaksi='#39'804'#39' an' +
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        '  where kd_warna=b.kd_warna and kd_lokasi=:kd_jns_item and kd_it' +
        'em=a.kd_item and kd_transaksi='#39'792'#39' and tgl>=trunc(:vsysdate)and' +
        ' tgl<trunc(:vsysdate2)+1-1/86400)/:VRASIO AS masuk1,'
      '(select sum(qty_in2-qty_out2) from ipisma_db4.vkartu_stok'
  ...
  object QDump4: TOracleQuery
    SQL.Strings = (
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        'nd kd_transaksi='#39'804'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vs' +
