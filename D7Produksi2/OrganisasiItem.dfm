object OrganisasiItemFrm: TOrganisasiItemFrm
        ...
        object PanelBrowse: TPanel
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'NO_PART'#9'15'#9'NO PART'#9'F'
              'NAMA_ITEM'#9'57'#9'NAMA ITEM'#9'F'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vitemall2')
  ...
  object QMaxKode: TOracleDataSet
    SQL.Strings = (
      'select max(a.kd_item) as kode from ipisma_db4.item a'
