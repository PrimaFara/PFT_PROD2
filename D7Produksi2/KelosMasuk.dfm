object KelosMasukFrm: TKelosMasukFrm
  Left = 218
  Top = 127
  Width = 1037
  Height = 606
      ...
      object TabSheet1: TTabSheet
        ...
        object PanelMaster: TPanel
          ...
          object Lookkelb: TwwDBComboBox
            ...
            TabOrder = 5
            UnboundDataType = wwDefault
            OnChange = LookkelbChange
          end
          object Lookdesai: TwwDBLookupComboDlg
            Left = 120
            Top = 24
            Width = 121
            Height = 19
            ...
            MaxHeight = 209
            Selected.Strings = (
              'NO_ORDER'#9'20'#9'NO_ORDER'#9'F'#9
              'NO_DESAIN'#9'10'#9'NO_DESAIN'#9'F'#9)
            DataField = 'RESEP'
            DataSource = dsQMaster
            LookupTable = QDesainLook
            LookupField = 'NO_ORDER'
            TabOrder = 6
            AutoDropDown = True
            ShowButton = True
            AllowClearKey = False
            OnCloseUp = LookdesaiCloseUp
            OnEnter = LookdesaiEnter
          end
          object LookTambahan: TwwDBLookupComboDlg
            ...
            MaxHeight = 209
            Selected.Strings = (
              'NO_NOTA'#9'22'#9'NO_NOTA'#9'F')
            DataField = 'RESEP'
            DataSource = dsQMaster
            LookupTable = QTambahan
            LookupField = 'NO_NOTA'
            TabOrder = 7
            AutoDropDown = True
            ShowButton = True
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vkelos_masuk'
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db4.kelos_masuk_detail a'
      'where a.no_reg=:no_reg')
    Variables.Data = {
      0300000001000000070000003A4E4F5F52454703000000040000004A79000000
      000000}
    SequenceField.Field = 'NO_REG_DET'
    SequenceField.Sequence = 'ipisma_db4.no_reg_km_DETAIL'
    QBEDefinition.QBEFieldDefs = {
      040000000C0000000A0000004B45544552414E47414E01000000000008000000
      ...
      000000000400000051545931010000000000}
    RefreshOptions = [roAfterInsert, roAfterUpdate]
    Session = DMFrm.OS
  ...
  object QBarang: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vitemall_2'
      ''
      '')
    QBEDefinition.QBEFieldDefs = {
  ...
  object QAmbil_Data2: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_kelos_masuk_rekap(:pawal,:pakhir);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QAmbil_Data3: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_kelos_masuk_rekap_shift(:pawal,:pakhir);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QBrowseRekap3_Total: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(t.I) as I, sum(t.II) as II, sum(t.III) as III, sum(t.' +
        'jumlah) as jumlah from ipisma_db4.kelos_rekap2 t')
    QBEDefinition.QBEFieldDefs = {
  ...
  object QAmbilResep: TOracleQuery
    SQL.Strings = (
      'begin'
      'ipisma_db4.proc_ambil_resep(:desai,:qmas);'
      'commit;'
      'end;'
      '')
    Session = DMFrm.OS
    Variables.Data = {
      0300000002000000060000003A44455341490500000000000000000000000500
      00003A514D4153030000000000000000000000}
    Left = 328
    Top = 272
  end
  object QWarna: TOracleDataSet
    SQL.Strings = (
      'select a.* from ipisma_db3.warna_baru a'
  ...
  object QAmbil_Data: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_kelos_masuk_rekap_B23(:pawal,:pakhir, :kel);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QAmbil_data1: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_kelos_masuk_rekap_B(:pawal,:pakhir, :kel);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QCek_idrab: TOracleDataSet
    SQL.Strings = (
        ...
        'select resep from ipisma_db4.kelos_masuk where resep=:res and is' +
        'post='#39'1'#39)
    Variables.Data = {0300000001000000040000003A524553050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {0400000001000000050000005245534550010000000000}
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 320
    Top = 328
    object QCek_idrabRESEP: TStringField
      FieldName = 'RESEP'
    end
  end
  object QCek_Tambah: TOracleDataSet
    SQL.Strings = (
      
        'select resep from ipisma_db4.kelos_masuk where resep=:res and is' +
        'post='#39'1'#39)
    Variables.Data = {
      0300000001000000040000003A524553050000000900000054414D424148414E
      0000000000}
    QBEDefinition.QBEFieldDefs = {0400000001000000050000005245534550010000000000}
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 744
    Top = 344
    object QCek_TambahRESEP: TStringField
      FieldName = 'RESEP'
    end
  end
  object QTambahan: TOracleDataSet
    SQL.Strings = (
      
        'select distinct a.no_nota/*, b.no_bukti as no_resep*/ from ipism' +
        'a_db4.bukti a, ipisma_db4.bukti_detail b'
      
        'where trunc(a.tgl) > to_date('#39'01/01/2022'#39','#39'dd/mm/yyyy'#39')/*to_date' +
        '('#39'01/01/2020'#39','#39'dd/mm/yyyy'#39')*/ and b.no_bukti IN ('#39'TAMBAHAN'#39','#39'WIR' +
        'ON'#39') and a.ibukti=b.ibukti'
      'and ispost='#39'1'#39' and kd_transaksi <> '#39'890'#39
      ''
      'minus'
      ''
      'select resep from ipisma_db4.kelos_masuk t'
      'where /*resep like '#39'872%'#39'*/ kd_transaksi= '#39'872'#39
      '')
    QBEDefinition.QBEFieldDefs = {0400000001000000070000004E4F5F4E4F5441010000000000}
    Session = DMFrm.OS3
    Left = 824
    Top = 400
    object QTambahanNO_NOTA: TStringField
      DisplayWidth = 22
      FieldName = 'NO_NOTA'
      Size = 22
    end
  end
  object Tambahan: TOracleQuery
    SQL.Strings = (
      'begin'
      'ipisma_db4.proc_ambil_resep_tambahan(:desai,:qmas);'
      'commit;'
      'end;'
      '')
    Session = DMFrm.OS
  ...
  object QDesainLook: TOracleDataSet
    SQL.Strings = (
      
        'select no_order, no_desain, KP, konstruksi, beam from ipisma_db4' +
        '.vdesain_look_kelos a')
    QBEDefinition.QBEFieldDefs = {
      0400000002000000080000004E4F5F4F52444552010000000000090000004E4F
      5F44455341494E010000000000}
    Session = DMFrm.OS3
    Left = 832
    Top = 336
    object QDesainLookNO_ORDER: TStringField
      FieldName = 'NO_ORDER'
    end
    object QDesainLookNO_DESAIN: TFloatField
      FieldName = 'NO_DESAIN'
      Required = True
    end
  end
