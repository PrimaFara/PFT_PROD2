object DesainResumekainFrm: TDesainResumekainFrm
  Left = 246
  Top = 208
  BorderStyle = bsDialog
  Caption = 'DesainResumekainFrm'
  ClientHeight = 241
  ClientWidth = 915
  Color = clBtnFace
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    ExportOptions.FileName = 'Resume Desain'
    ExportOptions.Options = [esoShowHeader, esoShowTitle, esoDblQuoteFields, esoShowRecordNo, esoShowAlternating]
    TitleColor = clBtnFace
    FixedCols = 0
    ShowHorzScrollBar = True
    Align = alClient
    Color = clYellow
    DataSource = DesainKainFrm.dsCDSQDetail5
