...
type
  TPermintaanKoreksi_kanjiFrm = class(TForm)
...
var
  PermintaanKoreksi_kanjiFrm: TPermintaanKoreksi_kanjiFrm;
...
//  if BPBFrm=Nil then
  begin
    PermintaanKoreksi_kanjiFrm:=TPermintaanKoreksi_kanjiFrm.Create(Application);
    PermintaanKoreksi_kanjiFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       PermintaanKoreksi_kanjiFrm.QMaster.ReadOnly:=True;
       PermintaanKoreksi_kanjiFrm.QDetail.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    PermintaanKoreksi_kanjiFrm.Caption:=UpperCase(pkode+pjudul);
    PermintaanKoreksi_kanjiFrm.vkode:=pkode;//copy(pjudul,1,3);
   // PermintaanKoreksi_kanjiFrm.vjns_lokasi:='';    ShowMessage(PermintaanKoreksi_kanjiFrm.QTransaksiKD_TRANSAKSI.AsString);
  //  PermintaanKoreksi_kanjiFrm.vjns_brg:='';
    PermintaanKoreksi_kanjiFrm.QTransaksi.Open;

    PermintaanKoreksi_kanjiFrm.Caption:=UpperCase(pkode+pjudul);
    PermintaanKoreksi_kanjiFrm.PanelHeader.Caption:=PermintaanKoreksi_kanjiFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+PermintaanKoreksi_kanjiFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    PermintaanKoreksi_kanjiFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    PermintaanKoreksi_kanjiFrm.wwDBGrid1.IniAttributes.SectionName:=PermintaanKoreksi_kanjiFrm.Caption+'1';
    PermintaanKoreksi_kanjiFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    PermintaanKoreksi_kanjiFrm.wwDBGrid1.LoadFromIniFile;
    PermintaanKoreksi_kanjiFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    PermintaanKoreksi_kanjiFrm.wwDBGrid2.IniAttributes.SectionName:=PermintaanKoreksi_kanjiFrm.Caption+'2';
    PermintaanKoreksi_kanjiFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    PermintaanKoreksi_kanjiFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,PermintaanKoreksi_kanjiFrm.Caption+'1',PermintaanKoreksi_kanjiFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,PermintaanKoreksi_kanjiFrm.Caption+'2',PermintaanKoreksi_kanjiFrm.wwDBGrid2);
    PermintaanKoreksi_kanjiFrm.wwDBSpinLine1.Value:=PermintaanKoreksi_kanjiFrm.wwDBGrid1.RowHeightPercent;
    PermintaanKoreksi_kanjiFrm.wwDBSpinLine2.Value:=PermintaanKoreksi_kanjiFrm.wwDBGrid2.RowHeightPercent;
...
procedure TPermintaanKoreksi_kanjiFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'1',wwDBGrid1);
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   PermintaanKoreksi_kanjiFrm:=Nil;
end;

procedure TPermintaanKoreksi_kanjiFrm.FormCreate(Sender: TObject);
begin
//barcode
...
QTransaksi.Close;
QTransaksi.SetVariable('kd_transaksi','865');
QTransaksi.Open;
...
procedure TPermintaanKoreksi_kanjiFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_kanjiFrm.BtnOkClick(Sender: TObject);
begin
      ...
      QBrowse.SQL.Text:='select * from ipisma_db4.vpermintaankoreksi_persiapan'+
        ' where trunc(tanggal)>=:pawal and trunc(tanggal)<=:pakhir and kd_transaksi=:kd_transaksi :porder';
  		...
  		QBrowse.SetVariable('pakhir',Trunc(vTglAkhir.Date)+1-1/86400);
			QBrowse.SetVariable('kd_transaksi','865');
...
procedure TPermintaanKoreksi_kanjiFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TPermintaanKoreksi_kanjiFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TPermintaanKoreksi_kanjiFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TPermintaanKoreksi_kanjiFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TPermintaanKoreksi_kanjiFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TPermintaanKoreksi_kanjiFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TPermintaanKoreksi_kanjiFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_kanjiFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TPermintaanKoreksi_kanjiFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  //ppNo.AsInteger:=0;
end;

procedure TPermintaanKoreksi_kanjiFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TPermintaanKoreksi_kanjiFrm.Button1Click(Sender: TObject);
begin
//  ppDesigner1.ShowModal;
end;

procedure TPermintaanKoreksi_kanjiFrm.BtnDesign2Click(Sender: TObject);
begin
//  ppDesigner1.ShowModal;
end;

procedure TPermintaanKoreksi_kanjiFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_kanjiFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TPermintaanKoreksi_kanjiFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TPermintaanKoreksi_kanjiFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_kanjiFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TPermintaanKoreksi_kanjiFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
//  ppNo2.AsInteger:=ppNo2.AsInteger+1;
end;

procedure TPermintaanKoreksi_kanjiFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_kanjiFrm.BtnPrintInputClick(Sender: TObject);
begin
//  ppReportInput.Print;
end;

procedure TPermintaanKoreksi_kanjiFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_kanjiFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_kanjiFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TPermintaanKoreksi_kanjiFrm.Label5Click(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_kanjiFrm.LookItemEnter(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_kanjiFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_kanjiFrm.QMasterNewRecord(DataSet: TDataSet);
begin
QTransaksi.Close;
QTransaksi.Open;
...
procedure TPermintaanKoreksi_kanjiFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_kanjiFrm.ppPageStyle1BeforePrint(Sender: TObject);
begin
//  ppNo2.AsInteger:=0;
end;

procedure TPermintaanKoreksi_kanjiFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TPermintaanKoreksi_kanjiFrm.FormCloseQuery(Sender: TObject;
...
procedure TPermintaanKoreksi_kanjiFrm.QMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_kanjiFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_kanjiFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
//  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TPermintaanKoreksi_kanjiFrm.QProc_Update_POBeforeQuery(Sender: TOracleQuery);
begin
//  QProc_Update_PO.SetVariable('NO_PO',QMasterNO_BUKTI.AsString);
end;

procedure TPermintaanKoreksi_kanjiFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TPermintaanKoreksi_kanjiFrm.QDetailCalcFields(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_kanjiFrm.TabSheet3Show(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_kanjiFrm.QItemBeforeOpen(DataSet: TDataSet);
begin
// QLokasi.Open;
end;

procedure TPermintaanKoreksi_kanjiFrm.BitBtn1Click(Sender: TObject);
var
vuser, vpwd : string;
nota: string;
cetak : string ;
...
procedure TPermintaanKoreksi_kanjiFrm.CheckBox1Click(Sender: TObject);
BEGIN
{VAR
nota: string;
cetak : string ;
...
procedure TPermintaanKoreksi_kanjiFrm.wwCheckBox1Click(Sender: TObject);
{VAR
nota: string;
cetak : string ;
opr_insert : string;
...
procedure TPermintaanKoreksi_kanjiFrm.FormShow(Sender: TObject);
begin
     TabSheet3.TabVisible:=False;
end;

procedure TPermintaanKoreksi_kanjiFrm.wwDBGrid1UpdateFooter(
  Sender: TObject);
begin
  {QTotal.Close;
  QTotal.Open;}
