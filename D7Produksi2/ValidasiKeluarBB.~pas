...
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ...
    begin
      ...
      QBrowse.SQL.Text:='select * from IPISMA_DB3.vvalidasikeluarbbfrm where tanggal>=:pawal and tanggal<=:pakhir and kd_transaksi=:kd_transaksi :porder';
...
begin
  ...
  QTransaksi.SQL.Text:='select a.* from ipisma_db3.vtransaksi a where a.kd_transaksi=:kd_transaksi';
...
begin
  ...
  QLokasi.SQL.Text:='select * from ipisma_db3.sub_lokasi where kd_lokasi=:vjns_lokasi';
