object CikalanKeluarFrm: TCikalanKeluarFrm
  Left = 236
  Top = 99
  Width = 1056
  Height = 625
  Caption = '862. CIKALAN KELUAR'
  Color = clBtnFace
      ...
      object TabSheet1: TTabSheet
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              'KD_KONSTRUKSI'#9'5'#9'KODE'#9'F'#9'BENANG'
              'KONSTRUKSI'#9'20'#9'NAMA'#9'T'#9'BENANG'
          ...
          object LookWarna2: TwwDBComboDlg
            Left = 200
            Top = 199
            Width = 121
            Height = 19
            OnCustomDlg = LookWarna2CustomDlg
            ShowButton = True
            Style = csDropDown
            DataField = 'KD_WARNA'
            DataSource = dsQDetail
        ...
        object PanelBrowse: TPanel
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'NAMA_ITEM'#9'15'#9'NAMA'#9'F'#9'BENANG'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vkelos_cikalan'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      01000000000004000000475255500100000000000A0000004B445F5355425F4B
      454C010000000000060000004953504F53540100000000000500000053484946
      54010000000000090000004E4F5F44455341494E010000000000050000005245
      534550010000000000}
    ReadOnly = True
  ...
  object QMaster: TOracleDataSet
    ...
    Variables.Data = {
      0300000001000000090000003A504E4F5F4E4F54410500000000000000000000
      00}
    SequenceField.Field = 'NO_REG'
    SequenceField.Sequence = 'IPISMA_DB4.NO_REG_KELOS'
  ...
  object QCek_KM: TOracleDataSet
    SQL.Strings = (
        ...
        ' no_bukti like '#39'875%'#39' and ispost='#39'1'#39)
  ...
  object QBrowseRekap2: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
      0000000000020000004347010000000000020000004447010000000000}
    ReadOnly = True
    QueryAllRecords = False
    Session = DMFrm.OS
  ...
  object QAmbil_Data2: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_cikalan_rekap(:pawal,:pakhir);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
      'select sum(kg) as kg, sum(pcs) as pcs'
      'from ipisma_db4.vkelos_cikalan'
  ...
  object QBrowseRekap2_Total: TOracleDataSet
    SQL.Strings = (
      ...
      'sum(t.jumlah) as jumlah from ipisma_db4.cikalan_rekap t')
    QBEDefinition.QBEFieldDefs = {
  ...
  object QAmbil_Data3: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_cikalan_rekap_shift(:pawal,:pakhir);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QBrowseRekap3: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.cikalan_rekap2')
    QBEDefinition.QBEFieldDefs = {
  ...
  object QBrowseRekap3_Total: TOracleDataSet
    SQL.Strings = (
        ...
        'jumlah) as jumlah from ipisma_db4.cikalan_rekap2 t')
    QBEDefinition.QBEFieldDefs = {
  ...
  object QNo_bukti: TOracleDataSet
    SQL.Strings = (
      'select no_nota from ipisma_db4.kelos_masuk'
        ...
        'where trunc(tanggal) > to_date('#39'01/01/2018'#39','#39'dd/mm/yyyy'#39') and is' +
        'post ='#39'1'#39' and kd_transaksi = '#39'875'#39
      ''
      'minus'
      ''
      'select no_bukti from ipisma_db4.kelos where ispost = '#39'1'#39
      '')
  ...
  object QNo_Bukti1: TOracleDataSet
    SQL.Strings = (
        ...
        'select no_nota, resep, no_desain,kel, KETERANGAN, konstruksi, be' +
        'am, KP_REV from ipisma_db4.kelos_masuk'
      
        'where trunc(tanggal) > to_date('#39'01/01/2018'#39','#39'dd/mm/yyyy'#39') and is' +
        'post ='#39'1'#39' and kd_transaksi = '#39'875'#39' and no_nota=:nota'
      ''
      '')
    Variables.Data = {
      0300000001000000050000003A4E4F5441050000000F0000003837352D313930
      362D30303030310000000000}
    QBEDefinition.QBEFieldDefs = {
      
      00004B505F524556010000000000}
    Session = DMFrm.OS
    BeforeOpen = QHasilCelupBeforeOpen
    Left = 648
    Top = 232
    ...
    object QNo_Bukti1KONSTRUKSI: TStringField
      FieldName = 'KONSTRUKSI'
      Size = 50
    end
    object QNo_Bukti1BEAM: TStringField
      FieldName = 'BEAM'
      Size = 50
    end
    object QNo_Bukti1KP_REV: TStringField
      FieldName = 'KP_REV'
    end
  end
  object QAmbil_Data1: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_cikalan_keluar_rekap_B(:pawal,:pakhir, :kel);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
