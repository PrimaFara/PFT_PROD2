unit PermintaanKoreksi_cikalan;
...
type
  TPermintaanKoreksi_cikalanFrm = class(TForm)
    ...
    QTotalAWAL3: TFloatField;
    QTotalAKHIR1: TFloatField;
    QTotalAKHIR2: TFloatField;
    QTotalAKHIR3: TFloatField;
    QTotalSELISIH1: TFloatField;
    QTotalSELISIH2: TFloatField;
    QTotalSELISIH3: TFloatField;
...
var
  PermintaanKoreksi_cikalanFrm: TPermintaanKoreksi_cikalanFrm;
...
//  if BPBFrm=Nil then
  begin
    PermintaanKoreksi_cikalanFrm:=TPermintaanKoreksi_cikalanFrm.Create(Application);
    PermintaanKoreksi_cikalanFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       PermintaanKoreksi_cikalanFrm.QMaster.ReadOnly:=True;
       PermintaanKoreksi_cikalanFrm.QDetail.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    PermintaanKoreksi_cikalanFrm.Caption:=UpperCase(pkode+pjudul);
    PermintaanKoreksi_cikalanFrm.vkode:=pkode;//copy(pjudul,1,3);
   // PermintaanKoreksi_cikalanFrm.vjns_lokasi:='';    ShowMessage(PermintaanKoreksi_cikalanFrm.QTransaksiKD_TRANSAKSI.AsString);
  //  PermintaanKoreksi_cikalanFrm.vjns_brg:='';
    PermintaanKoreksi_cikalanFrm.QTransaksi.Open;

    PermintaanKoreksi_cikalanFrm.Caption:=UpperCase(pkode+pjudul);
    PermintaanKoreksi_cikalanFrm.PanelHeader.Caption:=PermintaanKoreksi_cikalanFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+PermintaanKoreksi_cikalanFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    PermintaanKoreksi_cikalanFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    PermintaanKoreksi_cikalanFrm.wwDBGrid1.IniAttributes.SectionName:=PermintaanKoreksi_cikalanFrm.Caption+'1';
    PermintaanKoreksi_cikalanFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    PermintaanKoreksi_cikalanFrm.wwDBGrid1.LoadFromIniFile;
    PermintaanKoreksi_cikalanFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    PermintaanKoreksi_cikalanFrm.wwDBGrid2.IniAttributes.SectionName:=PermintaanKoreksi_cikalanFrm.Caption+'2';
    PermintaanKoreksi_cikalanFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    PermintaanKoreksi_cikalanFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,PermintaanKoreksi_cikalanFrm.Caption+'1',PermintaanKoreksi_cikalanFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,PermintaanKoreksi_cikalanFrm.Caption+'2',PermintaanKoreksi_cikalanFrm.wwDBGrid2);
    PermintaanKoreksi_cikalanFrm.wwDBSpinLine1.Value:=PermintaanKoreksi_cikalanFrm.wwDBGrid1.RowHeightPercent;
    PermintaanKoreksi_cikalanFrm.wwDBSpinLine2.Value:=PermintaanKoreksi_cikalanFrm.wwDBGrid2.RowHeightPercent;
...
procedure TPermintaanKoreksi_cikalanFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'1',wwDBGrid1);
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   PermintaanKoreksi_cikalanFrm:=Nil;
end;

procedure TPermintaanKoreksi_cikalanFrm.FormCreate(Sender: TObject);
begin
//barcode
...
QTransaksi.Close;
QTransaksi.SetVariable('kd_transaksi','866');
QTransaksi.Open;
...
procedure TPermintaanKoreksi_cikalanFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_cikalanFrm.BtnOkClick(Sender: TObject);
begin
      ...
      QBrowse.SQL.Text:='select * from ipisma_db4.vpermintaankoreksi_persiapan'+
        ' where trunc(tanggal)>=:pawal and trunc(tanggal)<=:pakhir and kd_transaksi=:kd_transaksi :porder';
  		...
  		QBrowse.SetVariable('pakhir',Trunc(vTglAkhir.Date)+1-1/86400);
			QBrowse.SetVariable('kd_transaksi','866');
...
procedure TPermintaanKoreksi_cikalanFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TPermintaanKoreksi_cikalanFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TPermintaanKoreksi_cikalanFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TPermintaanKoreksi_cikalanFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TPermintaanKoreksi_cikalanFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TPermintaanKoreksi_cikalanFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TPermintaanKoreksi_cikalanFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_cikalanFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TPermintaanKoreksi_cikalanFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  //ppNo.AsInteger:=0;
end;

procedure TPermintaanKoreksi_cikalanFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TPermintaanKoreksi_cikalanFrm.Button1Click(Sender: TObject);
begin
//  ppDesigner1.ShowModal;
end;

procedure TPermintaanKoreksi_cikalanFrm.BtnDesign2Click(Sender: TObject);
begin
//  ppDesigner1.ShowModal;
end;

procedure TPermintaanKoreksi_cikalanFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_cikalanFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TPermintaanKoreksi_cikalanFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TPermintaanKoreksi_cikalanFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_cikalanFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TPermintaanKoreksi_cikalanFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
//  ppNo2.AsInteger:=ppNo2.AsInteger+1;
end;

procedure TPermintaanKoreksi_cikalanFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_cikalanFrm.BtnPrintInputClick(Sender: TObject);
begin
//  ppReportInput.Print;
end;

procedure TPermintaanKoreksi_cikalanFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_cikalanFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_cikalanFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TPermintaanKoreksi_cikalanFrm.Label5Click(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_cikalanFrm.LookItemEnter(Sender: TObject);
begin
//  (sender as TwwDBLookupComboDlg).LookupTable.Open;
OracleQuery1.Close;
//OracleQuery1.SetVariable('pawal', trunc(QMasterTGL.AsDateTime));
...
procedure TPermintaanKoreksi_cikalanFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_cikalanFrm.QMasterNewRecord(DataSet: TDataSet);
begin
QTransaksi.Close;
QTransaksi.Open;
...
procedure TPermintaanKoreksi_cikalanFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_cikalanFrm.ppPageStyle1BeforePrint(Sender: TObject);
begin
//  ppNo2.AsInteger:=0;
end;

procedure TPermintaanKoreksi_cikalanFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TPermintaanKoreksi_cikalanFrm.FormCloseQuery(Sender: TObject;
...
procedure TPermintaanKoreksi_cikalanFrm.QMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_cikalanFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_cikalanFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
//  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TPermintaanKoreksi_cikalanFrm.QProc_Update_POBeforeQuery(Sender: TOracleQuery);
begin
//  QProc_Update_PO.SetVariable('NO_PO',QMasterNO_BUKTI.AsString);
end;

procedure TPermintaanKoreksi_cikalanFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TPermintaanKoreksi_cikalanFrm.QDetailCalcFields(DataSet: TDataSet);
begin
...
procedure TPermintaanKoreksi_cikalanFrm.TabSheet3Show(Sender: TObject);
begin
...
procedure TPermintaanKoreksi_cikalanFrm.QItemBeforeOpen(DataSet: TDataSet);
begin
// QLokasi.Open;
end;

procedure TPermintaanKoreksi_cikalanFrm.BitBtn1Click(Sender: TObject);
var
vuser, vpwd : string;
nota: string;
cetak : string ;
...
procedure TPermintaanKoreksi_cikalanFrm.CheckBox1Click(Sender: TObject);
BEGIN
{VAR
nota: string;
cetak : string ;
...
procedure TPermintaanKoreksi_cikalanFrm.wwCheckBox1Click(Sender: TObject);
{VAR
nota: string;
cetak : string ;
opr_insert : string;
...
procedure TPermintaanKoreksi_cikalanFrm.FormShow(Sender: TObject);
begin
     TabSheet3.TabVisible:=False;
end;

procedure TPermintaanKoreksi_cikalanFrm.wwDBGrid1UpdateFooter(
  Sender: TObject);
begin
  {QTotal.Close;
  QTotal.Open; }
...
wwDBGrid1.ColumnByName('QTY4').FooterValue:=FormatFloat('#.#,#;#.#,#; ',QTotalAKHIR1.AsFloat);
wwDBGrid1.ColumnByName('QTY5').FooterValue:=FormatFloat('#.#,#;#.#,#; ',QTotalAKHIR2.AsFloat);
wwDBGrid1.ColumnByName('QTY6').FooterValue:=FormatFloat('#.#,#;#.#,#; ',QTotalAKHIR3.AsFloat);
