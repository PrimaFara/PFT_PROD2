...
type
  TKoreksiKelosMasukFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
    PanelMain: TPanel;
    PanelHeader: TPanel;
...
var
  KoreksiKelosMasukFrm: TKoreksiKelosMasukFrm;
...
//  if BPBFrm=Nil then
  begin
    ...
    KoreksikelosMasukFrm.vkode:=pkode;
...
procedure TKoreksiKelosMasukFrm.FormClose(Sender: TObject;
...
procedure TKoreksiKelosMasukFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TKoreksiKelosMasukFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TKoreksiKelosMasukFrm.BtnOkClick(Sender: TObject);
begin
...
procedure TKoreksiKelosMasukFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKoreksiKelosMasukFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TKoreksiKelosMasukFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TKoreksiKelosMasukFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TKoreksiKelosMasukFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TKoreksiKelosMasukFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TKoreksiKelosMasukFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TKoreksiKelosMasukFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TKoreksiKelosMasukFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
 // ppNo.AsInteger:=0;
end;

procedure TKoreksiKelosMasukFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TKoreksiKelosMasukFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TKoreksiKelosMasukFrm.TabSheet1Show(Sender: TObject);
begin
...
//   ShowMessage('11111');
 ...
 // QDetail.SequenceField.Field:='NO_REG_DET';
  ...
  QDetail.SetVariable('no_reg',QMasterIBUKTI.AsInteger);
...
procedure TKoreksiKelosMasukFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TKoreksiKelosMasukFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiKelosMasukFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TKoreksiKelosMasukFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TKoreksiKelosMasukFrm.Label5Click(Sender: TObject);
begin
...
procedure TKoreksiKelosMasukFrm.LookKonstruksiEnter(Sender: TObject);
begin
//QBarang.Open;
...
procedure TKoreksiKelosMasukFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TKoreksiKelosMasukFrm.QMasterNewRecord(DataSet: TDataSet);
begin
DMFrm.QTime.Open;
...
procedure TKoreksiKelosMasukFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
  QTransaksi.DeclareVariable('kd_transaksi', otString);
  QTransaksi.SQL.Text:='select a.* from '+cUserTabel+'vtransaksi a where a.kd_transaksi=:kd_transaksi';
  QTransaksi.SetVariable('kd_transaksi','877');//vkode);
end;

procedure TKoreksiKelosMasukFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TKoreksiKelosMasukFrm.FormCloseQuery(Sender: TObject;
...
procedure TKoreksiKelosMasukFrm.QMasterAfterPost(DataSet: TDataSet);
begin
...
procedure TKoreksiKelosMasukFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TKoreksiKelosMasukFrm.QLokasiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TKoreksiKelosMasukFrm.LookLokasiEnter(Sender: TObject);
begin
  //QLokasi.Open;
end;

procedure TKoreksiKelosMasukFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
  {if vjns_brg<>'' then
  begin
...
procedure TKoreksiKelosMasukFrm.LookKonstruksiCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TKoreksiKelosMasukFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  QDetailIBUKTI.AsInteger:=QMasterIBUKTI.AsInteger;
  if vkd_konstruksi<>'' then QDetailKD_ITEM.AsString:=vkd_konstruksi;
  if vkd_warna<>'' then QDetailKD_WARNA.AsString:=vkd_warna;
//  QDetail.AsDateTime:=QMasterTANGGAL.AsDateTime;
//  QDetailNO_NOTA.AsString:=QMasterNO_NOTA.AsString;
end;

procedure TKoreksiKelosMasukFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
vkd_konstruksi:= QDetailKD_ITEM.AsString;
vkd_warna:=QDetailKD_WARNA.AsString;


end;

procedure TKoreksiKelosMasukFrm.FormShow(Sender: TObject);
begin
//  PanelHeader.Caption:=QTransaksiKD_TRANSAKSI.AsString+'. '+UpperCase(Caption);
end;

procedure TKoreksiKelosMasukFrm.LookWarnaEnter(Sender: TObject);
begin
  DMFrm.QWarna.Open;
end;

procedure TKoreksiKelosMasukFrm.QHasilCelupBeforeOpen(
  DataSet: TDataSet);
begin
  QHasilCelup.SetVariable('NO_NOTA',wwDBEdit1.Text);
end;

procedure TKoreksiKelosMasukFrm.Button1Click(Sender: TObject);
begin
...
procedure TKoreksiKelosMasukFrm.LookResepEnter(Sender: TObject);
begin
  DMFrm.QResep.Open;
end;

procedure TKoreksiKelosMasukFrm.LookResepUserButton1Click(
...
procedure TKoreksiKelosMasukFrm.QDetailAfterPost(DataSet: TDataSet);
begin
//ShowMessage('dfdsf');

end;

procedure TKoreksiKelosMasukFrm.cbPostClick(Sender: TObject);
begin
//DBText3.Caption:='';
end;

procedure TKoreksiKelosMasukFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
  QTotal.Open;
...
procedure TKoreksiKelosMasukFrm.QTotalBeforeQuery(Sender: TOracleDataSet);
begin
QTotal.SetVariable('no_reg',QMasterIBUKTI.AsInteger);
end;

procedure TKoreksiKelosMasukFrm.TabSheet2Show(Sender: TObject);
begin
QBrowse.Close;
QBrowse.Open;
QBrowse.Refresh;
...
procedure TKoreksiKelosMasukFrm.BtnPrintInputClick(Sender: TObject);
begin
QuickRep1.Preview;
end;

procedure TKoreksiKelosMasukFrm.BtnOk1Click(Sender: TObject);
begin
...
procedure TKoreksiKelosMasukFrm.QBrowseRekapAfterScroll(DataSet: TDataSet);
begin
