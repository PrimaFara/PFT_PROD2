object HasilTenunSTFrm: THasilTenunSTFrm
  Left = 190
  Top = 125
  Width = 1169
  Height = 602
  Caption = 'HasilTenunSTFrm'
  Color = clBtnFace
    ...
    object TabSheet1: TTabSheet
      ...
      object QuickRep1: TQuickRep
        ...
        object SummaryBand1: TQRBand
          ...
          object QRExpr1: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QDetail_rekap.QTY)'
            FontSize = 8
          end
          object QRExpr2: TQRExpr
            ...
            Transparent = False
            WordWrap = True
            Expression = 'sum(QDetail_rekap.MESIN)'
            FontSize = 8
          end
          ...
          object QRLabel22: TQRLabel
            ...
            AutoSize = True
            AutoStretch = False
            Caption = 'Pabrik Tekstil Pismatex'
            Color = clWhite
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -16
        ...
        object QRLabel9: TQRLabel
          ...
          AutoSize = True
          AutoStretch = False
          Caption = 'Dikirim Kebagian Inspecting'
          Color = clWhite
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
      ...
      object Panel3: TPanel
        ...
        object Panel4: TPanel
          ...
          object Tanggal: TwwDBDateTimePicker
            Left = 16
            Top = 65
            Width = 137
            Height = 21
        ...
        object wwDBGrid3: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'SATUAN'#9'7'#9'SATUAN'#9'F'#9'HASIL'
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'PCS'#9'10'#9'PCS'#9'F'
          'QTY'#9'10'#9'QTY'#9'F'
          'LOKASI'#9'1'#9'LOKASI'#9'F'
          'PROSES'#9'5'#9'PROSES'#9'F'
          'OPR_TENUN'#9'25'#9'OPR~TENUN'#9'F'
          'SHIFT'#9'1'#9'SHIFT'#9'F'
          'TGL_PRODUKSI'#9'18'#9'TGL~PRODUKSI'#9'F')
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db4.hasil_tenun_st a'
      'where no_reg=:no_reg')
    Variables.Data = {0300000001000000070000003A4E4F5F524547030000000000000000000000}
    SequenceField.Field = 'NO_REG'
    SequenceField.Sequence = 'ipisma_db4.NO_REG_HASIL_TENUN_ST'
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      04000000090000000700000054414E4747414C010000000000060000004E4F5F
      ...
      0100000000000D0000004A4E535F5452414E53414B53490100000000000C0000
      004B445F5452414E53414B5349010000000000}
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db4.hasil_tenun_detail_st a'
      'where a.no_reg =:no_reg')
    Variables.Data = {0300000001000000070000003A4E4F5F524547030000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000150000000600000053415455414E0100000000000C0000004E4F5F53
      ...
      
      000B0000004A454E49535F4D4553494E010000000000}
    Master = QMaster
    MasterFields = 'no_reg'
    ...
    object QDetailTANGGAL_PRODUKSI: TDateTimeField
      FieldName = 'TANGGAL_PRODUKSI'
    end
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vrekap_htenun_st'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000100000000700000054414E4747414C010000000000060000004E4F5F
      ...
      
      0000000003000000504353010000000000}
  ...
  object QAmbilData: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_ambil_hasil_tenun(:noreg, :noreg_ht);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
      0300000002000000060000003A4E4F5245470300000000000000000000000900
      00003A4E4F5245475F4854030000000000000000000000}
    Left = 984
    Top = 136
  end
  object QBrowseTotal: TOracleDataSet
    SQL.Strings = (
      ...
      'from ipisma_db4.vrekap_htenun_st'
      ':myparam'
      ''
      '')
    Variables.Data = {
  ...
  object QAmbilData2: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_rekap_hasil_tenun(:no_reg);'
      '  commit;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {0300000001000000070000003A4E4F5F524547030000000000000000000000}
  ...
  object QDetail_rekap: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vrekap_htenun_st2'
      'where lokasi =:lokasi')
    Variables.Data = {
      0300000001000000070000003A4C4F4B4153490500000004000000322E310000
      000000}
    QBEDefinition.QBEFieldDefs = {
      040000000400000003000000515459010000000000060000004C4F4B41534901
      00000000000A0000004B4F4E535452554B5349010000000000050000004D4553
      494E010000000000}
    RefreshOptions = [roAfterInsert, roAfterUpdate]
    Session = DMFrm.OS
    Left = 1098
    Top = 184
    object QDetail_rekapKONSTRUKSI: TStringField
      FieldName = 'KONSTRUKSI'
      Size = 100
    end
    object QDetail_rekapMESIN: TFloatField
      FieldName = 'MESIN'
    end
    object QDetail_rekapLOKASI: TStringField
      FieldName = 'LOKASI'
      Size = 50
    end
    object QDetail_rekapQTY: TFloatField
      FieldName = 'QTY'
    end
  end
  ...
  object QCek: TOracleDataSet
    SQL.Strings = (
        ...
        'select tanggal,no_reg_ht from ipisma_db4.hasil_tenun_detail_st w' +
        'here no_reg_ht=:noreg_ht'
      ''
      '')
    Variables.Data = {
      0300000001000000090000003A4E4F5245475F48540300000004000000950602
      0000000000}
    QBEDefinition.QBEFieldDefs = {
      04000000020000000700000054414E4747414C010000000000090000004E4F5F
      5245475F4854010000000000}
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 944
    Top = 344
    object QCekTANGGAL: TDateTimeField
      FieldName = 'TANGGAL'
    end
    object QCekNO_REG_HT: TFloatField
      FieldName = 'NO_REG_HT'
    end
  end
  object QCek1: TOracleDataSet
    SQL.Strings = (
      
        'select count (z.proses) as proses from (select distinct a.proses' +
        ' from ipisma_db4.hasil_tenun_detail_st a where a.no_reg=:no_reg ' +
        'and a.lokasi=:lokasi'
      'and a.proses in (select proses from ipisma_db4.vlokasi2_kel_1))z')
    Variables.Data = {
      0300000002000000070000003A4E4F5F52454703000000040000002400000000
      000000070000003A4C4F4B4153490500000002000000320000000000}
    QBEDefinition.QBEFieldDefs = {04000000010000000600000050524F534553010000000000}
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 984
    Top = 344
    object QCek1PROSES: TFloatField
      FieldName = 'PROSES'
    end
  end
  object QCek3: TOracleDataSet
    SQL.Strings = (
      
        'select count (z.proses) as proses from (select distinct a.proses' +
        ' from ipisma_db4.hasil_tenun_detail_st a where a.no_reg=:no_reg ' +
        'and a.lokasi=:lokasi'
      'and a.proses in (select proses from ipisma_db4.vlokasi3_kel_1))z')
    Variables.Data = {
      0300000002000000070000003A4E4F5F52454703000000040000002400000000
      000000070000003A4C4F4B4153490500000002000000330000000000}
    QBEDefinition.QBEFieldDefs = {04000000010000000600000050524F534553010000000000}
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 944
    Top = 392
    object QCek3PROSES: TFloatField
      FieldName = 'PROSES'
    end
  end
  object QCek6: TOracleDataSet
    SQL.Strings = (
      
        'select count (z.proses) as proses from (select distinct a.proses' +
        ' from ipisma_db4.hasil_tenun_detail_st a where a.no_reg=:no_reg ' +
        'and a.lokasi=:lokasi'
      'and a.proses in (select proses from ipisma_db4.vlokasi5))z')
    Variables.Data = {
      0300000002000000070000003A4E4F5F52454703000000040000002400000000
      000000070000003A4C4F4B4153490500000002000000350000000000}
    QBEDefinition.QBEFieldDefs = {04000000010000000600000050524F534553010000000000}
    QueryAllRecords = False
    Session = DMFrm.OS
    Left = 1080
    Top = 392
    object QCek6PROSES: TFloatField
      FieldName = 'PROSES'
    end
  end
  object QCek4: TOracleDataSet
    SQL.Strings = (
      
        'select count (z.proses) as proses from (select distinct a.proses' +
        ' from ipisma_db4.hasil_tenun_detail_st a where a.no_reg=:no_reg ' +
        'and a.lokasi=:lokasi'
      'and a.proses in (select proses from ipisma_db4.vlokasi3_kel_2))z')
    Variables.Data = {
      0300000002000000070000003A4E4F5F52454703000000040000002400000000
      000000070000003A4C4F4B4153490500000002000000330000000000}
    QBEDefinition.QBEFieldDefs = {04000000010000000600000050524F534553010000000000}
    ...
    Left = 984
    Top = 392
    object QCek4PROSES: TFloatField
      FieldName = 'PROSES'
    end
  end
  object QCek5: TOracleDataSet
    SQL.Strings = (
      
        'select count (z.proses) as proses from (select distinct a.proses' +
        ' from ipisma_db4.hasil_tenun_detail_st a where a.no_reg=:no_reg ' +
        'and a.lokasi=:lokasi'
      'and a.proses in (select proses from ipisma_db4.vlokasi3_kel_3))z')
    Variables.Data = {
      0300000002000000070000003A4E4F5F52454703000000040000002400000000
      000000070000003A4C4F4B4153490500000002000000330000000000}
    QBEDefinition.QBEFieldDefs = {04000000010000000600000050524F534553010000000000}
    ...
    Left = 1032
    Top = 392
    object QCek5PROSES: TFloatField
      FieldName = 'PROSES'
    end
  end
  object QCek2: TOracleDataSet
    SQL.Strings = (
      
        'select count (z.proses) as proses from (select distinct a.proses' +
        ' from ipisma_db4.hasil_tenun_detail_st a where a.no_reg=:no_reg ' +
        'and a.lokasi=:lokasi'
      'and a.proses in (select proses from ipisma_db4.vlokasi2_kel_2))z')
    Variables.Data = {
      0300000002000000070000003A4E4F5F52454703000000040000002400000000
      000000070000003A4C4F4B4153490500000002000000320000000000}
    QBEDefinition.QBEFieldDefs = {04000000010000000600000050524F534553010000000000}
    ...
    Left = 1032
    Top = 344
    object QCek2PROSES: TFloatField
      FieldName = 'PROSES'
    end
  end
  object looklokasi: TOracleDataSet
    SQL.Strings = (
      'select distinct lokasi from rekap_hasil_tenun')
    SequenceField.Field = 'NO_REG'
    SequenceField.Sequence = 'ipisma_db4.NO_REG_HASIL_TENUN_ST'
    SequenceField.ApplyMoment = amOnNewRecord
    ...
    Left = 1096
    Top = 136
    object looklokasiLOKASI: TStringField
      FieldName = 'LOKASI'
      Size = 50
    end
  end
  object QTotal: TOracleDataSet
    SQL.Strings = (
      ...
      'from ipisma_db4.hasil_tenun_detail_st'
      'where no_reg=:no_reg')
    Variables.Data = {
      0300000001000000070000003A4E4F5F52454703000000040000003500000000
      000000}
