object PaletKeluarFrm: TPaletKeluarFrm
  Left = 217
  Top = 79
  Width = 1032
  Height = 659
  Caption = 'PALET KELUAR'
  Color = clBtnFace
      ...
      object TabSheet1: TTabSheet
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              'KP'#9'30'#9'KODE PRODUKSI'#9'F'
              'MESIN'#9'30'#9'MESIN'#9'T'
              'PAKAN'#9'30'#9'NO BENANG PAKAN'#9'F'
              'KG'#9'10'#9'KG'#9'F')
        ...
        object PanelBrowse: TPanel
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'KP'#9'20'#9'KP'#9'F'
              'MESIN'#9'20'#9'MESIN'#9'F'
              'PAKAN'#9'20'#9'BENANG~PAKAN'#9'F'
              'KG'#9'20'#9'JUMLAH (KG)'#9'F'
              'KETERANGAN'#9'50'#9'KONSTRUKSI'#9'F')
            IniAttributes.Enabled = True
            IniAttributes.Delimiter = ';;'
            IniAttributes.CheckNewFields = True
            ExportOptions.ExportType = wwgetHTML
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
        ...
        'select trunc(a.tanggal) as tanggal, a.no_nota, b.kp, b.mesin, b.' +
        'pakan, b.kg, b.keterangan from ipisma_db4.palet a'
      'left join ipisma_db4.palet_detail b on a.no_reg=b.no_reg'
      'where trunc(a.tanggal)>=:pawal and trunc(a.tanggal)<=:pakhir'
      ':porder')
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      4552414E47414E010000000000020000004B47010000000000020000004B5001
      0000000000050000004D4553494E010000000000070000004E4F5F4E4F544101
      00000000000500000050414B414E010000000000}
    ReadOnly = True
    ...
    object QBrowsePAKAN: TStringField
      FieldName = 'PAKAN'
      Size = 128
    end
  end
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db4.palet_detail a'
    ...
    SequenceField.Sequence = 'IPISMA_DB4.NO_REG_PALET_DET'
    QBEDefinition.QBEFieldDefs = {
      040000000E0000000A0000004B45544552414E47414E01000000000008000000
      ...
      00000000020000004B50010000000000050000004D4553494E01000000000005
      00000050414B414E010000000000}
    Master = QMaster
    MasterFields = 'NO_REG'
    DetailFields = 'NO_REG'
    RefreshOptions = [roAfterInsert, roAfterUpdate]
    ...
    object QDetailKONSTRUKSI: TStringField
      ...
      LookupDataSet = DMFrm.QKonstruksi
    ...
    object QDetailPAKAN: TStringField
      FieldName = 'PAKAN'
      Size = 128
    end
  end
