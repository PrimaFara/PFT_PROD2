object KoreksiKelosKeluarFrm: TKoreksiKelosKeluarFrm
  Left = 201
  Top = 57
  Width = 1074
  Height = 659
  HorzScrollBar.Range = 897
  ActiveControl = vTglAwal1
  AutoScroll = False
  Caption = 'KOREKSI KELOS KELUAR'
  Color = clBtnFace
        ...
        object PanelDetail: TPanel
          ...
          object LookKonstruksi: TwwDBLookupComboDlg
            ...
            Selected.Strings = (
              ...
              'STOK_AWAL'#9'10'#9'STOK_AWAL'#9'F')
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vkoreksi_keluar'
  ...
  object QMaster: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      040000000D000000070000004E4F5F4E4F54410100000000000C0000004B445F
  ...
  object QDetail: TOracleDataSet
    ...
    object QDetailSTOK_AWA: TIntegerField
      FieldKind = fkLookup
      FieldName = 'STOK_AWA'
      LookupDataSet = QBarang
      LookupKeyFields = 'KD_ITEM'
      LookupResultField = 'STOK_AWAL'
      KeyFields = 'KD_KONSTRUKSI'
      Lookup = True
    end
  end
