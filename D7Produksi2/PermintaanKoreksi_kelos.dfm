object PermintaanKoreksi_kelosFrm: TPermintaanKoreksi_kelosFrm
  Left = 269
  Top = 124
  Width = 1010
  Height = 580
  ActiveControl = vTglAwal
  Caption = '877. Koreksi Kelos Cikalan'
  Color = clBtnFace
      ...
      object PanelDetail: TPanel
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'QTY1'#9'10'#9'KG'#9'T'#9'AWAL'
            'QTY2'#9'10'#9'PCS'#9'T'#9'AWAL'
            'QTY3'#9'10'#9'KG'#9'F'#9'AKHIR'
            'QTY4'#9'10'#9'PCS'#9'F'#9'AKHIR'
            'QTY5'#9'10'#9'KG'#9'T'#9'SELISIH'
            'QTY6'#9'10'#9'PCS'#9'T'#9'SELISIH')
      ...
      object PanelBrowse: TPanel
        ...
        object wwDBGrid2: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'AWPCS'#9'10'#9'Pcs'#9'F'#9'AWAL'
            'SELISIHKG'#9'10'#9'Kg'#9'F'#9'SELISIH'
            'SELISIHPCS'#9'10'#9'Psc'#9'F'#9'SELISIH'
            'STATUS'#9'10'#9'JENIS'#9'F')
          IniAttributes.Enabled = True
          IniAttributes.Delimiter = ';;'
          IniAttributes.CheckNewFields = True
          ExportOptions.ExportType = wwgetHTML
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vpermintaankoreksi_kelosfrm'
      'where kd_transaksi = '#39'877'#39)
    QBEDefinition.QBEFieldDefs = {
      ...
      00004B445F5452414E53414B5349010000000000060000004942554B54490100
      000000000400000041574B470100000000000500000041575043530100000000
      000900000053454C495349484B470100000000000A00000053454C4953494850
      4353010000000000}
    ReadOnly = True
    ...
    object QBrowseAWPCS: TFloatField
      FieldName = 'AWPCS'
      DisplayFormat = '#.#,#;(#.#,#); '
    end
    ...
    object QBrowseSELISIHPCS: TFloatField
      FieldName = 'SELISIHPCS'
      DisplayFormat = '#.#,#;(#.#,#); '
    end
  end
  ...
  object Qitem_ko: TOracleDataSet
    SQL.Strings = (
        ...
        '--select b.kd_item, a.* from ipisma_db4.vstok_kor_temp a, ipisma' +
        '_db4.vitemall_1 b --'#39'-'#39' as kd_item,'
      '--where qty1 <>0 and a.nama_item=b.kd_sub_kel'
      '--ORDER BY a.nama_item'
      
        'select /*distinct b.kd_item,*/ a.* from ipisma_db4.vstok_kor_tem' +
        'p a, ipisma_db4.vitemall_1 b --'#39'-'#39' as kd_item,'
      'where qty1 <>0 and a.nama_item=b.kd_sub_kel'
      'order by a.nama_item'
      '--edit 190923')
    QBEDefinition.QBEFieldDefs = {
  ...
  object OracleQuery1: TOracleQuery
    SQL.Strings = (
      'begin'
        ...
        '  ipisma_db4.proc_mutasi_kls_ckln(:pawal,:pakhir); /*proc_mutasi' +
        '_korNEW(:pawal); */'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
