object InfoWIPPengeringanFrm: TInfoWIPPengeringanFrm
  Left = -21
  Top = 119
  Width = 1010
  Height = 524
    ...
    object PanelBrowse: TPanel
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'MASUK1'#9'9'#9'Kg'#9'F'#9'DARI CELUP~(Masuk)'
          'MASUK2'#9'6'#9'Pcs'#9'F'#9'DARI CELUP~(Masuk)'
          'KELUAR1'#9'9'#9'Kg'#9'F'#9'HASIL PENGERINGAN~(Keluar)'
          'KELUAR2'#9'9'#9'Pcs'#9'F'#9'HASIL PENGERINGAN~(Keluar)'
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'NAMA_ITEM'#9'22'#9'NAMA ITEM'#9'F'
          'WARNA'#9'17'#9'WARNA'#9'F'
          'NO_BATCH'#9'9'#9'NO BATCH'#9'F'
          'AWAL1'#9'9'#9'Kg'#9'F'#9'AWAL'
          'AWAL2'#9'6'#9'Pcs'#9'F'#9'AWAL'
          'MASUK1'#9'10'#9'Kg'#9'F'#9'HASIL PENGERINGAN~(Masuk)'
          'MASUK2'#9'7'#9'Pcs'#9'F'#9'HASIL PENGERINGAN~(Masuk)'
          'KELUAR1'#9'9'#9'Kg'#9'F'#9'KE GUDANG WARNA~(Keluar)'
          'KELUAR2'#9'6'#9'Pcs'#9'F'#9'KE GUDANG WARNA~(Keluar)'
          'KELUAR5'#9'9'#9'Kg'#9'F'#9'KE LAINNYA~(Keluar)'
          'KELUAR6'#9'6'#9'Pcs'#9'F'#9'KE LAINNYA~(Keluar)'
          'KOREKSI1'#9'9'#9'Kg'#9'F'#9'KOREKSI'
          'KOREKSI2'#9'6'#9'Pcs'#9'F'#9'KOREKSI'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vinfomutasicelup'
      ':vorder')
  ...
  object QDump: TOracleQuery
    SQL.Strings = (
      'begin'
      'commit;'
      'insert into ipisma_db4.vinfomutasicelup'
      'select a.kd_item, '
      'a.kd_jns_item, '
      'a.nama_item, '
      'a.kd_satuan, '
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        'item=a.kd_item and kd_transaksi='#39'807'#39' and tgl>=trunc(:vsysdate)a' +
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        'saksi='#39'793'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1' +
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        '  where kd_lokasi=:kd_jns_item and kd_item=a.kd_item and kd_tran' +
        'saksi='#39'803'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1' +
      ...
      '(select sum(qty_out-qty_in) from ipisma_db4.vkartu_stok'
        ...
        '  where kd_lokasi=:kd_jns_item and kd_item=a.kd_item and kd_tran' +
        'saksi='#39'796'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1' +
      ...
      '(select sum(qty_out-qty_in) from ipisma_db4.vkartu_stok'
        ...
        '  where kd_lokasi=:kd_jns_item and kd_item=a.kd_item and kd_tran' +
        'saksi='#39'806'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1' +
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        'saksi='#39'807'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1' +
  ...
  object QDump2: TOracleQuery
    SQL.Strings = (
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        '  where kd_lokasi=:kd_jns_item and kd_item=a.kd_item and jns_lok' +
        'asi='#39'PROSES'#39' and tgl<trunc(:vsysdate))/:VRASIO AS AWAL1,'
      '(select sum(qty_in2-qty_out2) from ipisma_db4.vkartu_stok'
      
        '  where kd_lokasi=:kd_jns_item and kd_item=a.kd_item and jns_lok' +
        'asi='#39'PROSES'#39'  and tgl<trunc(:vsysdate))/:VRASIO AS AWAL2,'
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where  jns_koreksi='#39'KOREKSI'#39' and kd_lokasi=:kd_jns_item and kd' +
        '_item=a.kd_item and kd_transaksi='#39'804'#39' and tgl>=trunc(:vsysdate)' +
        'and tgl<trunc(:vsysdate2)+1-1/86400)/:VRASIO AS koreksi1,'
      '(select sum(qty_in2-qty_out2) from ipisma_db4.vkartu_stok'
      
        '  where jns_koreksi='#39'KOREKSI'#39' and kd_lokasi=:kd_jns_item and kd_' +
        'item=a.kd_item and kd_transaksi='#39'804'#39' and tgl>=trunc(:vsysdate)a' +
        'nd tgl<trunc(:vsysdate2)+1-1/86400)/:VRASIO AS koreksi2,'
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where kd_lokasi=:kd_jns_item and kd_item=a.kd_item and kd_tran' +
        'saksi='#39'795'#39' and jns_lokasi='#39'PROSES'#39' and tgl>=trunc(:vsysdate)and' +
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        '  where kd_lokasi=:kd_jns_item and kd_item=a.kd_item and kd_tran' +
        'saksi='#39'802'#39' and jns_lokasi='#39'PROSES'#39' and tgl>=trunc(:vsysdate)and' +
      ...
      '(select sum(qty_out-qty_in) from ipisma_db4.vkartu_stok'
        ...
        '  where kd_lokasi=:kd_jns_item and kd_item=a.kd_item and kd_tran' +
        'saksi='#39'793'#39' and jns_lokasi='#39'PROSES'#39' and tgl>=trunc(:vsysdate)and' +
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        '  where jns_koreksi in ('#39'PROSES ULANG'#39', '#39'KELUAR PROSES'#39', '#39'LAINNY' +
        'A'#39') and kd_lokasi=:kd_jns_item and kd_item=a.kd_item and kd_tran' +
        'saksi='#39'804'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1' +
        '-1/86400)/:VRASIO AS keluar5,'
      '(select sum(qty_in2-qty_out2) from ipisma_db4.vkartu_stok'
        ...
        '-1/86400)/:VRASIO AS keluar6'
      'from ipisma_db4.vitemall a'
      'where a.kd_jns_item=:kd_jns_item2'
      'order by a.kd_jns_item, a.nama_item;'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QDump3: TOracleQuery
    SQL.Strings = (
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        'em=a.kd_item and jns_lokasi='#39'LOKASI'#39' and tgl<trunc(:vsysdate))/:' +
        'VRASIO AS AWAL1,'
      '(select sum(qty_in2-qty_out2) from ipisma_db4.vkartu_stok'
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        '  where jns_koreksi='#39'KOREKSI'#39' and kd_warna=b.kd_warna and kd_lok' +
        'asi=:kd_jns_item and kd_item=a.kd_item and kd_transaksi='#39'807'#39' an' +
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        '  where kd_warna=b.kd_warna and kd_lokasi=:kd_jns_item and kd_it' +
        'em=a.kd_item and kd_transaksi='#39'793'#39' and tgl>=trunc(:vsysdate)and' +
        ' tgl<trunc(:vsysdate2)+1-1/86400)/:VRASIO AS masuk1,'
      '(select sum(qty_in2-qty_out2) from ipisma_db4.vkartu_stok'
      ...
      '(select sum(qty_out-qty_in) from ipisma_db4.vkartu_stok'
        ...
        '  where kd_warna=b.kd_warna and kd_lokasi=:kd_jns_item and kd_it' +
        'em=a.kd_item and kd_transaksi='#39'796'#39' and tgl>=trunc(:vsysdate)and' +
        ' tgl<trunc(:vsysdate2)+1-1/86400)/:VRASIO AS keluar1,'
      '(select sum(qty_out2-qty_in2) from ipisma_db4.vkartu_stok'
      ...
      '(select sum(qty_out-qty_in) from ipisma_db4.vkartu_stok'
        ...
        '  where kd_warna=b.kd_warna and kd_lokasi=:kd_jns_item and kd_it' +
        'em=a.kd_item and kd_transaksi='#39'806'#39' and tgl>=trunc(:vsysdate)and' +
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        'em=a.kd_item and kd_transaksi='#39'807'#39' and tgl>=trunc(:vsysdate)and' +
      ...
      '(select sum(qty_in2-qty_out2) from ipisma_db4.vkartu_stok'
        ...
        'from ipisma_db4.vitemall a,ipisma_db4.vitem_warna b, ipisma_db4.' +
        'warna c'
  ...
  object QDump4: TOracleQuery
    SQL.Strings = (
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        '  where jns_koreksi='#39'KOREKSI'#39' and no_batch=b.no_batch and kd_war' +
        'na=b.kd_warna and kd_lokasi=:kd_jns_item and kd_item=a.kd_item a' +
        'nd kd_transaksi='#39'807'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vs' +
        'ysdate2)+1-1/86400)/:VRASIO AS koreksi1,'
      '(select sum(qty_in2-qty_out2) from ipisma_db4.vkartu_stok'
      
        '  where jns_koreksi='#39'KOREKSI'#39' and no_batch=b.no_batch and kd_war' +
        'na=b.kd_warna and kd_lokasi=:kd_jns_item and kd_item=a.kd_item a' +
        'nd kd_transaksi='#39'807'#39' and tgl>=trunc(:vsysdate)and tgl<trunc(:vs' +
        'ysdate2)+1-1/86400)/:VRASIO AS koreksi2,'
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
      
        '  where no_batch=b.no_batch and kd_warna=b.kd_warna and kd_lokas' +
        'i=:kd_jns_item and kd_item=a.kd_item and kd_transaksi='#39'793'#39' and ' +
      ...
      '(select sum(qty_out-qty_in) from ipisma_db4.vkartu_stok'
        ...
        '  where no_batch=b.no_batch and kd_warna=b.kd_warna and kd_lokas' +
        'i=:kd_jns_item and kd_item=a.kd_item and kd_transaksi='#39'796'#39' and ' +
        'tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1-1/86400)/:VRASI' +
        'O AS keluar1,'
      '(select sum(qty_out2-qty_in2) from ipisma_db4.vkartu_stok'
      ...
      '(select sum(qty_out-qty_in) from ipisma_db4.vkartu_stok'
        ...
        '  where no_batch=b.no_batch and kd_warna=b.kd_warna and kd_lokas' +
        'i=:kd_jns_item and kd_item=a.kd_item and kd_transaksi='#39'806'#39' and ' +
        'tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1-1/86400)/:VRASI' +
        'O AS keluar3,'
      '(select sum(qty_out2-qty_in2) from ipisma_db4.vkartu_stok'
      ...
      '(select sum(qty_in-qty_out) from ipisma_db4.vkartu_stok'
        ...
        'i=:kd_jns_item and kd_item=a.kd_item and kd_transaksi='#39'807'#39' and ' +
        'tgl>=trunc(:vsysdate)and tgl<trunc(:vsysdate2)+1-1/86400)/:VRASI' +
        'O AS keluar5,'
      '(select sum(qty_in2-qty_out2) from ipisma_db4.vkartu_stok'
        ...
        'from ipisma_db4.vitemall a,ipisma_db4.vitem_warna_batch b, ipism' +
        'a_db3.warna c'
      'where a.kd_item=b.kd_item and b.kd_warna=c.kd_warna and '
    ...
    Session = DMFrm.OS
    Variables.Data = {
      }
    Left = 600
    Top = 72
  end
end
