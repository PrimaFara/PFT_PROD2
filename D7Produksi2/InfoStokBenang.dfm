object InfoStokBenangFrm: TInfoStokBenangFrm
  Left = 229
  Top = 151
  Width = 1139
  Height = 568
  Caption = 'Info Mutasi Stok Benang'
  Color = clBtnFace
    ...
    object TabSheet3: TTabSheet
      ...
      object wwDBGrid3: TwwDBGrid
        ...
        ControlType.Strings = (
          'ISPOST;CheckBox;1;0')
        Selected.Strings = (
          'NAMA_ITEM'#9'12'#9'No. Benang'#9'F'
          'AWAL1'#9'10'#9'AWAL'#9'F'
          'QTY_IN1'#9'10'#9'GW'#9'F'#9'PEMASUKAN'
          'QTY_IN2'#9'10'#9'Jasa~Benang'#9'F'#9'PEMASUKAN'
          'QTY_IN3'#9'10'#9'Kemitraan'#9'F'#9'PEMASUKAN'
          'QTY_IN4'#9'10'#9'Akumulasi~Draft Sizing'#9'F'#9'PEMASUKAN'
          'QTY_OUT1'#9'10'#9'Tenun'#9'F'#9'PENGELUARAN'
          'QTY_OUT2'#9'10'#9'Kemitraan'#9'F'#9'PENGELUARAN'
          'QTY_OUT3'#9'10'#9'Jasa~Benang'#9'F'#9'PENGELUARAN'
          'QTY_OUT4'#9'10'#9'Waste'#9'F'#9'PENGELUARAN'
          'QTY_OUT5'#9'10'#9'Retur GW'#9'F'#9'PENGELUARAN'
          'QTY_OUT6'#9'10'#9'Akumulasi Draft Szg~Selisih Konversi'#9'F'#9'PENGELUARAN'
          'AKHIR1'#9'10'#9'AKHIR'#9'F')
  ...
  object QTotal1: TOracleDataSet
    SQL.Strings = (
      ...
      'from ipisma_db4.vinfomutasipersiapan'
      ':myparam'
      '')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      0000000000080000005154595F4F555436010000000000}
    Session = DMFrm.OS
    Left = 296
    Top = 320
  ...
  object QAmbil_Data2: TOracleQuery
    SQL.Strings = (
      'begin'
      '  ipisma_db4.proc_info_mut_bng_pers(:pawal,:pakhir);'
      'end;')
    Session = DMFrm.OS
    Variables.Data = {
  ...
  object QStok2: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db4.vinfomutasipersiapan'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      4F555436010000000000060000005154595F414B010000000000}
