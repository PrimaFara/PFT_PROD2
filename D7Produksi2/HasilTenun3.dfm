object HasilTenun3Frm: THasilTenun3Frm
  Left = 169
  Top = 109
  Width = 918
  Height = 613
  Caption = 'Hasil Tenun Per Nomer Lokasi'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        ControlType.Strings = (
          'ISPOST;CheckBox;1;0')
        Selected.Strings = (
          'LOKASI'#9'7'#9'LOKASI'#9'F'
          'KONSTRUKSI'#9'20'#9'Konstruksi'#9'F'#9'HASIL PRODUKSI'
          'CORAK'#9'17'#9'Corak'#9'F'#9'HASIL PRODUKSI'
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
        ...
        'select lokasi, konstruksi, corak, sum(kodi) as kodi, sum(pcs) as' +
        ' pcs from ipisma_db4.vrekap_htenun'
      ':myparam')
    Variables.Data = {
      0300000001000000080000003A4D59504152414D010000008300000077686572
      ...
      282731302F31302F32303130272C2764642F6D6D2F7979797927292067726F75
      70206279206C6F6B6173692C206B6F6E737472756B73692C20636F72616B0000
      000000}
    QBEDefinition.QBEFieldDefs = {
      04000000050000000A0000004B4F4E535452554B534901000000000005000000
      434F52414B010000000000040000004B4F444901000000000003000000504353
